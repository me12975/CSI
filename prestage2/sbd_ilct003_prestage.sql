...
-- Purpose: Prestage資料表;
-- Table: sbd_ilct003_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_data_tp,incm_pfn_org_cd,incm_pfn_serial_no,seq_no,incm_pfn_idn_ban);
...
DROP TABLE IF EXISTS  prestage.sbd_ilct003_prestage;

CREATE TABLE  prestage.sbd_ilct003_prestage (
...
goods_no varchar(10) ,
bscd varchar(6) ,
purchs_unit_prc decimal(14,0) ,
purchs_qty decimal(10,0) ,
purchs_amt decimal(14,0) ,
sgst_sale_amt decimal(14,0) ,
aux_sale_gd_mk varchar(1) ,
err_mk varchar(1) ,
err_cd varchar(16) ,
upd_mk varchar(1) ,
dtl_incm_amt decimal(14,0) ,
mdm_tp varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_data_tp,incm_pfn_org_cd,incm_pfn_serial_no,seq_no,incm_pfn_idn_ban)
...
ALTER TABLE  prestage.sbd_ilct003_prestage OWNER TO ap_sbd;
