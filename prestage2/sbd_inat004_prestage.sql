...
DROP TABLE IF EXISTS  prestage.sbd_inat004_prestage;

CREATE TABLE  prestage.sbd_inat004_prestage (
...
prof_bl varchar(2) ,
prof_cd varchar(2) ,
united_prof_mk varchar(1) ,
partner_date varchar(7) ,
estab_date varchar(7) ,
open_date varchar(7) ,
stop_date varchar(7) ,
prof_unit_nm varchar(52) ,
prof_tel varchar(26) ,
...
caddr_lin varchar(5) ,
caddr_road_no varchar(50) ,
floor_expl varchar(10) ,
prof_haddr varchar(80) ,
side_job_mk varchar(1) ,
hou_holder varchar(1) ,
update_reas varchar(1) ,
case_cd varchar(1) ,
case_docu_no varchar(20) ,
create_date varchar(7) ,
hlthins_mk varchar(1) ,
hlthins_ym varchar(5) ,
acbk_verify_yr varchar(3) ,
nm_get_houhld_mk varchar(1) ,
idn_nm_conf_mk varchar(1) ,
htcmp_mk varchar(1) ,
visit_mk varchar(1) ,
force_mk varchar(1) ,
ban_update_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_inat004_prestage OWNER TO ap_sbd;
