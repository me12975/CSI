...
-- Purpose: Prestage資料表;
-- Table: sbd_ibct610_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn,item_no,batch_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_ibct610_prestage;

CREATE TABLE  prestage.sbd_ibct610_prestage (
...
empl_divd_time_prc decimal(14,3) ,
oth_data varchar(20) ,
upd_mk varchar(1) ,
punish_mk varchar(1) ,
suc_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_ibct610_prestage OWNER TO ap_sbd;
