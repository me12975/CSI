...
-- Purpose: Prestage資料表;
-- Table: sbd_fpvt134_prestage;
-- Compressed: N ;
-- Distributed: Y (fbrk_cd,co_ban);
...
DROP TABLE IF EXISTS  prestage.sbd_fpvt134_prestage;

CREATE TABLE  prestage.sbd_fpvt134_prestage (
fbrk_cd varchar(7) ,
fbrk_tp varchar(1) ,
co_ban varchar(8) ,
hsn_cd varchar(1) ,
...
ALTER TABLE  prestage.sbd_fpvt134_prestage OWNER TO ap_sbd;
