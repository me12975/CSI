...
DROP TABLE IF EXISTS  prestage.sbd_ibct600_prestage;

CREATE TABLE  prestage.sbd_ibct600_prestage (
...
ALTER TABLE  prestage.sbd_ibct600_prestage OWNER TO ap_sbd;
