...
DROP TABLE IF EXISTS  prestage.sbd_fpvt133_prestage;

CREATE TABLE  prestage.sbd_fpvt133_prestage (
pfn varchar(13) ,
source_tp varchar(1) ,
...
ALTER TABLE  prestage.sbd_fpvt133_prestage OWNER TO ap_sbd;
