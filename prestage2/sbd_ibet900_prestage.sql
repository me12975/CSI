...
DROP TABLE IF EXISTS  prestage.sbd_ibet900_prestage;

CREATE TABLE  prestage.sbd_ibet900_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
dst_nm varchar(16) ,
tel_no varchar(15) ,
comu_addr_hsn_nm varchar(3) ,
comu_addr_town_nm varchar(5) ,
comu_addr_vill_nm varchar(5) ,
comu_addr_lin varchar(5) ,
comu_addr_road_no varchar(50) ,
zip_cd varchar(5) ,
post_office_nm varchar(6) ,
pstg_paid_po_nm varchar(8) ,
pstg_paid_brch_nm varchar(12) ,
pstg_paid_app_char varchar(10) ,
pstg_paid_app_no varchar(8) ,
yn_ntax_brch varchar(1) ,
ad_reply_char varchar(6) ,
ad_reply_no varchar(5) ,
gvnr_srnm varchar(20) ,
...
ALTER TABLE  prestage.sbd_ibet900_prestage OWNER TO ap_sbd;
