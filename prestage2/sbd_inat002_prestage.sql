...
-- Purpose: Prestage資料表;
-- Table: sbd_inat002_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_data_tp,incm_pfn_org_cd,incm_pfn_serial_no,incm_pfn_idn_ban);
...
DROP TABLE IF EXISTS  prestage.sbd_inat002_prestage;

CREATE TABLE  prestage.sbd_inat002_prestage (
...
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_data_tp,incm_pfn_org_cd,incm_pfn_serial_no,incm_pfn_idn_ban)
...
ALTER TABLE  prestage.sbd_inat002_prestage OWNER TO ap_sbd;
