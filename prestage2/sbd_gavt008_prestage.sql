...
-- Purpose: Prestage資料表;
-- Table: sbd_gavt008_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,aphd_mk,serial_no,prop_serial_no);
...
DROP TABLE IF EXISTS  prestage.sbd_gavt008_prestage;

CREATE TABLE  prestage.sbd_gavt008_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
flg_yy varchar(3) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,aphd_mk,serial_no,prop_serial_no)
...
ALTER TABLE  prestage.sbd_gavt008_prestage OWNER TO ap_sbd;
