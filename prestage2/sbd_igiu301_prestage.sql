...
-- Purpose: Prestage資料表;
-- Table: sbd_igiu301_prestage;
-- Compressed: N ;
-- Distributed: Y (trs_cd,serial_no,serial_no_seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_igiu301_prestage;

CREATE TABLE  prestage.sbd_igiu301_prestage (
rvnu_date varchar(7) ,
trs_cd varchar(7) ,
serial_no varchar(6) ,
serial_no_seq_no varchar(2) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
tax_cd varchar(2) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (trs_cd,serial_no,serial_no_seq_no)
...
ALTER TABLE  prestage.sbd_igiu301_prestage OWNER TO ap_sbd;
