...
-- Purpose: Prestage資料表;
-- Table: sbd_inat001_prestage;
-- Compressed: N ;
-- Distributed: Y (prof_bl,prof_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_inat001_prestage;

CREATE TABLE  prestage.sbd_inat001_prestage (
data_yr varchar(3) ,
prof_bl varchar(2) ,
prof_bl_nm varchar(20) ,
prof_cd varchar(2) ,
prof_cd_nm varchar(64) ,
tp_cd varchar(4) ,
tp_cd_nm varchar(20) ,
prof_exp_rate decimal(3,0) ,
prof_pcity_rvnu decimal(14,0) ,
prof_hsn_rvnu decimal(14,0) ,
prof_exp_mk varchar(1) ,
prof_mk varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (prof_bl,prof_cd)
...
ALTER TABLE  prestage.sbd_inat001_prestage OWNER TO ap_sbd;
