...
-- Purpose: Prestage資料表;
-- Table: sbd_davt023_prestage;
-- Compressed: N ;
-- Distributed: Y (manage_cd,rbt_tms);
...
DROP TABLE IF EXISTS  prestage.sbd_davt023_prestage;

CREATE TABLE  prestage.sbd_davt023_prestage (
...
est_case_no varchar(14) ,
heired_idn varchar(10) ,
flg_date varchar(7) ,
pybl_ba_tax decimal(11,0) ,
slf_sup_int decimal(10,0) ,
adm_rmd_int decimal(10,0) ,
vio_fine_amt decimal(10,0) ,
dly_pay_amt decimal(10,0) ,
dly_pay_int decimal(10,0) ,
instm_int decimal(10,0) ,
rebate_ba_tax decimal(11,0) ,
rbt_slf_sup_int decimal(10,0) ,
rbt_adm_rmd_int decimal(10,0) ,
rbt_dly_pay_amt decimal(10,0) ,
rbt_dly_pay_int decimal(10,0) ,
rbt_instm_int decimal(10,0) ,
rbt_fine_amt decimal(10,0) ,
rbt_ltax decimal(10,0) ,
dnt_gov_amt decimal(10,0) ,
aft_rlzt_ratio_rtn decimal(10,0) ,
prop_rbt_amt_tot decimal(12,0) ,
app_obrt_date varchar(7) ,
app_obrt_docu_no varchar(11) ,
obrt_mk varchar(1) ,
appr_obrt_date varchar(7) ,
appr_obrt_docu_no varchar(11) ,
revo_rbt_date varchar(7) ,
did_obrt_date varchar(7) ,
did_obrt_docu_no varchar(11) ,
rbt_extend_b_date varchar(7) ,
rbt_extend_e_date varchar(7) ,
ntc_trsf_date varchar(7) ,
rlzt_mk varchar(1) ,
rbt_pay_docu_copy decimal(2,0) ,
rbt_trstr_cd varchar(5) ,
update_date varchar(7) ,
time_stamp timestamp ,
sub_manage_cd varchar(24) ,
asg_key varchar(25) ,
ntrs_amt decimal(11,0) ,
htrs_amt decimal(11,0) ,
upd_adm_rmd_mk varchar(1) ,
rmk varchar(200) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (manage_cd,rbt_tms)
...
ALTER TABLE  prestage.sbd_davt023_prestage OWNER TO ap_sbd;
