...
DROP TABLE IF EXISTS  prestage.sbd_ibrt801_prestage;

CREATE TABLE  prestage.sbd_ibrt801_prestage (
data_yr varchar(3) ,
hsn_cd varchar(1) ,
idn varchar(10) ,
nm varchar(20) ,
...
grdn_gov varchar(40) ,
grdn_date_s varchar(7) ,
grdn_date_e varchar(7) ,
trsf_mk varchar(1) ,
trsf_date varchar(7) ,
...
ALTER TABLE  prestage.sbd_ibrt801_prestage OWNER TO ap_sbd;
