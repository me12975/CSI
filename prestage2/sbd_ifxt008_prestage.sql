...
DROP TABLE IF EXISTS  prestage.sbd_ifxt008_prestage;

CREATE TABLE  prestage.sbd_ifxt008_prestage (
...
un_lst_scts decimal(14,0) ,
trst_fund_scts decimal(14,0) ,
...
no_cost_un_lst_scts decimal(14,0) ,
no_cost_trst_fund decimal(14,0) ,
get_cost_scts_tot decimal(14,0) ,
no_cost_scts_tot decimal(14,0) ,
scts_trade_loss_ded decimal(14,0) ,
ovrse_crd decimal(14,0) ,
dif_crd_aft_blnc decimal(14,0) ,
scts_trade_incm_stot decimal(14,0) ,
ovese_prop_incm decimal(14,0) ,
ovese_non_prop_incm decimal(14,0) ,
src_cty_tax_paid decimal(14,0) ,
org_cd varchar(3) ,
...
ALTER TABLE  prestage.sbd_ifxt008_prestage OWNER TO ap_sbd;
