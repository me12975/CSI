...
DROP TABLE IF EXISTS  prestage.sbd_ifxt027_prestage;

CREATE TABLE  prestage.sbd_ifxt027_prestage (
...
ALTER TABLE  prestage.sbd_ifxt027_prestage OWNER TO ap_sbd;
