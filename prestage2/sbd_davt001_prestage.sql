...
DROP TABLE IF EXISTS  prestage.sbd_davt001_prestage;

CREATE TABLE  prestage.sbd_davt001_prestage (
...
ALTER TABLE  prestage.sbd_davt001_prestage OWNER TO ap_sbd;
