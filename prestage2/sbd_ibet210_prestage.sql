...
DROP TABLE IF EXISTS  prestage.sbd_ibet210_prestage;

CREATE TABLE  prestage.sbd_ibet210_prestage (
rfn varchar(17) ,
flg_xmp decimal(14,0) ,
...
ins_payment decimal(14,0) ,
scts_trade_incm decimal(14,0) ,
no_cash_ded decimal(14,0) ,
empl_dist_dif decimal(14,0) ,
base_incm_tot decimal(14,0) ,
base_tax decimal(14,0) ,
gene_incm_tax decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_ibet210_prestage OWNER TO ap_sbd;
