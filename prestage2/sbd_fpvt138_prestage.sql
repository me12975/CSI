...
-- Purpose: Prestage資料表;
-- Table: sbd_fpvt138_prestage;
-- Compressed: N ;
-- Distributed: Y (fbrk_cd,ftt_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_fpvt138_prestage;

CREATE TABLE  prestage.sbd_fpvt138_prestage (
fbrk_cd varchar(7) ,
trade_date varchar(7) ,
ftt_tp varchar(1) ,
hsn_cd varchar(1) ,
co_ban varchar(8) ,
trade_qty decimal(10,0) ,
trade_amt decimal(14,0) ,
trdng_tax_tot decimal(12,0) ,
...
ALTER TABLE  prestage.sbd_fpvt138_prestage OWNER TO ap_sbd;
