...
DROP TABLE IF EXISTS  prestage.sbd_ibet220_prestage;

CREATE TABLE  prestage.sbd_ibet220_prestage (
rfn varchar(17) ,
...
ALTER TABLE  prestage.sbd_ibet220_prestage OWNER TO ap_sbd;
