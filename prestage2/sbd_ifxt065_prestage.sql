...
-- Purpose: Prestage資料表;
-- Table: sbd_ifxt065_prestage;
-- Compressed: N ;
-- Distributed: Y (ntnty_cd,passport_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ifxt065_prestage;

CREATE TABLE  prestage.sbd_ifxt065_prestage (
...
ALTER TABLE  prestage.sbd_ifxt065_prestage OWNER TO ap_sbd;
