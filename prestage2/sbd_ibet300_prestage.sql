...
DROP TABLE IF EXISTS  prestage.sbd_ibet300_prestage;

CREATE TABLE  prestage.sbd_ibet300_prestage (
rfn varchar(17) ,
...
cnd_dnt decimal(14,0) ,
adj_cnd_dnt decimal(14,0) ,
tppt_dnt decimal(14,0) ,
adj_tppt_dnt decimal(14,0) ,
prvt_s_dnt decimal(14,0) ,
adj_prvt_s_dnt decimal(14,0) ,
cnd_cmpgn_fee decimal(14,0) ,
pres_cnd_cmpgn_fee decimal(14,0) ,
pres_cnd_dnt decimal(14,0) ,
aaf_pres_cnd_dnt decimal(14,0) ,
...
dfs_dnt_ded decimal(14,0) ,
dnt_act_hppn_amt decimal(14,0) ,
hou_rent decimal(14,0) ,
lnd_dnt_ded decimal(14,0) ,
tpg_dnt decimal(14,0) ,
adj_tpg_dnt decimal(14,0) ,
dfs_dnt_obj_ded decimal(14,0) ,
dnt_obj_act_amt decimal(14,0) ,
dnt_obj_ded decimal(14,0) ,
hlth_ins_ded decimal(14,0) ,
oth_no_cash_ded decimal(14,0) ,
hou_rent_act_amt decimal(14,0) ,
non_houhld_reg varchar(1) ,
mrg_hou_int_rent_mk varchar(1) ,
hou_loan_days decimal(3) ,
hou_rent_days decimal(3) ,
asgn_prvt_s_dnt decimal(14) ,
asgn_adj_prvt_s_dnt decimal(14) ,
recall_exp decimal(14) ,
set_haddr_idn varchar(10) ,
set_haddr_nm varchar(20) ,
...
ALTER TABLE  prestage.sbd_ibet300_prestage OWNER TO ap_sbd;
