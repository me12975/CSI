...
DROP TABLE IF EXISTS  prestage.sbd_davt007_prestage;

CREATE TABLE  prestage.sbd_davt007_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
flg_yy varchar(3) ,
...
stk_volume decimal(16,4) ,
stk_pres_val decimal(10,4) ,
invt_amt decimal(12,0) ,
lst_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_davt007_prestage OWNER TO ap_sbd;
