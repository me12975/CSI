...
-- Purpose: Prestage資料表;
-- Table: sbd_ifxt067_prestage;
-- Compressed: N ;
-- Distributed: Y (prmt_no,reg_ban,ntnty_cd,passport_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ifxt067_prestage;

CREATE TABLE  prestage.sbd_ifxt067_prestage (
trans_date varchar(7) ,
update_id varchar(1) ,
prmt_no varchar(11) ,
...
task_b_date varchar(7) ,
ctrt_e_date varchar(7) ,
salary decimal(14,0) ,
occp_task varchar(20) ,
zip_cd varchar(3) ,
task_addr varchar(80) ,
extend_docu_no varchar(11) ,
group_nm varchar(50) ,
prog_nm varchar(50) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (prmt_no,reg_ban,ntnty_cd,passport_no)
...
ALTER TABLE  prestage.sbd_ifxt067_prestage OWNER TO ap_sbd;
