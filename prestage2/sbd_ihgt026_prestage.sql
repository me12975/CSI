...
-- Purpose: Prestage資料表;
-- Table: sbd_ihgt026_prestage;
-- Compressed: N ;
-- Distributed: Y (rpfn_org_cd,rpfn_serial_no,holder_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_ihgt026_prestage;

CREATE TABLE  prestage.sbd_ihgt026_prestage (
rpfn_org_cd varchar(3) ,
rpfn_data_yr varchar(3) ,
rpfn_serial_no varchar(5) ,
holder_idn varchar(10) ,
holder_nm varchar(20) ,
hou_losn varchar(12) ,
shr_nmrt decimal(10) ,
shr_dnt decimal(10) ,
rent_incm decimal(14) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (rpfn_org_cd,rpfn_serial_no,holder_idn)
...
ALTER TABLE  prestage.sbd_ihgt026_prestage OWNER TO ap_sbd;
