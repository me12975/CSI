...
-- Purpose: Prestage資料表;
-- Table: sbd_ibkt516_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn,apply_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_ibkt516_prestage;

CREATE TABLE  prestage.sbd_ibkt516_prestage (
rfn varchar(17) ,
rfn_data_yr varchar(3) ,
rfn_data_tp varchar(3) ,
rfn_hsn_tp varchar(1) ,
rfn_org varchar(2) ,
...
book_no varchar(6) ,
page_no varchar(2) ,
apply_idn varchar(10) ,
apply_nm varchar(20) ,
disa_date varchar(7) ,
disa_reas varchar(20) ,
apl_loss_amt decimal(14,0) ,
appr_docu_no varchar(12) ,
update_org varchar(3) ,
user_id_cd varchar(8) ,
update_date_time varchar(13) ,
edit_cmpl_mk varchar(1) ,
data_err_cd varchar(1) ,
err_reas varchar(20) ,
err_mk varchar(1) ,
bill_batch_tp varchar(1) ,
flg_loss_amt decimal(14,0) ,
flg_loss_item varchar(100) ,
appr_date varchar(7) ,
flg_date varchar(7) ,
...
disa_hppn_hsn_cd varchar(1) ,
disa_hppn_hsn_nm varchar(3) ,
disa_hppn_town_cd varchar(2) ,
disa_hppn_town_nm varchar(5) ,
disa_hppn_vill_cd varchar(2) ,
disa_hppn_vill_nm varchar(5) ,
disa_hppn_lin varchar(5) ,
disa_hppn_road_no varchar(50) ,
seq_no decimal(2,0) ,
holder_idn varchar(10) ,
holder_nm varchar(20) ,
apl_loss_item varchar(100) ,
chk_suple_tax decimal(14,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (rfn,apply_idn)
...
ALTER TABLE  prestage.sbd_ibkt516_prestage OWNER TO ap_sbd;
