...
-- Purpose: Prestage資料表;
-- Table: sbd_gavt021_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,aphd_mk,serial_no,apl_add_tms);
...
DROP TABLE IF EXISTS  prestage.sbd_gavt021_prestage;

CREATE TABLE  prestage.sbd_gavt021_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
flg_yy varchar(3) ,
...
giver_idn varchar(10) ,
gift_date varchar(7) ,
gift_yr varchar(3) ,
flg_date varchar(7) ,
zst_flg_gift_t decimal(12,0) ,
zst_flg_ded_t decimal(12,0) ,
lvt_ded decimal(10,0) ,
ddt_mntr_fe_ded decimal(10,0) ,
bdebt_ded decimal(10,0) ,
pub_fac_ded decimal(10,0) ,
oth_ded1 decimal(10,0) ,
oth_ded2 decimal(10,0) ,
excl_farm_amt decimal(12,0) ,
zst_excl_gift_t decimal(12,0) ,
zst_evade_gift_t decimal(12,0) ,
lt_case_no varchar(14) ,
lt_apl_gift_t decimal(12,0) ,
aptm_apl_pybl_tax decimal(10,0) ,
apl_gift_amt decimal(12,0) ,
xmp_amt decimal(8,0) ,
apl_ded_amt decimal(12,0) ,
gift_net_amt decimal(12,0) ,
tax_rate decimal(2,0) ,
prg_dif decimal(8,0) ,
whl_apl_pybl_tax decimal(10,0) ,
zst_apl_shsp_tax decimal(10,0) ,
vio_stus varchar(2) ,
adt_cd varchar(5) ,
upd_tp varchar(1) ,
upd_tms decimal(2,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,aphd_mk,serial_no,apl_add_tms)
...
ALTER TABLE  prestage.sbd_gavt021_prestage OWNER TO ap_sbd;
