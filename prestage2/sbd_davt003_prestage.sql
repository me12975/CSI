...
DROP TABLE IF EXISTS  prestage.sbd_davt003_prestage;

CREATE TABLE  prestage.sbd_davt003_prestage (
...
data_yy varchar(3) ,
serial_no varchar(5) ,
ntc_flg_date varchar(7) ,
ntc_flg_docu_no varchar(11) ,
ntc_flg_e_date varchar(7) ,
ext_tms decimal(1,0) ,
appr_ext_date varchar(7) ,
appr_ext_docu_no varchar(11) ,
ext_flg_dl varchar(7) ,
ug_ntc_date varchar(7) ,
ug_ntc_docu_no varchar(11) ,
print_date varchar(7) ,
flg_mk varchar(1) ,
lt_flg_mk varchar(1) ,
wfunc_cntr_mk varchar(1) ,
keyin_date varchar(7) ,
pick_date varchar(7) ,
time_stamp timestamp ,
trst_mk varchar(1) ,
tran_mk varchar(1) ,
app_ext_flg_date varchar(7) ,
case_mk varchar(1) ,
anno_ug_s_date varchar(7) ,
anno_ug_e_date varchar(7) ,
appr_ext_flg_date varchar(7) ,
...
ALTER TABLE  prestage.sbd_davt003_prestage OWNER TO ap_sbd;
