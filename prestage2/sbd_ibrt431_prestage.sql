...
-- Purpose: Prestage資料表;
-- Table: sbd_ibrt431_prestage;
-- Compressed: N ;
-- Distributed: Y (dntr_idn_ban,recp_dnt_unit_ban);
...
DROP TABLE IF EXISTS  prestage.sbd_ibrt431_prestage;

CREATE TABLE  prestage.sbd_ibrt431_prestage (
data_yr varchar(3) ,
dntr_idn_ban varchar(10) ,
dntr_nm varchar(20) ,
dnt_amt decimal(14) ,
recp_dnt_unit_ban varchar(10) ,
dnt_tp varchar(2) ,
recp_dntr_unit_nm varchar(52) ,
case_docu_no varchar(60) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (dntr_idn_ban,recp_dnt_unit_ban)
...
ALTER TABLE  prestage.sbd_ibrt431_prestage OWNER TO ap_sbd;
