...
-- Purpose: Prestage資料表;
-- Table: sbd_ibrt413_prestage;
-- Compressed: N ;
-- Distributed: Y (schl_cd,student_no,student_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_ibrt413_prestage;

CREATE TABLE  prestage.sbd_ibrt413_prestage (
data_yr varchar(3) ,
schl_cd varchar(6) ,
student_no varchar(12) ,
pay_fee_date varchar(7) ,
student_idn varchar(10) ,
student_nm varchar(20) ,
schl_yr varchar(3) ,
schl_pds_tp varchar(1) ,
schl_sys_cd varchar(2) ,
yy_grd varchar(2) ,
tuition decimal(14) ,
drom_fee decimal(14) ,
remark varchar(30) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (schl_cd,student_no,student_idn)
...
ALTER TABLE  prestage.sbd_ibrt413_prestage OWNER TO ap_sbd;
