...
DROP TABLE IF EXISTS  prestage.sbd_ifxt700_prestage;

CREATE TABLE  prestage.sbd_ifxt700_prestage (
rfn varchar(17) ,
seq_no varchar(2) ,
pers_alien_idn varchar(10) ,
pers_eng_nm varchar(60) ,
pers_idn varchar(10) ,
pers_nm varchar(20) ,
id_tp varchar(1) ,
id_cd varchar(1) ,
...
ALTER TABLE  prestage.sbd_ifxt700_prestage OWNER TO ap_sbd;
