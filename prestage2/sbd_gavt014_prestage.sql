...
-- Purpose: Prestage資料表;
-- Table: sbd_gavt014_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,aphd_mk,serial_no,recep_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_gavt014_prestage;

CREATE TABLE  prestage.sbd_gavt014_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
flg_yy varchar(3) ,
aphd_mk varchar(1) ,
serial_no varchar(5) ,
recep_idn varchar(10) ,
giver_idn varchar(10) ,
recep_nm varchar(52) ,
born_date varchar(7) ,
recer_addr_hsn_nm varchar(3) ,
recer_addr_town_nm varchar(5) ,
recer_addr_vill_nm varchar(5) ,
recer_addr_lin varchar(5) ,
recer_addr_road_no varchar(50) ,
giver_relation varchar(1) ,
cert_mk varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,aphd_mk,serial_no,recep_idn)
...
ALTER TABLE  prestage.sbd_gavt014_prestage OWNER TO ap_sbd;
