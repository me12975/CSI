...
DROP TABLE IF EXISTS  prestage.sbd_iict001_prestage;

CREATE TABLE  prestage.sbd_iict001_prestage (
...
ALTER TABLE  prestage.sbd_iict001_prestage OWNER TO ap_sbd;
