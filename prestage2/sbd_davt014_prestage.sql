...
-- Purpose: Prestage資料表;
-- Table: sbd_davt014_prestage;
-- Compressed: N ;
-- Distributed: Y (heired_idn,heir_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_davt014_prestage;

CREATE TABLE  prestage.sbd_davt014_prestage (
heired_idn varchar(10) ,
heir_idn varchar(10) ,
heir_nm varchar(52) ,
born_date varchar(7) ,
heir_addr_hsn_nm varchar(3) ,
heir_addr_town_nm varchar(5) ,
heir_addr_vill_nm varchar(5) ,
heir_addr_lin varchar(5) ,
heir_addr_road_no varchar(50) ,
heired_relation varchar(1) ,
heir_yn_mk varchar(1) ,
inher_manager_mk varchar(1) ,
rdc_date varchar(7) ,
rdc_docu_no varchar(11) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (heired_idn,heir_idn)
...
ALTER TABLE  prestage.sbd_davt014_prestage OWNER TO ap_sbd;
