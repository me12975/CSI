...
-- Purpose: Prestage資料表;
-- Table: sbd_icmt015_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,org,town_cd,vill_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_icmt015_prestage;

CREATE TABLE  prestage.sbd_icmt015_prestage (
data_yr varchar(3) ,
hsn_cd varchar(1) ,
org varchar(2) ,
town_cd varchar(2) ,
vill_cd varchar(2) ,
ctrl_area_cd varchar(2) ,
vill_nm varchar(5) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,org,town_cd,vill_cd)
...
ALTER TABLE  prestage.sbd_icmt015_prestage OWNER TO ap_sbd;
