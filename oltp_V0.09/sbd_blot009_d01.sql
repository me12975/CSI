...
DROP TABLE IF EXISTS  oltp.sbd_blot009_d01;

CREATE TABLE  oltp.sbd_blot009_d01 (
...
ALTER TABLE  oltp.sbd_blot009_d01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_blot009_d01 ADD CONSTRAINT sbd_blot009_d01_PK PRIMARY KEY (data_ym,ban,bill_of_sight_no,bill_of_sight_tp);
