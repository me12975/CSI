...
DROP TABLE IF EXISTS  oltp.sbd_wxxw300_d01;

CREATE TABLE  oltp.sbd_wxxw300_d01 (
...
ALTER TABLE  oltp.sbd_wxxw300_d01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_wxxw300_d01 ADD CONSTRAINT sbd_wxxw300_d01_PK PRIMARY KEY (unpaid_case_tp,hsn_cd,dst_cd,town_cd,tax_cd,subtax_cd,bl_yr_pd,data_no);
