...
DROP TABLE IF EXISTS  oltp.sbd_bgmh007_a05;

CREATE TABLE  oltp.sbd_bgmh007_a05 (
...
ALTER TABLE  oltp.sbd_bgmh007_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bgmh007_a05 ADD CONSTRAINT sbd_bgmh007_a05_PK PRIMARY KEY (data_yr,ban,update_date_time,update_cd);
