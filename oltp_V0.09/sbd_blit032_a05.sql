...
DROP TABLE IF EXISTS  oltp.sbd_blit032_a05;

CREATE TABLE  oltp.sbd_blit032_a05 (
...
ALTER TABLE  oltp.sbd_blit032_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_blit032_a05 ADD CONSTRAINT sbd_blit032_a05_PK PRIMARY KEY (data_ym,ban,format_cd,pfn,seq_no,asg_date);
