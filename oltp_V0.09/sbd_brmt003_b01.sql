...
DROP TABLE IF EXISTS  oltp.sbd_brmt003_b01;

CREATE TABLE  oltp.sbd_brmt003_b01 (
...
ALTER TABLE  oltp.sbd_brmt003_b01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_brmt003_b01 ADD CONSTRAINT sbd_brmt003_b01_PK PRIMARY KEY (bl_yr,bl_mm,ban,unfile_mk);
