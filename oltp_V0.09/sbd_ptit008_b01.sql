...
DROP TABLE IF EXISTS  oltp.sbd_ptit008_b01;

CREATE TABLE  oltp.sbd_ptit008_b01 (
...
ALTER TABLE  oltp.sbd_ptit008_b01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ptit008_b01 ADD CONSTRAINT sbd_ptit008_b01_PK PRIMARY KEY (payment_unit_ban,seq_no,item_no);
