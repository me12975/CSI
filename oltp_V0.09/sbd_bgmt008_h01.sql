...
DROP TABLE IF EXISTS  oltp.sbd_bgmt008_h01;

CREATE TABLE  oltp.sbd_bgmt008_h01 (
...
ALTER TABLE  oltp.sbd_bgmt008_h01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bgmt008_h01 ADD CONSTRAINT sbd_bgmt008_h01_PK PRIMARY KEY (ban,partner_idn,data_yr);
