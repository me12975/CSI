...
DROP TABLE IF EXISTS  oltp.sbd_brmt006_d01;

CREATE TABLE  oltp.sbd_brmt006_d01 (
...
ALTER TABLE  oltp.sbd_brmt006_d01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_brmt006_d01 ADD CONSTRAINT sbd_brmt006_d01_PK PRIMARY KEY (pfn_hsn_cd,pfn_dst_cd,pfn_serv_area,pfn_create_yy,pfn_create_mm,pfn_data_source_mk,pfn_book_page_no);
