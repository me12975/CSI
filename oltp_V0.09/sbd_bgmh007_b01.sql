...
DROP TABLE IF EXISTS  oltp.sbd_bgmh007_b01;

CREATE TABLE  oltp.sbd_bgmh007_b01 (
...
ALTER TABLE  oltp.sbd_bgmh007_b01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bgmh007_b01 ADD CONSTRAINT sbd_bgmh007_b01_PK PRIMARY KEY (data_yr,ban,update_date_time,update_cd);
