...
DROP TABLE IF EXISTS  oltp.sbd_jvpt001_a05;

CREATE TABLE  oltp.sbd_jvpt001_a05 (
...
ALTER TABLE  oltp.sbd_jvpt001_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_jvpt001_a05 ADD CONSTRAINT sbd_jvpt001_a05_PK PRIMARY KEY (asg_busi_tp,data_bl_yr,asg_no,chk_tms);
