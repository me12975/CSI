...
DROP TABLE IF EXISTS  oltp.sbd_bimt009_d01;

CREATE TABLE  oltp.sbd_bimt009_d01 (
...
ALTER TABLE  oltp.sbd_bimt009_d01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bimt009_d01 ADD CONSTRAINT sbd_bimt009_d01_PK PRIMARY KEY (agt_cd,agt_hsn_cd,agt_seq_no);
