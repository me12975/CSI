...
DROP TABLE IF EXISTS  oltp.sbd_ptit008_a05;

CREATE TABLE  oltp.sbd_ptit008_a05 (
...
ALTER TABLE  oltp.sbd_ptit008_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ptit008_a05 ADD CONSTRAINT sbd_ptit008_a05_PK PRIMARY KEY (payment_unit_ban,seq_no,item_no);
