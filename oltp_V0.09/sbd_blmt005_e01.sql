...
DROP TABLE IF EXISTS  oltp.sbd_blmt005_e01;

CREATE TABLE  oltp.sbd_blmt005_e01 (
...
ALTER TABLE  oltp.sbd_blmt005_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_blmt005_e01 ADD CONSTRAINT sbd_blmt005_e01_PK PRIMARY KEY (data_ym,format_cd,p_s_item_pfn,flg_mk,seq_no);
