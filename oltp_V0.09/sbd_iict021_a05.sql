...
DROP TABLE IF EXISTS  oltp.sbd_iict021_a05;

CREATE TABLE  oltp.sbd_iict021_a05 (
...
ALTER TABLE  oltp.sbd_iict021_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_iict021_a05 ADD CONSTRAINT sbd_iict021_a05_PK PRIMARY KEY (incm_pfn_data_yr,incm_pfn_data_tp,incm_pfn_hsn_cd,incm_pfn_org,incm_pfn_serial_no,id_dstg,idn_ban_tp,incm_tp,trst_mk,no_rsdt_pay_date);
