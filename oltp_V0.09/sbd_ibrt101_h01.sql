...
DROP TABLE IF EXISTS  oltp.sbd_ibrt101_h01;

CREATE TABLE  oltp.sbd_ibrt101_h01 (
...
ALTER TABLE  oltp.sbd_ibrt101_h01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ibrt101_h01 ADD CONSTRAINT sbd_ibrt101_h01_PK PRIMARY KEY (idn);
