...
DROP TABLE IF EXISTS  oltp.sbd_wxxw300_a05;

CREATE TABLE  oltp.sbd_wxxw300_a05 (
...
ALTER TABLE  oltp.sbd_wxxw300_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_wxxw300_a05 ADD CONSTRAINT sbd_wxxw300_a05_PK PRIMARY KEY (unpaid_case_tp,hsn_cd,dst_cd,town_cd,tax_cd,subtax_cd,bl_yr_pd,data_no);
