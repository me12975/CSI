...
DROP TABLE IF EXISTS  oltp.sbd_bcit008_b01;

CREATE TABLE  oltp.sbd_bcit008_b01 (
...
ALTER TABLE  oltp.sbd_bcit008_b01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bcit008_b01 ADD CONSTRAINT sbd_bcit008_b01_PK PRIMARY KEY (hsn_cd,dst_cd,sel_case_yy,sel_case_mm,case_source,case_tp,serial_no);
