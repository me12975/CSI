...
DROP TABLE IF EXISTS  oltp.sbd_bcit008_d01;

CREATE TABLE  oltp.sbd_bcit008_d01 (
...
ban varchar(10) ,
sale_abnor varchar(1) ,
add_rate_abnor varchar(1) ,
invo_abnor varchar(1) ,
prs_abnor varchar(1) ,
pay_tax_abnor varchar(1) ,
purchs_sale_abnor varchar(1) ,
...
ALTER TABLE  oltp.sbd_bcit008_d01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bcit008_d01 ADD CONSTRAINT sbd_bcit008_d01_PK PRIMARY KEY (hsn_cd,dst_cd,sel_case_yy,sel_case_mm,case_source,case_tp,serial_no);
