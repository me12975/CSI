...
DROP TABLE IF EXISTS  oltp.sbd_bcmt001_d01;

CREATE TABLE  oltp.sbd_bcmt001_d01 (
...
ALTER TABLE  oltp.sbd_bcmt001_d01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bcmt001_d01 ADD CONSTRAINT sbd_bcmt001_d01_PK PRIMARY KEY (hsn_cd,dst_cd,data_bl_ym,case_source,case_tp,serial_no);
