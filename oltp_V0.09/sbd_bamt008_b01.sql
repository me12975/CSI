...
DROP TABLE IF EXISTS  oltp.sbd_bamt008_b01;

CREATE TABLE  oltp.sbd_bamt008_b01 (
...
ALTER TABLE  oltp.sbd_bamt008_b01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bamt008_b01 ADD CONSTRAINT sbd_bamt008_b01_PK PRIMARY KEY (idn_ban,apl_ym,vat_orgl_cp_no);
