...
DROP TABLE IF EXISTS  oltp.sbd_wiit001_b01;

CREATE TABLE  oltp.sbd_wiit001_b01 (
...
ALTER TABLE  oltp.sbd_wiit001_b01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_wiit001_b01 ADD CONSTRAINT sbd_wiit001_b01_PK PRIMARY KEY (clcn_rec_key);
