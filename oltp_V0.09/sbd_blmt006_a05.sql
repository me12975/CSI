...
DROP TABLE IF EXISTS  oltp.sbd_blmt006_a05;

CREATE TABLE  oltp.sbd_blmt006_a05 (
...
ALTER TABLE  oltp.sbd_blmt006_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_blmt006_a05 ADD CONSTRAINT sbd_blmt006_a05_PK PRIMARY KEY (data_ym,format_cd,p_s_item_pfn,flg_mk,seq_no);
