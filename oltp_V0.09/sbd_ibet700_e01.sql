...
DROP TABLE IF EXISTS  oltp.sbd_ibet700_e01;

CREATE TABLE  oltp.sbd_ibet700_e01 (
...
ALTER TABLE  oltp.sbd_ibet700_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ibet700_e01 ADD CONSTRAINT sbd_ibet700_e01_PK PRIMARY KEY (rfn,pers_idn,seq_no);
