...
DROP TABLE IF EXISTS  oltp.sbd_bimu008_e01;

CREATE TABLE  oltp.sbd_bimu008_e01 (
...
ALTER TABLE  oltp.sbd_bimu008_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bimu008_e01 ADD CONSTRAINT sbd_bimu008_e01_PK PRIMARY KEY (ban,update_date_time);
