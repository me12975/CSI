...
DROP TABLE IF EXISTS  oltp.sbd_ibet200_fdc;

CREATE TABLE  oltp.sbd_ibet200_fdc (
...
ALTER TABLE  oltp.sbd_ibet200_fdc OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ibet200_fdc ADD CONSTRAINT sbd_ibet200_fdc_PK PRIMARY KEY (rfn);
