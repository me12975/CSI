...
DROP TABLE IF EXISTS  oltp.sbd_ibet700_fdc;

CREATE TABLE  oltp.sbd_ibet700_fdc (
...
ALTER TABLE  oltp.sbd_ibet700_fdc OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ibet700_fdc ADD CONSTRAINT sbd_ibet700_fdc_PK PRIMARY KEY (rfn,pers_idn,seq_no);
