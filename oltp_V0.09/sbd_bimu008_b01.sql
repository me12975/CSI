...
DROP TABLE IF EXISTS  oltp.sbd_bimu008_b01;

CREATE TABLE  oltp.sbd_bimu008_b01 (
...
ALTER TABLE  oltp.sbd_bimu008_b01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bimu008_b01 ADD CONSTRAINT sbd_bimu008_b01_PK PRIMARY KEY (ban,update_date_time);
