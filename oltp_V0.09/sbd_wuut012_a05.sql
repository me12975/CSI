...
DROP TABLE IF EXISTS  oltp.sbd_wuut012_a05;

CREATE TABLE  oltp.sbd_wuut012_a05 (
...
ALTER TABLE  oltp.sbd_wuut012_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_wuut012_a05 ADD CONSTRAINT sbd_wuut012_a05_PK PRIMARY KEY (keyin_yy,ref_batch_no,serial_no,hsn_cd);
