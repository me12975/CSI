...
DROP TABLE IF EXISTS  oltp.sbd_nigt022_e01;

CREATE TABLE  oltp.sbd_nigt022_e01 (
dlv_unit varchar(3) ,
tax_cd varchar(2) ,
dlv_yr varchar(3) ,
flg_tp varchar(1) ,
...
ALTER TABLE  oltp.sbd_nigt022_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_nigt022_e01 ADD CONSTRAINT sbd_nigt022_e01_PK PRIMARY KEY (dlv_unit,tax_cd,dlv_yr,flg_tp,serial_no);
