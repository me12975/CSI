...
DROP TABLE IF EXISTS  oltp.sbd_blmt005_fdc;

CREATE TABLE  oltp.sbd_blmt005_fdc (
...
ALTER TABLE  oltp.sbd_blmt005_fdc OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_blmt005_fdc ADD CONSTRAINT sbd_blmt005_fdc_PK PRIMARY KEY (data_ym,format_cd,p_s_item_pfn,flg_mk,seq_no);
