...
DROP TABLE IF EXISTS  oltp.sbd_blot009_a05;

CREATE TABLE  oltp.sbd_blot009_a05 (
...
ALTER TABLE  oltp.sbd_blot009_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_blot009_a05 ADD CONSTRAINT sbd_blot009_a05_PK PRIMARY KEY (data_ym,ban,bill_of_sight_no,bill_of_sight_tp);
