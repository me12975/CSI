...
DROP TABLE IF EXISTS  oltp.sbd_bgmt008_e01;

CREATE TABLE  oltp.sbd_bgmt008_e01 (
...
ALTER TABLE  oltp.sbd_bgmt008_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bgmt008_e01 ADD CONSTRAINT sbd_bgmt008_e01_PK PRIMARY KEY (ban,partner_idn,data_yr);
