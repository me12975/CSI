...
DROP TABLE IF EXISTS  oltp.sbd_ifxt100_fdc;

CREATE TABLE  oltp.sbd_ifxt100_fdc (
...
ALTER TABLE  oltp.sbd_ifxt100_fdc OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ifxt100_fdc ADD CONSTRAINT sbd_ifxt100_fdc_PK PRIMARY KEY (rfn);
