...
DROP TABLE IF EXISTS  oltp.sbd_bcit009_d01;

CREATE TABLE  oltp.sbd_bcit009_d01 (
...
ALTER TABLE  oltp.sbd_bcit009_d01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bcit009_d01 ADD CONSTRAINT sbd_bcit009_d01_PK PRIMARY KEY (hsn_cd,dst_cd,sel_case_yy,sel_case_mm,case_source,case_tp,serial_no);
