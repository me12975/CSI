...
DROP TABLE IF EXISTS  oltp.sbd_bcit005_h01;

CREATE TABLE  oltp.sbd_bcit005_h01 (
...
ALTER TABLE  oltp.sbd_bcit005_h01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bcit005_h01 ADD CONSTRAINT sbd_bcit005_h01_PK PRIMARY KEY (org_group,hsn_cd,dst_cd,proj_cd);
