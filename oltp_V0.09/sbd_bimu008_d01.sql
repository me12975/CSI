...
DROP TABLE IF EXISTS  oltp.sbd_bimu008_d01;

CREATE TABLE  oltp.sbd_bimu008_d01 (
...
ALTER TABLE  oltp.sbd_bimu008_d01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bimu008_d01 ADD CONSTRAINT sbd_bimu008_d01_PK PRIMARY KEY (ban,update_date_time);
