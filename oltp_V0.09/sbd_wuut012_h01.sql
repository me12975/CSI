...
DROP TABLE IF EXISTS  oltp.sbd_wuut012_h01;

CREATE TABLE  oltp.sbd_wuut012_h01 (
...
ALTER TABLE  oltp.sbd_wuut012_h01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_wuut012_h01 ADD CONSTRAINT sbd_wuut012_h01_PK PRIMARY KEY (keyin_yy,ref_batch_no,serial_no,hsn_cd);
