...
DROP TABLE IF EXISTS  oltp.sbd_nigt037_a05;

CREATE TABLE  oltp.sbd_nigt037_a05 (
...
ALTER TABLE  oltp.sbd_nigt037_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_nigt037_a05 ADD CONSTRAINT sbd_nigt037_a05_PK PRIMARY KEY (suit_artc_cd);
