...
DROP TABLE IF EXISTS  oltp.sbd_blit028_e01;

CREATE TABLE  oltp.sbd_blit028_e01 (
...
ALTER TABLE  oltp.sbd_blit028_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_blit028_e01 ADD CONSTRAINT sbd_blit028_e01_PK PRIMARY KEY (format_cd,data_ym,p_s_item_pfn,flg_mk,seq_no);
