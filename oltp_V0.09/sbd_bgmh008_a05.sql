...
DROP TABLE IF EXISTS  oltp.sbd_bgmh008_a05;

CREATE TABLE  oltp.sbd_bgmh008_a05 (
...
ALTER TABLE  oltp.sbd_bgmh008_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bgmh008_a05 ADD CONSTRAINT sbd_bgmh008_a05_PK PRIMARY KEY (ban,partner_idn,data_yr,update_date_time,update_cd);
