...
DROP TABLE IF EXISTS  oltp.sbd_nigt065_a05;

CREATE TABLE  oltp.sbd_nigt065_a05 (
...
ALTER TABLE  oltp.sbd_nigt065_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_nigt065_a05 ADD CONSTRAINT sbd_nigt065_a05_PK PRIMARY KEY (dlv_unit,tax_cd,dlv_yr,flg_tp,serial_no);
