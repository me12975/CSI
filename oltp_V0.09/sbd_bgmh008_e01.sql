...
DROP TABLE IF EXISTS  oltp.sbd_bgmh008_e01;

CREATE TABLE  oltp.sbd_bgmh008_e01 (
...
ALTER TABLE  oltp.sbd_bgmh008_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bgmh008_e01 ADD CONSTRAINT sbd_bgmh008_e01_PK PRIMARY KEY (ban,partner_idn,data_yr,update_date_time,update_cd);
