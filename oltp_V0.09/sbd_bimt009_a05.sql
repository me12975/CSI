...
DROP TABLE IF EXISTS  oltp.sbd_bimt009_a05;

CREATE TABLE  oltp.sbd_bimt009_a05 (
...
ALTER TABLE  oltp.sbd_bimt009_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bimt009_a05 ADD CONSTRAINT sbd_bimt009_a05_PK PRIMARY KEY (agt_cd,agt_hsn_cd,agt_seq_no);
