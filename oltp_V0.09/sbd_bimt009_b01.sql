...
DROP TABLE IF EXISTS  oltp.sbd_bimt009_b01;

CREATE TABLE  oltp.sbd_bimt009_b01 (
...
ALTER TABLE  oltp.sbd_bimt009_b01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bimt009_b01 ADD CONSTRAINT sbd_bimt009_b01_PK PRIMARY KEY (agt_cd,agt_hsn_cd,agt_seq_no);
