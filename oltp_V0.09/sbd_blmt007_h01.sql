...
DROP TABLE IF EXISTS  oltp.sbd_blmt007_h01;

CREATE TABLE  oltp.sbd_blmt007_h01 (
...
ALTER TABLE  oltp.sbd_blmt007_h01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_blmt007_h01 ADD CONSTRAINT sbd_blmt007_h01_PK PRIMARY KEY (data_ym,format_cd,p_s_item_pfn,flg_mk,seq_no);
