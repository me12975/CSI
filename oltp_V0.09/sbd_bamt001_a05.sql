...
DROP TABLE IF EXISTS  oltp.sbd_bamt001_a05;

CREATE TABLE  oltp.sbd_bamt001_a05 (
...
ALTER TABLE  oltp.sbd_bamt001_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bamt001_a05 ADD CONSTRAINT sbd_bamt001_a05_PK PRIMARY KEY (ban,bl_ym);
