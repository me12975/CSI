...
DROP TABLE IF EXISTS  oltp.sbd_wuut012_b01;

CREATE TABLE  oltp.sbd_wuut012_b01 (
...
ALTER TABLE  oltp.sbd_wuut012_b01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_wuut012_b01 ADD CONSTRAINT sbd_wuut012_b01_PK PRIMARY KEY (keyin_yy,ref_batch_no,serial_no,hsn_cd);
