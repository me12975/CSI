...
DROP TABLE IF EXISTS  oltp.sbd_ifxt100_b01;

CREATE TABLE  oltp.sbd_ifxt100_b01 (
...
ALTER TABLE  oltp.sbd_ifxt100_b01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ifxt100_b01 ADD CONSTRAINT sbd_ifxt100_b01_PK PRIMARY KEY (rfn);
