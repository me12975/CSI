...
DROP TABLE IF EXISTS  oltp.sbd_ibet600_fdc;

CREATE TABLE  oltp.sbd_ibet600_fdc (
...
ALTER TABLE  oltp.sbd_ibet600_fdc OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ibet600_fdc ADD CONSTRAINT sbd_ibet600_fdc_PK PRIMARY KEY (rfn,item_no,incmer_idn);
