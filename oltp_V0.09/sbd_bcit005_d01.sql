...
DROP TABLE IF EXISTS  oltp.sbd_bcit005_d01;

CREATE TABLE  oltp.sbd_bcit005_d01 (
...
ALTER TABLE  oltp.sbd_bcit005_d01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bcit005_d01 ADD CONSTRAINT sbd_bcit005_d01_PK PRIMARY KEY (org_group,hsn_cd,dst_cd,proj_cd);
