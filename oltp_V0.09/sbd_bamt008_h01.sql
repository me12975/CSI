...
DROP TABLE IF EXISTS  oltp.sbd_bamt008_h01;

CREATE TABLE  oltp.sbd_bamt008_h01 (
...
ALTER TABLE  oltp.sbd_bamt008_h01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bamt008_h01 ADD CONSTRAINT sbd_bamt008_h01_PK PRIMARY KEY (idn_ban,apl_ym,vat_orgl_cp_no);
