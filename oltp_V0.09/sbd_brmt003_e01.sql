...
DROP TABLE IF EXISTS  oltp.sbd_brmt003_e01;

CREATE TABLE  oltp.sbd_brmt003_e01 (
...
ALTER TABLE  oltp.sbd_brmt003_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_brmt003_e01 ADD CONSTRAINT sbd_brmt003_e01_PK PRIMARY KEY (bl_yr,bl_mm,ban,unfile_mk);
