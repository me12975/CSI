...
DROP TABLE IF EXISTS  oltp.sbd_ibet600_a05;

CREATE TABLE  oltp.sbd_ibet600_a05 (
...
ALTER TABLE  oltp.sbd_ibet600_a05 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ibet600_a05 ADD CONSTRAINT sbd_ibet600_a05_PK PRIMARY KEY (rfn,item_no,incmer_idn);
