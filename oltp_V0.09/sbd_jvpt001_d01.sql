...
DROP TABLE IF EXISTS  oltp.sbd_jvpt001_d01;

CREATE TABLE  oltp.sbd_jvpt001_d01 (
...
ALTER TABLE  oltp.sbd_jvpt001_d01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_jvpt001_d01 ADD CONSTRAINT sbd_jvpt001_d01_PK PRIMARY KEY (asg_busi_tp,data_bl_yr,asg_no,chk_tms);
