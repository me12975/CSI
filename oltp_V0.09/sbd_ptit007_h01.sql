...
DROP TABLE IF EXISTS  oltp.sbd_ptit007_h01;

CREATE TABLE  oltp.sbd_ptit007_h01 (
...
ALTER TABLE  oltp.sbd_ptit007_h01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ptit007_h01 ADD CONSTRAINT sbd_ptit007_h01_PK PRIMARY KEY (payment_unit_ban,seq_no);
