...
DROP TABLE IF EXISTS  oltp.sbd_ibrt101_fdc;

CREATE TABLE  oltp.sbd_ibrt101_fdc (
...
ALTER TABLE  oltp.sbd_ibrt101_fdc OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_ibrt101_fdc ADD CONSTRAINT sbd_ibrt101_fdc_PK PRIMARY KEY (idn);
