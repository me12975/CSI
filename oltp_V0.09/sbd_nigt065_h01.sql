...
DROP TABLE IF EXISTS  oltp.sbd_nigt065_h01;

CREATE TABLE  oltp.sbd_nigt065_h01 (
...
ALTER TABLE  oltp.sbd_nigt065_h01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_nigt065_h01 ADD CONSTRAINT sbd_nigt065_h01_PK PRIMARY KEY (dlv_unit,tax_cd,dlv_yr,flg_tp,serial_no);
