...
DROP TABLE IF EXISTS  oltp.sbd_bimt009_e01;

CREATE TABLE  oltp.sbd_bimt009_e01 (
...
ALTER TABLE  oltp.sbd_bimt009_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_bimt009_e01 ADD CONSTRAINT sbd_bimt009_e01_PK PRIMARY KEY (agt_cd,agt_hsn_cd,agt_seq_no);
