...
DROP TABLE IF EXISTS  oltp.sbd_davt001_e01;

CREATE TABLE  oltp.sbd_davt001_e01 (
...
ALTER TABLE  oltp.sbd_davt001_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_davt001_e01 ADD CONSTRAINT sbd_davt001_e01_PK PRIMARY KEY (heired_idn);
