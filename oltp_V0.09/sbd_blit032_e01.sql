...
DROP TABLE IF EXISTS  oltp.sbd_blit032_e01;

CREATE TABLE  oltp.sbd_blit032_e01 (
...
ALTER TABLE  oltp.sbd_blit032_e01 OWNER TO ap_sbd;

ALTER TABLE ONLY  oltp.sbd_blit032_e01 ADD CONSTRAINT sbd_blit032_e01_PK PRIMARY KEY (data_ym,ban,format_cd,pfn,seq_no,asg_date);
