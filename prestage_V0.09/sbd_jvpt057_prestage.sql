...
DROP TABLE IF EXISTS  prestage.sbd_jvpt057_prestage;

CREATE TABLE  prestage.sbd_jvpt057_prestage (
asg_busi_tp varchar(3) ,
data_bl_yr varchar(3) ,
asg_no varchar(17) ,
chk_tms varchar(2) ,
d_goal_item_cd varchar(2) ,
d_goal_item_cd0 varchar(2) ,
...
submit_date varchar(7) ,
upd_reas_tp varchar(1) ,
apl_tp varchar(1) ,
case_tp varchar(3) ,
case_source varchar(2) ,
re_chk_tms decimal(2,0) ,
m_submit_tms decimal(2,0) ,
acu_submit_tms decimal(2,0) ,
d_goal_item_cnt decimal(1,0) ,
d_goal_item_cnt0 decimal(1,0) ,
apl_incm_t decimal(14,0) ,
adj_y_incm_amt decimal(14,0) ,
apl_tax decimal(14,0) ,
adj_pybl_tax decimal(14,0) ,
adjs_invt_ctx decimal(14,0) ,
d_goal_amt decimal(14,0) ,
d_goal_amt0 decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_jvpt057_prestage OWNER TO ap_sbd;
