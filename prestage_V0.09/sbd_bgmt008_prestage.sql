...
DROP TABLE IF EXISTS  prestage.sbd_bgmt008_prestage;

CREATE TABLE  prestage.sbd_bgmt008_prestage (
ban varchar(8) ,
...
ALTER TABLE  prestage.sbd_bgmt008_prestage OWNER TO ap_sbd;
