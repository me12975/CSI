...
-- Purpose: Prestage資料表;
-- Table: sbd_blmt012_prestage;
-- Compressed: N ;
-- Distributed: Y (agent_idn_ban);
...
DROP TABLE IF EXISTS  prestage.sbd_blmt012_prestage;

CREATE TABLE  prestage.sbd_blmt012_prestage (
...
ALTER TABLE  prestage.sbd_blmt012_prestage OWNER TO ap_sbd;
