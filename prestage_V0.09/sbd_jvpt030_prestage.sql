...
DROP TABLE IF EXISTS  prestage.sbd_jvpt030_prestage;

CREATE TABLE  prestage.sbd_jvpt030_prestage (
...
empl_cd varchar(5) ,
asg_stus_tp varchar(4) ,
proc_date varchar(7) ,
next_asg_org_cd varchar(3) ,
next_sctn_cd varchar(2) ,
next_scttm_cd varchar(2) ,
next_asg_resp_unit varchar(1) ,
flow_rec_seq_no varchar(4) ,
...
ALTER TABLE  prestage.sbd_jvpt030_prestage OWNER TO ap_sbd;
