...
-- Purpose: Prestage資料表;
-- Table: sbd_brmt012_prestage;
-- Compressed: N ;
-- Distributed: Y (data_source_mk,data_kd,ban,ctrl_no);
...
DROP TABLE IF EXISTS  prestage.sbd_brmt012_prestage;

CREATE TABLE  prestage.sbd_brmt012_prestage (
data_source_mk varchar(2) ,
data_kd varchar(2) ,
ban varchar(8) ,
busi_item varchar(25) ,
ctrl_no varchar(50) ,
chi_addr varchar(68) ,
update_cd varchar(1) ,
...
appr_date varchar(7) ,
revo_date varchar(7) ,
pht_end_date varchar(7) ,
pht_beg_date varchar(7) ,
chi_name varchar(104) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (data_source_mk,data_kd,ban,ctrl_no)
...
ALTER TABLE  prestage.sbd_brmt012_prestage OWNER TO ap_sbd;
