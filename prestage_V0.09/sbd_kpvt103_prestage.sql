...
-- Purpose: Prestage資料表;
-- Table: sbd_kpvt103_prestage;
-- Compressed: N ;
-- Distributed: Y (co_ban);
...
DROP TABLE IF EXISTS  prestage.sbd_kpvt103_prestage;

CREATE TABLE  prestage.sbd_kpvt103_prestage (
co_ban varchar(8) ,
nta_cd varchar(1) ,
data_tp varchar(1) ,
orgn_tp varchar(1) ,
estab_stus varchar(2) ,
bscd varchar(7) ,
stk_isu_mk varchar(1) ,
bond_isu_mk varchar(1) ,
oth_isu_mk varchar(1) ,
reg_capital decimal(14,0) ,
capital decimal(14,0) ,
capital1 decimal(14,0) ,
stk_pblc_mk varchar(1) ,
bond_pblc_mk varchar(1) ,
oth_scts_pblc_mk varchar(1) ,
stk_lst_otc_mk varchar(1) ,
bond_lst_otc_mk varchar(1) ,
oth_lst_otc_mk varchar(1) ,
source_update_date varchar(7) ,
update_cd varchar(1) ,
reg_date varchar(7) ,
vat_losn varchar(9) ,
scts_fv decimal(8,0) ,
bond_isu_amt decimal(14,0) ,
oth_isu_amt decimal(14,0) ,
bond_int_cond_mk varchar(1) ,
oth_int_cond_mk varchar(1) ,
otc_date varchar(7) ,
deotc_date varchar(7) ,
hsn_cd varchar(1) ,
resp_idn varchar(10) ,
resp_nm varchar(20) ,
co_nm varchar(30) ,
chi_addr varchar(68) ,
stk_isu_date varchar(7) ,
bond_isu_date varchar(7) ,
oth_isu_date varchar(7) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (co_ban)
...
ALTER TABLE  prestage.sbd_kpvt103_prestage OWNER TO ap_sbd;
