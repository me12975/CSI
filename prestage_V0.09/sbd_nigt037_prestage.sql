...
DROP TABLE IF EXISTS  prestage.sbd_nigt037_prestage;

CREATE TABLE  prestage.sbd_nigt037_prestage (
suit_artc_cd varchar(7) ,
...
ALTER TABLE  prestage.sbd_nigt037_prestage OWNER TO ap_sbd;
