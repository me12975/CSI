...
DROP TABLE IF EXISTS  prestage.sbd_pact032_prestage;

CREATE TABLE  prestage.sbd_pact032_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
recev_no varchar(8) ,
chk_tms varchar(2) ,
...
aptm_sh_int decimal(14,0) ,
sh_int decimal(14,0) ,
tot_suple_tax decimal(14,0) ,
zsy_acu_pfls_bef86y decimal(14,0) ,
dist_divd_pf_bef86y decimal(14,0) ,
acu_pfls_cmpt_samt1 decimal(14,0) ,
zsy_pf_offset_bef86y decimal(14,0) ,
acu_pfls_cmpt_aamt1 decimal(14,0) ,
acu_pfls_bef86y decimal(14,0) ,
zsy_pfls_num_aft87y decimal(14,0) ,
dist_divd_pf_aft87y decimal(14,0) ,
acu_pfls_cmpt_samt2 decimal(14,0) ,
zsy_pf_offset_aft87y decimal(14,0) ,
acu_pfls_cmpt_aamt2 decimal(14,0) ,
acu_pfls_aft87y decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_pact032_prestage OWNER TO ap_sbd;
