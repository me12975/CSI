...
-- Purpose: Prestage資料表;
-- Table: sbd_ihgt007_prestage;
-- Compressed: N ;
-- Distributed: Y (hou_losn,holder_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_ihgt007_prestage;

CREATE TABLE  prestage.sbd_ihgt007_prestage (
hou_losn varchar(12) ,
holder_idn varchar(10) ,
data_yr varchar(3) ,
hold_b_date varchar(7) ,
hold_e_date varchar(7) ,
apl_list_no varchar(12) ,
holder_nm varchar(20) ,
holder_haddr varchar(80) ,
hou_id_cd varchar(1) ,
hou_xmp_cd varchar(1) ,
hou_loc varchar(80) ,
hou_tot_area decimal(11,2) ,
shr_pr_val decimal(14) ,
busi_pr_val decimal(14) ,
resd_pr_val decimal(14) ,
nrb_pr_val decimal(14) ,
tot_floor varchar(3) ,
pure_resd_cd varchar(1) ,
shr_nmrt decimal(10) ,
shr_dnt decimal(10) ,
iit_pfn varchar(17) ,
tpr_idn varchar(10) ,
tpr_nm varchar(20) ,
holder_id_cd varchar(1) ,
hold_spous_idn varchar(10) ,
holder_spous_nm varchar(20) ,
tpr_spous_idn varchar(10) ,
town_nm varchar(8) ,
vill_nm varchar(8) ,
hou_stus1 varchar(1) ,
hou_stus2 varchar(1) ,
...
road_cd varchar(4) ,
reply_yr varchar(3) ,
l2y_data_str_addr varchar(16) ,
l2y_apl_rent decimal(14) ,
l2y_court_rent decimal(14) ,
ly_court_rent decimal(14) ,
user_idn_ban1 varchar(10) ,
user_idn_ban2 varchar(10) ,
hou_build_num_tot decimal(3) ,
pure_resd_build decimal(3) ,
hou_loc_org_cd varchar(3) ,
bureau_cd varchar(1) ,
sel_chk_mk varchar(1) ,
reply_mk varchar(1) ,
match_mk varchar(1) ,
hou_prop_mk varchar(1) ,
o_hou_losn varchar(12) ,
o_holder_idn varchar(10) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hou_losn,holder_idn)
...
ALTER TABLE  prestage.sbd_ihgt007_prestage OWNER TO ap_sbd;
