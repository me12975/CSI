...
DROP TABLE IF EXISTS  prestage.sbd_bmst006_prestage;

CREATE TABLE  prestage.sbd_bmst006_prestage (
coll_ym varchar(5) ,
pr_cd varchar(1) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
...
ALTER TABLE  prestage.sbd_bmst006_prestage OWNER TO ap_sbd;
