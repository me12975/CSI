...
-- Purpose: Prestage資料表;
-- Table: sbd_wmmt550_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,tax_subtax_cd,gove_priv_tp,assess_data_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_wmmt550_prestage;

CREATE TABLE  prestage.sbd_wmmt550_prestage (
data_ym varchar(5) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
tax_subtax_cd varchar(3) ,
gove_priv_tp varchar(1) ,
assess_data_tp decimal(2,0) ,
m_amt decimal(13,0) ,
m_cnt decimal(7,0) ,
acu_cnt decimal(9,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,tax_subtax_cd,gove_priv_tp,assess_data_tp)
...
ALTER TABLE  prestage.sbd_wmmt550_prestage OWNER TO ap_sbd;
