...
-- Purpose: Prestage資料表;
-- Table: sbd_wsst820_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_wsst820_prestage;

CREATE TABLE  prestage.sbd_wsst820_prestage (
hsn_cd varchar(1) ,
hsn_nm varchar(3) ,
org_nm varchar(10) ,
...
ALTER TABLE  prestage.sbd_wsst820_prestage OWNER TO ap_sbd;
