...
DROP TABLE IF EXISTS  prestage.sbd_puat006_prestage;

CREATE TABLE  prestage.sbd_puat006_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
recev_no varchar(8) ,
bkkpr_nm varchar(40) ,
bkkpr_idn varchar(10) ,
acc_b_date varchar(7) ,
acc_e_date varchar(7) ,
acc_m_fee decimal(14,0) ,
acc_y_fee decimal(14,0) ,
acc_mk varchar(1) ,
agent_idn varchar(10) ,
agent_lic_no varchar(5) ,
cpa_auth_fee decimal(14,0) ,
keyin_id_cd varchar(8) ,
keyin_date varchar(7) ,
update_cd varchar(1) ,
time_stamp timestamp ,
bkkpr_lic_no varchar(40) ,
agt_nm varchar(40) ,
agt_tel_no varchar(20) ,
bkkpr_tel_no varchar(20) ,
agent_filer_nm varchar(40) ,
agent_filer_tel varchar(20) ,
agent_filer_idn varchar(10) ,
agent_filer_lic_no varchar(40) ,
agent_b_date varchar(7) ,
agent_e_date varchar(7) ,
commit_acc_mk varchar(1) ,
slf_commit_mk varchar(1) ,
agent_lic_tp varchar(1) ,
agent_acc_nm varchar(40) ,
agent_men_idn varchar(11) ,
bkkpr_lic_tp varchar(1) ,
orgn_bkkpr_hsn_nm varchar(40) ,
...
ALTER TABLE  prestage.sbd_puat006_prestage OWNER TO ap_sbd;
