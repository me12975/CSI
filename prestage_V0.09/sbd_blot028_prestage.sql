...
DROP TABLE IF EXISTS  prestage.sbd_blot028_prestage;

CREATE TABLE  prestage.sbd_blot028_prestage (
...
hou_losn varchar(12) ,
tran_hou_loc varchar(80) ,
o_holder_idn_ban varchar(10) ,
o_holder_losn varchar(12) ,
o_holder_nm varchar(52) ,
o_holder_addr varchar(80) ,
n_holder_idn_ban varchar(10) ,
n_holder_nm varchar(52) ,
flg_date varchar(7) ,
ctrt_date varchar(7) ,
tran_prc decimal(14,0) ,
hou_std_prc decimal(14,0) ,
hou_tot_area decimal(8,2) ,
shr_nmrt decimal(5,0) ,
shr_dnt decimal(5,0) ,
trd_mk varchar(1) ,
morg_mk varchar(1) ,
exch_mk varchar(1) ,
...
dvsn_mk varchar(1) ,
hold_mk varchar(1) ,
cnstrt_chg_mk varchar(1) ,
start_pty_mk varchar(1) ,
auction_mk varchar(1) ,
...
apl_deedprc decimal(14,0) ,
o_file_no varchar(14) ,
o_keyin_date varchar(7) ,
o_keyin_id_cd varchar(10) ,
o_upd_tp varchar(1) ,
o_err_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_blot028_prestage OWNER TO ap_sbd;
