...
-- Purpose: Prestage資料表;
-- Table: sbd_jvpt009_prestage;
-- Compressed: N ;
-- Distributed: Y (seq_no,bl_org_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_jvpt009_prestage;

CREATE TABLE  prestage.sbd_jvpt009_prestage (
seq_no varchar(8) ,
databag_no varchar(11) ,
ntf_no varchar(27) ,
org_cd varchar(3) ,
sctn_cd varchar(2) ,
scttm_cd varchar(2) ,
data_bl_yr varchar(3) ,
levy_pd varchar(1) ,
safe_no varchar(17) ,
seize_org varchar(4) ,
...
data_tp_cd1 varchar(3) ,
data_tp_cd2 varchar(3) ,
data_tp_cd3 varchar(3) ,
data_tp_cd4 varchar(3) ,
data_tp_cd5 varchar(3) ,
data_tp_cnt1 decimal(4,0) ,
data_tp_cnt2 decimal(4,0) ,
data_tp_cnt3 decimal(4,0) ,
data_tp_cnt4 decimal(4,0) ,
data_tp_cnt5 decimal(4,0) ,
data_tp_page_num1 decimal(4,0) ,
data_tp_page_num2 decimal(4,0) ,
data_tp_page_num3 decimal(4,0) ,
data_tp_page_num4 decimal(4,0) ,
data_tp_page_num5 decimal(4,0) ,
o_ntf_date varchar(7) ,
o_ntfd_unit varchar(7) ,
no_reply_mk varchar(1) ,
npnsh_mk varchar(1) ,
urgt_mk varchar(1) ,
finish_date varchar(7) ,
tax_rtn_comb_mk varchar(1) ,
asg_comb_key varchar(25) ,
comb_date varchar(7) ,
evade_tax_amt decimal(14,0) ,
evade_tax_amt1 decimal(14,0) ,
evade_tax_amt2 decimal(14,0) ,
evade_tax_amt3 decimal(14,0) ,
evade_tax_amt4 decimal(14,0) ,
evade_tax_amt5 decimal(14,0) ,
seize_amt decimal(14,0) ,
ntf_amt decimal(14,0) ,
adj_incm_amt decimal(14,0) ,
adj_incm_amt1 decimal(14,0) ,
adj_incm_amt2 decimal(14,0) ,
adj_incm_amt3 decimal(14,0) ,
adj_incm_amt4 decimal(14,0) ,
adj_incm_amt5 decimal(14,0) ,
create_date varchar(7) ,
time_stamp timestamp ,
update_id_cd varchar(5) ,
update_date varchar(7) ,
databag_ntf_date varchar(7) ,
remark varchar(40) ,
adt_id_cd varchar(8) ,
mend_levy_tax_amt decimal(14,0) ,
mend_levy_tax_amt1 decimal(14,0) ,
mend_levy_tax_amt2 decimal(14,0) ,
mend_levy_tax_amt3 decimal(14,0) ,
mend_levy_tax_amt4 decimal(14,0) ,
mend_levy_tax_amt5 decimal(14,0) ,
acrs_ntf_ntf_no varchar(27) ,
data_tp_nm1 varchar(24) ,
data_tp_nm2 varchar(24) ,
data_tp_nm3 varchar(24) ,
data_tp_nm4 varchar(24) ,
data_tp_nm5 varchar(24) ,
bl_org_cd varchar(3) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (seq_no,bl_org_cd)
...
ALTER TABLE  prestage.sbd_jvpt009_prestage OWNER TO ap_sbd;
