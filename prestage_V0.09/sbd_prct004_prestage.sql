...
DROP TABLE IF EXISTS  prestage.sbd_prct004_prestage;

CREATE TABLE  prestage.sbd_prct004_prestage (
data_yr varchar(3) ,
flg_mk varchar(1) ,
ban varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
recev_no varchar(8) ,
mfg_imnl decimal(14,0) ,
mfg_rent_exp decimal(14,0) ,
mfg_stnry decimal(14,0) ,
mfg_trvl_fee decimal(14,0) ,
mfg_frgt decimal(14,0) ,
mfg_post_tel_fee decimal(14,0) ,
mfg_rpa_exp decimal(14,0) ,
mfg_pkg_fee decimal(14,0) ,
mfg_water_ele_fee decimal(14,0) ,
mfg_ins decimal(14,0) ,
mfg_prcd_fee decimal(14,0) ,
mfg_tax_amt decimal(14,0) ,
mfg_depr_amt decimal(14,0) ,
mfg_depl_apn decimal(14,0) ,
mfg_meals_fee decimal(14,0) ,
mfg_empl_ben decimal(14,0) ,
oth_mfg_exp decimal(14,0) ,
mfg_exp_elmt decimal(14,0) ,
mfg_exp_t decimal(14,0) ,
force_mk varchar(1) ,
update_cd varchar(1) ,
keyin_id_cd varchar(8) ,
keyin_date varchar(7) ,
time_stamp timestamp ,
acc_stl_mfg_imnl decimal(14,0) ,
acc_mfg_rent_exp decimal(14,0) ,
acc_stl_mfg_stnry decimal(14,0) ,
acc_mfg_trvl_fee decimal(14,0) ,
acc_stl_mfg_frgt decimal(14,0) ,
acc_mfg_post_tel decimal(14,0) ,
acc_mfg_rpa_exp decimal(14,0) ,
acc_mfg_pkg_fee decimal(14,0) ,
acc_mfg_water_ele decimal(14,0) ,
acc_stl_mfg_ins decimal(14,0) ,
acc_mfg_prcd_fee decimal(14,0) ,
acc_mfg_tax_amt decimal(14,0) ,
acc_mfg_depr_amt decimal(14,0) ,
acc_mfg_depl_apn decimal(14,0) ,
acc_mfg_meals_fee decimal(14,0) ,
acc_mfg_empl_ben decimal(14,0) ,
acc_oth_mfg_exp decimal(14,0) ,
acc_stl_mfg_exp_t decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_prct004_prestage OWNER TO ap_sbd;
