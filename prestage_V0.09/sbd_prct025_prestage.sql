...
-- Purpose: Prestage資料表;
-- Table: sbd_prct025_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,abate_clause,recev_no);
...
DROP TABLE IF EXISTS  prestage.sbd_prct025_prestage;

CREATE TABLE  prestage.sbd_prct025_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
...
ALTER TABLE  prestage.sbd_prct025_prestage OWNER TO ap_sbd;
