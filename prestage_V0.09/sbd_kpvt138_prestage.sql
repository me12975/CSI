...
-- Purpose: Prestage資料表;
-- Table: sbd_kpvt138_prestage;
-- Compressed: N ;
-- Distributed: Y (brk_cd,brk_trade_tp,stt_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_kpvt138_prestage;

CREATE TABLE  prestage.sbd_kpvt138_prestage (
brk_cd varchar(4) ,
brk_trade_tp varchar(1) ,
trdng_date varchar(7) ,
stt_tp varchar(2) ,
stk_nums decimal(10,0) ,
trade_amt decimal(14,0) ,
stk_trdng_tax decimal(12,0) ,
hsn_cd varchar(1) ,
co_ban varchar(8) ,
update_cd varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (brk_cd,brk_trade_tp,stt_tp)
...
ALTER TABLE  prestage.sbd_kpvt138_prestage OWNER TO ap_sbd;
