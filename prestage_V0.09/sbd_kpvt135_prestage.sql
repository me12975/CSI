...
-- Purpose: Prestage資料表;
-- Table: sbd_kpvt135_prestage;
-- Compressed: N ;
-- Distributed: Y (brk_cd,brk_trade_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_kpvt135_prestage;

CREATE TABLE  prestage.sbd_kpvt135_prestage (
brk_cd varchar(4) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (brk_cd,brk_trade_tp)
...
ALTER TABLE  prestage.sbd_kpvt135_prestage OWNER TO ap_sbd;
