...
-- Purpose: Prestage資料表;
-- Table: sbd_bgmu009_prestage;
-- Compressed: N ;
-- Distributed: Y (seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_bgmu009_prestage;

CREATE TABLE  prestage.sbd_bgmu009_prestage (
lrg_bscd varchar(1) ,
bscd varchar(6) ,
...
ALTER TABLE  prestage.sbd_bgmu009_prestage OWNER TO ap_sbd;
