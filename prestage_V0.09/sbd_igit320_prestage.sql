...
-- Purpose: Prestage資料表;
-- Table: sbd_igit320_prestage;
-- Compressed: N ;
-- Distributed: Y (asg_no,chk_tms);
...
DROP TABLE IF EXISTS  prestage.sbd_igit320_prestage;

CREATE TABLE  prestage.sbd_igit320_prestage (
asg_busi_tp varchar(3) ,
data_bl_yr varchar(3) ,
asg_no varchar(17) ,
chk_tms varchar(2) ,
finish_date varchar(7) ,
add_incm_slry decimal(12,0) ,
add_incm_lse decimal(12,0) ,
add_incm_int decimal(12,0) ,
add_incm_roy decimal(12,0) ,
add_incm_pf decimal(12,0) ,
add_incm_prof decimal(12,0) ,
add_incm_prize_bonus decimal(12,0) ,
add_incm_retire decimal(12,0) ,
add_incm_oth decimal(12,0) ,
add_tax_slry decimal(12,0) ,
add_tax_lse decimal(12,0) ,
add_tax_int decimal(12,0) ,
add_tax_roy decimal(12,0) ,
add_tax_pf decimal(12,0) ,
add_tax_prof decimal(12,0) ,
add_tax_prize_bonus decimal(12,0) ,
add_tax_retire decimal(12,0) ,
add_tax_oth decimal(12,0) ,
vio_incm_slry decimal(12,0) ,
vio_incm_lse decimal(12,0) ,
vio_incm_int decimal(12,0) ,
vio_incm_roy decimal(12,0) ,
vio_incm_pf decimal(12,0) ,
vio_incm_prof decimal(12,0) ,
vio_incm_prize_bonus decimal(12,0) ,
vio_incm_retire decimal(12,0) ,
vio_incm_oth decimal(12,0) ,
vio_tax_slry decimal(12,0) ,
vio_tax_lse decimal(12,0) ,
vio_tax_int decimal(12,0) ,
vio_tax_roy decimal(12,0) ,
vio_tax_pf decimal(12,0) ,
vio_tax_prof decimal(12,0) ,
vio_tax_prize_bonus decimal(12,0) ,
vio_tax_retire decimal(12,0) ,
vio_tax_oth decimal(12,0) ,
update_id_cd varchar(5) ,
update_date varchar(7) ,
asg_org_cd varchar(3) ,
sctn_cd varchar(2) ,
scttm_cd varchar(2) ,
case_tp varchar(3) ,
yn_void_case varchar(1) ,
void_reas_cd varchar(1) ,
yn_upd varchar(1) ,
oth_void_reas varchar(40) ,
data_bl_yr_b varchar(3) ,
data_bl_yr_e varchar(3) ,
outj_unit_cd varchar(7) ,
vio_manage_cd varchar(24) ,
file_number varchar(10) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (asg_no,chk_tms)
...
ALTER TABLE  prestage.sbd_igit320_prestage OWNER TO ap_sbd;
