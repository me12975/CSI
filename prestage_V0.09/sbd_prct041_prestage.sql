...
-- Purpose: Prestage資料表;
-- Table: sbd_prct041_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,recev_no,apl_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_prct041_prestage;

CREATE TABLE  prestage.sbd_prct041_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
recev_no varchar(8) ,
apl_yr varchar(3) ,
apl_tp varchar(1) ,
n_loss decimal(14,0) ,
ly_paid_ded decimal(14,0) ,
zsy_ded decimal(14,0) ,
un_ded decimal(14,0) ,
update_cd varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (ban,recev_no,apl_tp)
...
ALTER TABLE  prestage.sbd_prct041_prestage OWNER TO ap_sbd;
