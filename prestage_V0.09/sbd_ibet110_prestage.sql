...
DROP TABLE IF EXISTS  prestage.sbd_ibet110_prestage;

CREATE TABLE  prestage.sbd_ibet110_prestage (
rfn varchar(17) ,
...
ovrse_crd_lmt decimal(14,0) ,
ovrse_paid_tax_cert decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_ibet110_prestage OWNER TO ap_sbd;
