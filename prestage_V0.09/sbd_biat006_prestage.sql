...
DROP TABLE IF EXISTS  prestage.sbd_biat006_prestage;

CREATE TABLE  prestage.sbd_biat006_prestage (
...
ALTER TABLE  prestage.sbd_biat006_prestage OWNER TO ap_sbd;
