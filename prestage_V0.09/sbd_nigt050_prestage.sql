...
-- Purpose: Prestage資料表;
-- Table: sbd_nigt050_prestage;
-- Compressed: N ;
-- Distributed: Y (stat_ym,org_cd,tax_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_nigt050_prestage;

CREATE TABLE  prestage.sbd_nigt050_prestage (
stat_ym varchar(5) ,
org_cd varchar(3) ,
tax_cd varchar(2) ,
asg_cnt decimal(6,0) ,
jdgf_fsh_cnt decimal(6,0) ,
oth_fsh_cnt decimal(6,0) ,
npnsh_fsh_cnt decimal(6,0) ,
comb_fsh_cnt decimal(6,0) ,
delete_fsh_cnt decimal(6,0) ,
un_extd_fsh_cnt decimal(6,0) ,
extd_fsh_cnt decimal(6,0) ,
ov_due_fsh_cnt decimal(6,0) ,
fsh_cnt decimal(6,0) ,
un_fsh_cnt decimal(6,0) ,
un_ov_due_cnt decimal(6,0) ,
od2m_cnt decimal(6,0) ,
jdgf_amt_tot decimal(14,0) ,
evade_tax_tot decimal(14,0) ,
auth_arrg_mtg_cnt decimal(6,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (stat_ym,org_cd,tax_cd)
...
ALTER TABLE  prestage.sbd_nigt050_prestage OWNER TO ap_sbd;
