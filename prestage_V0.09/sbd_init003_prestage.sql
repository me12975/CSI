...
DROP TABLE IF EXISTS  prestage.sbd_init003_prestage;

CREATE TABLE  prestage.sbd_init003_prestage (
...
ALTER TABLE  prestage.sbd_init003_prestage OWNER TO ap_sbd;
