...
-- Purpose: Prestage資料表;
-- Table: sbd_wsst810_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_tax_juris_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_wsst810_prestage;

CREATE TABLE  prestage.sbd_wsst810_prestage (
hsn_tax_juris_cd varchar(3) ,
hsn_tax_juris_nm varchar(11) ,
hsn_tax_juris_shnm varchar(6) ,
gvnr_srnm varchar(2) ,
gvnr_nm varchar(6) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hsn_tax_juris_cd)
...
ALTER TABLE  prestage.sbd_wsst810_prestage OWNER TO ap_sbd;
