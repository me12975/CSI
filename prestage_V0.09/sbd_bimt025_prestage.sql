...
-- Purpose: Prestage資料表;
-- Table: sbd_bimt025_prestage;
-- Compressed: N ;
-- Distributed: Y (invo_track,invo_no);
...
DROP TABLE IF EXISTS  prestage.sbd_bimt025_prestage;

CREATE TABLE  prestage.sbd_bimt025_prestage (
invo_ym varchar(5) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (invo_track,invo_no)
...
ALTER TABLE  prestage.sbd_bimt025_prestage OWNER TO ap_sbd;
