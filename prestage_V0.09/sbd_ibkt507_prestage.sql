...
-- Purpose: Prestage資料表;
-- Table: sbd_ibkt507_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn,death_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_ibkt507_prestage;

CREATE TABLE  prestage.sbd_ibkt507_prestage (
rfn varchar(17) ,
...
incm_pfn_hsn_tp varchar(1) ,
incm_pfn_org varchar(2) ,
incm_pfn_death_idn varchar(10) ,
incm_pfn_fam_no varchar(8) ,
...
ALTER TABLE  prestage.sbd_ibkt507_prestage OWNER TO ap_sbd;
