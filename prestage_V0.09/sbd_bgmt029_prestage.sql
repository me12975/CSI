...
DROP TABLE IF EXISTS  prestage.sbd_bgmt029_prestage;

CREATE TABLE  prestage.sbd_bgmt029_prestage (
ban varchar(8) ,
ctrl_item varchar(2) ,
start_suit_term varchar(5) ,
appr_date varchar(7) ,
appr_docu_no varchar(40) ,
update_id varchar(8) ,
update_date_time timestamp ,
mof_docu_no varchar(40) ,
...
ALTER TABLE  prestage.sbd_bgmt029_prestage OWNER TO ap_sbd;
