...
-- Purpose: Prestage資料表;
-- Table: sbd_init006_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,exp_item_nm_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_init006_prestage;

CREATE TABLE  prestage.sbd_init006_prestage (
incm_pfn_data_yr varchar(3) ,
incm_pfn_org_cd varchar(3) ,
incm_pfn_idn_ban varchar(10) ,
incm_pfn_seq_no varchar(1) ,
exp_item_nm_cd varchar(2) ,
exp_item_nm_amt decimal(14,0) ,
org_cd varchar(3) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,exp_item_nm_cd)
...
ALTER TABLE  prestage.sbd_init006_prestage OWNER TO ap_sbd;
