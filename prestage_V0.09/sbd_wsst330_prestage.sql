...
DROP TABLE IF EXISTS  prestage.sbd_wsst330_prestage;

CREATE TABLE  prestage.sbd_wsst330_prestage (
rvnu_date varchar(7) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
tax_cd varchar(2) ,
paid_misc_cd varchar(1) ,
rvnu_corr_tp varchar(1) ,
...
ALTER TABLE  prestage.sbd_wsst330_prestage OWNER TO ap_sbd;
