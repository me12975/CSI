...
DROP TABLE IF EXISTS  prestage.sbd_ifxt009_prestage;

CREATE TABLE  prestage.sbd_ifxt009_prestage (
rfn_data_yr varchar(3) ,
rfn_data_tp varchar(3) ,
rfn_org_cd varchar(3) ,
rfn_ctrl_area varchar(2) ,
rfn_serial_no varchar(6) ,
tpr_email varchar(40) ,
spous_email varchar(40) ,
cntct_ban varchar(8) ,
cntct_company varchar(52) ,
cntct_nm varchar(20) ,
cntct_tel_no varchar(20) ,
depo_nm varchar(60) ,
depo_idn varchar(10) ,
depo_tp varchar(1) ,
bank_cd varchar(7) ,
...
cert_expire varchar(7) ,
cert_format_cd varchar(1) ,
cert_kd varchar(1) ,
agt_recev_nm varchar(20) ,
agt_recev_idn varchar(10) ,
agt_recev_hsn_nm varchar(3) ,
agt_recev_town_nm varchar(5) ,
agt_recev_vill_nm varchar(5) ,
agt_recev_lin_nm varchar(5) ,
agt_recev_road_no varchar(100) ,
cert_self_or_send varchar(1) ,
cert_send_addr_mark varchar(1) ,
login_language varchar(10) ,
cert_recev_nm varchar(20) ,
cert_recev_idn varchar(10) ,
cert_recev_hsn_nm varchar(3) ,
cert_recev_town_nm varchar(5) ,
cert_recev_vill_nm varchar(5) ,
cert_recev_lin_nm varchar(5) ,
cert_recev_road_no varchar(100) ,
cert_recev_tel_no varchar(20) ,
cert_net_mk varchar(1) ,
org_cd varchar(3) ,
...
ALTER TABLE  prestage.sbd_ifxt009_prestage OWNER TO ap_sbd;
