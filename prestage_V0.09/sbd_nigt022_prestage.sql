...
DROP TABLE IF EXISTS  prestage.sbd_nigt022_prestage;

CREATE TABLE  prestage.sbd_nigt022_prestage (
dlv_unit varchar(3) ,
tax_cd varchar(2) ,
dlv_yr varchar(3) ,
flg_tp varchar(1) ,
...
adt_sgst1 varchar(800) ,
adt_sgst2 varchar(800) ,
adt_sgst3 varchar(800) ,
adt_sgst4 varchar(800) ,
adt_sgst5 varchar(800) ,
adt_sgst6 varchar(800) ,
...
ALTER TABLE  prestage.sbd_nigt022_prestage OWNER TO ap_sbd;
