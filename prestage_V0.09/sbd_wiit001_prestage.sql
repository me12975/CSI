...
-- Purpose: Prestage資料表;
-- Table: sbd_wiit001_prestage;
-- Compressed: N ;
-- Distributed: Y (clcn_rec_key,bl_org_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_wiit001_prestage;

CREATE TABLE  prestage.sbd_wiit001_prestage (
clcn_rec_key decimal(10,0) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
tax_cd varchar(2) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (clcn_rec_key,bl_org_cd)
...
ALTER TABLE  prestage.sbd_wiit001_prestage OWNER TO ap_sbd;
