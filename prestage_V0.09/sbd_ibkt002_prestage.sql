...
-- Purpose: Prestage資料表;
-- Table: sbd_ibkt002_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn,seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ibkt002_prestage;

CREATE TABLE  prestage.sbd_ibkt002_prestage (
rfn varchar(17) ,
seq_no decimal(2,0) ,
flg_depnt_idn varchar(10) ,
flg_depnt_nm varchar(20) ,
flg_depnt_born_yy varchar(3) ,
flg_tpr_idn varchar(10) ,
flg_tpr_nm varchar(20) ,
flg_tpr_born_yy varchar(3) ,
flg_spous_idn varchar(10) ,
flg_spous_nm varchar(20) ,
flg_spous_born_yy varchar(3) ,
town_cd varchar(2) ,
vill_cd varchar(2) ,
town_nm varchar(5) ,
vill_nm varchar(5) ,
...
pers_idn varchar(10) ,
pers_nm varchar(20) ,
pers_born_yy varchar(3) ,
foster_fr_idn varchar(10) ,
foster_fr_nm varchar(20) ,
foster_mo_idn varchar(10) ,
foster_mo_nm varchar(20) ,
...
ALTER TABLE  prestage.sbd_ibkt002_prestage OWNER TO ap_sbd;
