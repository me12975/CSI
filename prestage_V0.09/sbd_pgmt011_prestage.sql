...
-- Purpose: Prestage資料表;
-- Table: sbd_pgmt011_prestage;
-- Compressed: N ;
-- Distributed: Y (agent_lic_no);
...
DROP TABLE IF EXISTS  prestage.sbd_pgmt011_prestage;

CREATE TABLE  prestage.sbd_pgmt011_prestage (
agent_lic_no varchar(4) ,
agent_idn varchar(10) ,
chi_nm varchar(40) ,
ft_cdc_date varchar(7) ,
ft_cdc_docu_no varchar(15) ,
ft_rdc_date varchar(7) ,
ft_rdc_docu_no varchar(15) ,
last_cdc_date varchar(7) ,
last_cdc_docu_no varchar(15) ,
last_rdc_date varchar(7) ,
last_rdc_docu_no varchar(15) ,
rtn_cdc_date varchar(7) ,
rtn_cdc_docu_no varchar(15) ,
rtn_rdc_date varchar(7) ,
rtn_rdc_docu_no varchar(15) ,
e_reas_cd varchar(2) ,
e_cdc_date varchar(7) ,
e_cdc_docu_no varchar(15) ,
e_rdc_date varchar(7) ,
e_rdc_docu_no varchar(15) ,
firm_ban varchar(8) ,
firm_nm varchar(52) ,
...
firm_tel_no varchar(12) ,
firm_fax_no varchar(12) ,
orgn_juris_no varchar(10) ,
prof_area_cd varchar(10) ,
orgn_cpa_no varchar(4) ,
agent_born_date varchar(7) ,
...
ALTER TABLE  prestage.sbd_pgmt011_prestage OWNER TO ap_sbd;
