...
DROP TABLE IF EXISTS  prestage.sbd_bgmt400_prestage;

CREATE TABLE  prestage.sbd_bgmt400_prestage (
hsn_cd varchar(1) ,
ban varchar(8) ,
ctrled_idn varchar(10) ,
ctrl_tp varchar(1) ,
ctrled_nm varchar(30) ,
main_ctrl_tp varchar(1) ,
main_ctrled_idn varchar(10) ,
pfn varchar(12) ,
case_type varchar(1) ,
ctrled_ban_nm varchar(52) ,
ctrled_ban_addr varchar(80) ,
update_id varchar(8) ,
update_date_time timestamp ,
create_date varchar(7) ,
resp_mk varchar(1) ,
resp_dead_mk varchar(1) ,
seq_no varchar(2) ,
...
ALTER TABLE  prestage.sbd_bgmt400_prestage OWNER TO ap_sbd;
