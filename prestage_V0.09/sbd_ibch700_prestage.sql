...
DROP TABLE IF EXISTS  prestage.sbd_ibch700_prestage;

CREATE TABLE  prestage.sbd_ibch700_prestage (
...
ALTER TABLE  prestage.sbd_ibch700_prestage OWNER TO ap_sbd;
