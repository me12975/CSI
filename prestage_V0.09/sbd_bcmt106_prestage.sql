...
DROP TABLE IF EXISTS  prestage.sbd_bcmt106_prestage;

CREATE TABLE  prestage.sbd_bcmt106_prestage (
hsn_cd varchar(1) ,
ban varchar(20) ,
case_reas_cd varchar(8) ,
stus_cd varchar(4) ,
reg_org varchar(4) ,
orgn_tp varchar(4) ,
head_ban varchar(16) ,
cntct_tel varchar(22) ,
alien_invt_career varchar(2) ,
one_co varchar(2) ,
o_ban varchar(16) ,
o_ban_nm varchar(120) ,
estab_date varchar(7) ,
schdl_open_date varchar(27) ,
ban_nm varchar(120) ,
ban_nm_eng varchar(120) ,
zip_cd varchar(160) ,
ban_addr varchar(840) ,
town_vill_cd varchar(10) ,
agt_tel varchar(25) ,
busi_addr varchar(840) ,
busi_town_vill_cd varchar(10) ,
branch_busi_cnt varchar(10) ,
bscd varchar(7) ,
cptl_tot decimal(15,0) ,
act_cptl_tot decimal(15,0) ,
stk_tot decimal(15,0) ,
acnt_prd varchar(4) ,
cpa_nm varchar(90) ,
cpa_idn varchar(20) ,
appr_estab_char varchar(50) ,
appr_estab_no varchar(30) ,
appr_estab_date varchar(7) ,
appr_chg_char varchar(50) ,
appr_chg_no varchar(30) ,
appr_chg_date varchar(7) ,
stop_date_b varchar(7) ,
stop_date_e varchar(7) ,
stop_appr_org varchar(90) ,
stop_appr_date varchar(7) ,
stop_appr_char varchar(50) ,
stop_appr_no varchar(30) ,
reopen_date varchar(7) ,
close_date varchar(7) ,
revo_appr_date varchar(7) ,
governor_pers_cnt varchar(10) ,
governor_start_date varchar(7) ,
governor_limit_date varchar(7) ,
sub_pers_cnt varchar(10) ,
sub_start_date varchar(17) ,
sub_limit_date varchar(7) ,
update_date varchar(7) ,
time_stamp timestamp ,
dism_revo_no varchar(90) ,
dism_revo_date varchar(7) ,
ticket_no varchar(16) ,
tel varchar(20) ,
fax varchar(20) ,
resp_zip_cd varchar(5) ,
resp_addr_town_vill varchar(10) ,
resp_addr_lin varchar(8) ,
resp_addr_road_no varchar(50) ,
resp_born_date varchar(7) ,
net_auction_no varchar(100) ,
net_auction_e_mail varchar(200) ,
net_auction_conf varchar(1) ,
net_auction_area varchar(8) ,
hou_rgsi_no varchar(12) ,
f_trf_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_bcmt106_prestage OWNER TO ap_sbd;
