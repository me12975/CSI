...
-- Purpose: Prestage資料表;
-- Table: sbd_ipat040_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,databag_case_no,chk_tms,sctn_cd,rvnu_item_seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ipat040_prestage;

CREATE TABLE  prestage.sbd_ipat040_prestage (
...
chk_tms varchar(2) ,
sctn_cd varchar(2) ,
rvnu_item_seq_no varchar(2) ,
rvnu_item_nm varchar(50) ,
sys_apl_amt decimal(14) ,
rvnu_flg_amt decimal(14) ,
rvnu_apl_amt decimal(14) ,
org_cd varchar(3) ,
user_id_cd varchar(8) ,
update_date_time varchar(13) ,
hlth_ins_exp_tot decimal(14) ,
apl_point_tot decimal(14) ,
ded_amt decimal(14) ,
pay_amt decimal(14) ,
bef_ded_amt decimal(14) ,
bef_pay_amt decimal(14) ,
rvnu_adj_sgst text ,
dnt_tot_amt decimal(14) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,databag_case_no,chk_tms,sctn_cd,rvnu_item_seq_no)
...
ALTER TABLE  prestage.sbd_ipat040_prestage OWNER TO ap_sbd;
