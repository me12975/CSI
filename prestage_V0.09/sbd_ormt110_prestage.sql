...
DROP TABLE IF EXISTS  prestage.sbd_ormt110_prestage;

CREATE TABLE  prestage.sbd_ormt110_prestage (
...
ALTER TABLE  prestage.sbd_ormt110_prestage OWNER TO ap_sbd;
