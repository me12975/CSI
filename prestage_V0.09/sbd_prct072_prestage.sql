...
-- Purpose: Prestage資料表;
-- Table: sbd_prct072_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,recev_no,seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_prct072_prestage;

CREATE TABLE  prestage.sbd_prct072_prestage (
data_yr varchar(3) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
ban varchar(8) ,
recev_no varchar(8) ,
seq_no varchar(4) ,
bl_tran_report varchar(1) ,
used_tran_report varchar(1) ,
used_tran_reas varchar(60) ,
relation_nm1 varchar(60) ,
relation_eng_nm varchar(200) ,
relation_ban varchar(10) ,
cntry_code varchar(2) ,
with_co_relation_cd varchar(42) ,
relation_pfls_data varchar(1) ,
fiscal_yr_b_date varchar(7) ,
fiscal_yr_e_date varchar(7) ,
busi_rvnu_net decimal(14,0) ,
busi_pf decimal(14,0) ,
busi_net_pf decimal(14,0) ,
non_busi_rvnu decimal(14,0) ,
non_busi_loss decimal(14,0) ,
tax_o_n_pf decimal(14,0) ,
ast_rvnu_sale_act decimal(14,0) ,
ast_rvnu_oth_act decimal(14,0) ,
ast_exp_purchs_act decimal(14,0) ,
ast_exp_oth_act decimal(14,0) ,
ast_rvnu_sale_flg decimal(14,0) ,
ast_rvnu_oth_flg decimal(14,0) ,
ast_exp_purchs_flg decimal(14,0) ,
ast_exp_oth_flg decimal(14,0) ,
ast_tran_report varchar(1) ,
ast_use_rvnu_act decimal(14,0) ,
ast_use_exp_act decimal(14,0) ,
ast_use_rvnu_flg decimal(14,0) ,
ast_use_exp_flg decimal(14,0) ,
use_tran_report varchar(1) ,
ia_tran_rvnu_act decimal(14,0) ,
ia_tran_exp_act decimal(14,0) ,
ia_tran_rvnu_flg decimal(14,0) ,
ia_tran_exp_flg decimal(14,0) ,
ia_tran_report varchar(1) ,
ia_use_rvnu_act decimal(14,0) ,
ia_use_exp_act decimal(14,0) ,
ia_use_rvnu_flg decimal(14,0) ,
ia_use_exp_flg decimal(14,0) ,
ia_use_tran_report varchar(1) ,
serv_rvnu_act decimal(14,0) ,
serv_exp_act decimal(14,0) ,
serv_rvnu_flg decimal(14,0) ,
serv_exp_flg decimal(14,0) ,
serv_tran_report varchar(1) ,
cash_supply_act decimal(14,0) ,
cash_int_rvnu_act decimal(14,0) ,
cash_use_act decimal(14,0) ,
cash_int_exp_act decimal(14,0) ,
cash_supply_flg decimal(14,0) ,
cash_int_rvnu_flg decimal(14,0) ,
cash_use_flg decimal(14,0) ,
cash_int_exp_flg decimal(14,0) ,
cash_tran_report varchar(1) ,
oth_rvnu_act decimal(14,0) ,
oth_exp_act decimal(14,0) ,
oth_rvnu_flg decimal(14,0) ,
oth_exp_flg decimal(14,0) ,
oth_tran_report varchar(1) ,
tot_rvnu_act decimal(14,0) ,
tot_exp_act decimal(14,0) ,
tot_rvnu_flg decimal(14,0) ,
tot_exp_flg decimal(14,0) ,
update_cd varchar(1) ,
force_mk varchar(1) ,
keyin_id_cd varchar(8) ,
keyin_date varchar(7) ,
time_stamp timestamp ,
unable_tran_rfrc varchar(1) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (ban,recev_no,seq_no)
...
ALTER TABLE  prestage.sbd_prct072_prestage OWNER TO ap_sbd;
