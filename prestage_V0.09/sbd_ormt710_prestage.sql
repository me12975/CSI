...
-- Purpose: Prestage資料表;
-- Table: sbd_ormt710_prestage;
-- Compressed: N ;
-- Distributed: Y (manage_cd,data_key,factory_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ormt710_prestage;

CREATE TABLE  prestage.sbd_ormt710_prestage (
manage_cd varchar(24) ,
data_key decimal(13,0) ,
factory_no varchar(5) ,
ban varchar(8) ,
idn varchar(10) ,
idn_mk varchar(1) ,
cmt_apl_cd varchar(1) ,
sup_ref_reas varchar(1) ,
ref_yr varchar(1) ,
...
apl_sup_ref_tax decimal(11,0) ,
dlfg_amt decimal(10,0) ,
ncfg_amt decimal(10,0) ,
add_cal_int decimal(10,0) ,
serv_rvnu decimal(10,0) ,
tax_t_tot decimal(11,0) ,
f_cnvt_mk varchar(1) ,
bill_mk varchar(1) ,
factory_nm varchar(52) ,
factory_addr_hsn varchar(3) ,
factory_addr_town varchar(5) ,
factory_addr_vill varchar(5) ,
factory_addr_lin varchar(5) ,
factory_addr varchar(50) ,
resp_nm varchar(30) ,
apl_unit_cd varchar(2) ,
asg_mk varchar(1) ,
vio_mk varchar(1) ,
...
o_apl_tax decimal(11,0) ,
o_dlfg_amt decimal(10,0) ,
o_ncfg_amt decimal(10,0) ,
o_add_cal_int decimal(10,0) ,
paid_amt decimal(11,0) ,
update_cd varchar(1) ,
update_date_time varchar(15) ,
keyin_id_cd varchar(8) ,
pybl_ba_tax decimal(11,0) ,
paid_ba_tax decimal(11,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (manage_cd,data_key,factory_no)
...
ALTER TABLE  prestage.sbd_ormt710_prestage OWNER TO ap_sbd;
