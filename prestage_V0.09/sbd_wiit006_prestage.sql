...
DROP TABLE IF EXISTS  prestage.sbd_wiit006_prestage;

CREATE TABLE  prestage.sbd_wiit006_prestage (
clcn_rec_key decimal(10,0) ,
send_date varchar(7) ,
send_mk varchar(1) ,
send_stat_tp varchar(1) ,
proc_ym varchar(5) ,
...
ALTER TABLE  prestage.sbd_wiit006_prestage OWNER TO ap_sbd;
