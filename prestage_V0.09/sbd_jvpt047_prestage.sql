...
-- Purpose: Prestage資料表;
-- Table: sbd_jvpt047_prestage;
-- Compressed: N ;
-- Distributed: Y (asg_no,chk_tms,sub_case_seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_jvpt047_prestage;

CREATE TABLE  prestage.sbd_jvpt047_prestage (
data_bl_yr varchar(3) ,
asg_no varchar(17) ,
chk_tms varchar(2) ,
sub_case_seq_no varchar(1) ,
sub_case_chk_tms decimal(2,0) ,
jdgf_amt decimal(14,0) ,
yn_violate varchar(1) ,
cnvt_coll_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_jvpt047_prestage OWNER TO ap_sbd;
