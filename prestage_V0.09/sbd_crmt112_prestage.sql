...
-- Purpose: Prestage資料表;
-- Table: sbd_crmt112_prestage;
-- Compressed: N ;
-- Distributed: Y (data_key,factory_serial);
...
DROP TABLE IF EXISTS  prestage.sbd_crmt112_prestage;

CREATE TABLE  prestage.sbd_crmt112_prestage (
...
TABLESPACE sbd 
DISTRIBUTED BY (data_key,factory_serial)
...
ALTER TABLE  prestage.sbd_crmt112_prestage OWNER TO ap_sbd;
