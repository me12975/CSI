...
-- Purpose: Prestage資料表;
-- Table: sbd_ifxt002_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn_data_tp,rfn_org_cd,rfn_ctrl_area,rfn_serial_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ifxt002_prestage;

CREATE TABLE  prestage.sbd_ifxt002_prestage (
rfn_data_yr varchar(3) ,
rfn_data_tp varchar(3) ,
rfn_org_cd varchar(3) ,
rfn_ctrl_area varchar(2) ,
rfn_serial_no varchar(6) ,
tpr_co_tel varchar(26) ,
tpr_co_ext varchar(6) ,
tpr_resd_tel varchar(26) ,
tpr_resd_ext varchar(6) ,
spous_co_tel varchar(26) ,
spous_co_ext varchar(6) ,
spous_resd_tel varchar(26) ,
spous_resd_ext varchar(6) ,
...
ft_entry_date varchar(7) ,
l5y_yn_flg varchar(1) ,
flg_last_yr varchar(3) ,
flg_last_org_cd varchar(3) ,
flg_vouch varchar(17) ,
...
ALTER TABLE  prestage.sbd_ifxt002_prestage OWNER TO ap_sbd;
