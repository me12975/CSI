...
-- Purpose: Prestage資料表;
-- Table: sbd_wmmt530_prestage;
-- Compressed: N ;
-- Distributed: Y (vio_mk,tax_subtax_cd,gove_priv_tp,apl_suple_data_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_wmmt530_prestage;

CREATE TABLE  prestage.sbd_wmmt530_prestage (
vio_mk varchar(1) ,
data_ym varchar(5) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (vio_mk,tax_subtax_cd,gove_priv_tp,apl_suple_data_tp)
...
ALTER TABLE  prestage.sbd_wmmt530_prestage OWNER TO ap_sbd;
