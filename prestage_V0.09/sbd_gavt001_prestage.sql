...
-- Purpose: Prestage資料表;
-- Table: sbd_gavt001_prestage;
-- Compressed: N ;
-- Distributed: Y (giver_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_gavt001_prestage;

CREATE TABLE  prestage.sbd_gavt001_prestage (
giver_idn varchar(10) ,
giver_nm varchar(20) ,
born_date varchar(7) ,
giver_addr_hsn_nm varchar(3) ,
giver_addr_town_nm varchar(5) ,
giver_addr_vill_nm varchar(5) ,
giver_addr_lin varchar(5) ,
giver_addr_road_no varchar(50) ,
zip_cd varchar(5) ,
...
ALTER TABLE  prestage.sbd_gavt001_prestage OWNER TO ap_sbd;
