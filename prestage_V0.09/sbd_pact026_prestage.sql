...
-- Purpose: Prestage資料表;
-- Table: sbd_pact026_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,abate_clause);
...
DROP TABLE IF EXISTS  prestage.sbd_pact026_prestage;

CREATE TABLE  prestage.sbd_pact026_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
abate_clause varchar(4) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
recev_no varchar(8) ,
rd_exp1 decimal(14,0) ,
rd_exp2 decimal(14,0) ,
rd_exp3 decimal(14,0) ,
rd_exp4 decimal(14,0) ,
rd_exp5 decimal(14,0) ,
rd_exp6 decimal(14,0) ,
rd_exp7 decimal(14,0) ,
rd_exp8 decimal(14,0) ,
rd_exp9 decimal(14,0) ,
trng_exp1 decimal(14,0) ,
trng_exp2 decimal(14,0) ,
trng_exp3 decimal(14,0) ,
trng_exp4 decimal(14,0) ,
trng_exp5 decimal(14,0) ,
trng_exp6 decimal(14,0) ,
estab_logo_exp1 decimal(14,0) ,
estab_logo_exp2 decimal(14,0) ,
estab_logo_exp3 decimal(14,0) ,
estab_logo_exp4 decimal(14,0) ,
estab_logo_exp5 decimal(14,0) ,
estab_logo_exp6 decimal(14,0) ,
ly_rd_ctx decimal(14,0) ,
l2y_rd_ctx decimal(14,0) ,
l2y_rd_avg_num decimal(14,0) ,
rd_ctx decimal(14,0) ,
ly_trng_ctx decimal(14,0) ,
l2y_trng_ctx decimal(14,0) ,
l2y_trng_avg_num decimal(14,0) ,
trng_ctx decimal(14,0) ,
estab_logo_pd_b_un_ctx decimal(14,0) ,
estab_logo_zsy_ctx decimal(14,0) ,
estab_logo_pd_e_un_ctx decimal(14,0) ,
credit_tax decimal(14,0) ,
apl_date varchar(7) ,
adt_id_cd varchar(5) ,
update_cd varchar(1) ,
force_mk varchar(1) ,
...
rd_gov_alwc_amt decimal(14,0) ,
trng_gov_alwc_amt decimal(14,0) ,
rd_exp10 decimal(14,0) ,
rd_exp11 decimal(14,0) ,
appr_pt_rd_ctx decimal(14,0) ,
appr_rd_ctx decimal(14,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (ban,abate_clause)
...
ALTER TABLE  prestage.sbd_pact026_prestage OWNER TO ap_sbd;
