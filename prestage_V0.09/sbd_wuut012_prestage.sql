...
DROP TABLE IF EXISTS  prestage.sbd_wuut012_prestage;

CREATE TABLE  prestage.sbd_wuut012_prestage (
keyin_yy varchar(3) ,
ref_batch_no varchar(4) ,
serial_no varchar(6) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
...
ALTER TABLE  prestage.sbd_wuut012_prestage OWNER TO ap_sbd;
