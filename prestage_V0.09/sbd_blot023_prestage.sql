...
DROP TABLE IF EXISTS  prestage.sbd_blot023_prestage;

CREATE TABLE  prestage.sbd_blot023_prestage (
...
seller_nm varchar(52) ,
gov_org_nm varchar(52) ,
buyer_ban varchar(10) ,
buyer_nm varchar(52) ,
invo_track_no varchar(10) ,
amt decimal(14,0) ,
invo_copy decimal(2,0) ,
invo_date varchar(7) ,
rcvr_nm1 varchar(40) ,
recev_date varchar(7) ,
rcvr_nm2 varchar(40) ,
seller_addr varchar(80) ,
gd_nm varchar(52) ,
qty decimal(10,0) ,
unit_prc decimal(10,2) ,
jurisl_org_cd varchar(3) ,
no_o_tax_rgst varchar(1) ,
pay_vouch_no varchar(5) ,
pay_vouch_bl_yr varchar(3) ,
pay_vouch_bl_mm varchar(2) ,
data_date varchar(7) ,
chk_mk varchar(7) ,
update_cd varchar(1) ,
...
ALTER TABLE  prestage.sbd_blot023_prestage OWNER TO ap_sbd;
