...
DROP TABLE IF EXISTS  prestage.sbd_bcit005_prestage;

CREATE TABLE  prestage.sbd_bcit005_prestage (
org_group varchar(2) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
...
ALTER TABLE  prestage.sbd_bcit005_prestage OWNER TO ap_sbd;
