...
DROP TABLE IF EXISTS  prestage.sbd_wsst310_prestage;

CREATE TABLE  prestage.sbd_wsst310_prestage (
rvnu_date varchar(7) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
...
ALTER TABLE  prestage.sbd_wsst310_prestage OWNER TO ap_sbd;
