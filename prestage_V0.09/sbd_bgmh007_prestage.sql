...
DROP TABLE IF EXISTS  prestage.sbd_bgmh007_prestage;

CREATE TABLE  prestage.sbd_bgmh007_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
...
ALTER TABLE  prestage.sbd_bgmh007_prestage OWNER TO ap_sbd;
