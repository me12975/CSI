...
DROP TABLE IF EXISTS  prestage.sbd_blmt009_prestage;

CREATE TABLE  prestage.sbd_blmt009_prestage (
data_ym varchar(5) ,
format_cd varchar(2) ,
p_s_item_pfn varchar(17) ,
flg_mk varchar(1) ,
seq_no varchar(9) ,
...
ALTER TABLE  prestage.sbd_blmt009_prestage OWNER TO ap_sbd;
