...
-- Purpose: Prestage資料表;
-- Table: sbd_ibet610_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn,item_no,incmer_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_ibet610_prestage;

CREATE TABLE  prestage.sbd_ibet610_prestage (
rfn varchar(17) ,
item_no decimal(4,0) ,
...
ALTER TABLE  prestage.sbd_ibet610_prestage OWNER TO ap_sbd;
