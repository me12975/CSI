...
-- Purpose: Prestage資料表;
-- Table: sbd_nigt081_prestage;
-- Compressed: N ;
-- Distributed: Y (sctn_cd,tax_cd,bureau_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_nigt081_prestage;

CREATE TABLE  prestage.sbd_nigt081_prestage (
sctn_cd varchar(2) ,
tax_cd varchar(2) ,
bureau_cd varchar(3) ,
user_id varchar(8) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (sctn_cd,tax_cd,bureau_cd)
...
ALTER TABLE  prestage.sbd_nigt081_prestage OWNER TO ap_sbd;
