...
-- Purpose: Prestage資料表;
-- Table: sbd_bimt016_prestage;
-- Compressed: N ;
-- Distributed: Y (invo_track,invo_b_no);
...
DROP TABLE IF EXISTS  prestage.sbd_bimt016_prestage;

CREATE TABLE  prestage.sbd_bimt016_prestage (
invo_ym varchar(5) ,
invo_track varchar(2) ,
invo_b_no varchar(8) ,
invo_e_no varchar(8) ,
real_s_bk_cnt decimal(10,0) ,
invo_tp varchar(1) ,
ban varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (invo_track,invo_b_no)
...
ALTER TABLE  prestage.sbd_bimt016_prestage OWNER TO ap_sbd;
