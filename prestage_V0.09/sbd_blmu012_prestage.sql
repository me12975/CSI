...
-- Purpose: Prestage資料表;
-- Table: sbd_blmu012_prestage;
-- Compressed: N ;
-- Distributed: Y (agent_idn_ban,keyin_id_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_blmu012_prestage;

CREATE TABLE  prestage.sbd_blmu012_prestage (
agent_idn_ban varchar(10) ,
org_cd varchar(3) ,
org_cd_a varchar(3) ,
org_cd_h varchar(3) ,
org_cd_b varchar(3) ,
...
tel_ext_no varchar(4) ,
tel_area_cd_2 varchar(3) ,
cntct_tel_2 varchar(12) ,
tel_ext_no_2 varchar(6) ,
cntct_nm varchar(30) ,
mobilephone varchar(10) ,
fax_no varchar(12) ,
email_addr varchar(30) ,
soft_factory varchar(52) ,
agent_nm varchar(52) ,
...
mdm_cd varchar(10) ,
tel_area_cd_a varchar(3) ,
cntct_tel_a varchar(12) ,
tel_ext_no_a varchar(4) ,
fax_no_a varchar(12) ,
cntct_nm_a varchar(30) ,
mobilephone_a varchar(10) ,
email_addr_a varchar(30) ,
tel_area_cd_h varchar(3) ,
cntct_tel_h varchar(12) ,
tel_ext_no_h varchar(4) ,
fax_no_h varchar(12) ,
cntct_nm_h varchar(30) ,
mobilephone_h varchar(10) ,
email_addr_h varchar(30) ,
tel_area_cd_b varchar(3) ,
cntct_tel_b varchar(12) ,
tel_ext_no_b varchar(4) ,
fax_no_b varchar(12) ,
cntct_nm_b varchar(30) ,
mobilephone_b varchar(10) ,
email_addr_b varchar(30) ,
tel_area_cd_d varchar(3) ,
cntct_tel_d varchar(12) ,
tel_ext_no_d varchar(4) ,
fax_no_d varchar(12) ,
cntct_nm_d varchar(30) ,
mobilephone_d varchar(10) ,
email_addr_d varchar(30) ,
tel_area_cd_e varchar(3) ,
cntct_tel_e varchar(12) ,
tel_ext_no_e varchar(4) ,
fax_no_e varchar(12) ,
cntct_nm_e varchar(30) ,
mobilephone_e varchar(10) ,
email_addr_e varchar(30) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (agent_idn_ban,keyin_id_cd)
...
ALTER TABLE  prestage.sbd_blmu012_prestage OWNER TO ap_sbd;
