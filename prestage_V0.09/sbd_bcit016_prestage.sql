...
-- Purpose: Prestage資料表;
-- Table: sbd_bcit016_prestage;
-- Compressed: N ;
-- Distributed: Y (trstr_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_bcit016_prestage;

CREATE TABLE  prestage.sbd_bcit016_prestage (
sel_case_yr varchar(3) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
trstr_cd varchar(5) ,
sh_chk_cnt decimal(4,0) ,
chg_mk varchar(1) ,
chg_update_date varchar(7) ,
time_stamp timestamp ,
schdl_chk_suple_tax decimal(12,0) ,
no_vat_sh_chk_cnt decimal(4,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (trstr_cd)
...
ALTER TABLE  prestage.sbd_bcit016_prestage OWNER TO ap_sbd;
