...
-- Purpose: Prestage資料表;
-- Table: sbd_plmt057_prestage;
-- Compressed: N ;
-- Distributed: Y (data_yr,head_ban,incm_source_idnban,idn,dprt_date,entry_date);
...
DROP TABLE IF EXISTS  prestage.sbd_plmt057_prestage;

CREATE TABLE  prestage.sbd_plmt057_prestage (
data_yr varchar(3) ,
head_ban varchar(8) ,
incm_source_idnban varchar(8) ,
idn varchar(10) ,
idn_nm varchar(40) ,
dprt_date varchar(7) ,
entry_date varchar(7) ,
depa_day varchar(4) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (data_yr,head_ban,incm_source_idnban,idn,dprt_date,entry_date)
...
ALTER TABLE  prestage.sbd_plmt057_prestage OWNER TO ap_sbd;
