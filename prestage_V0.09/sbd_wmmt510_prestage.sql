...
-- Purpose: Prestage資料表;
-- Table: sbd_wmmt510_prestage;
-- Compressed: N ;
-- Distributed: Y (vio_mk,this_prev_yr,tax_subtax_cd,gove_priv_tp,org_tax_data_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_wmmt510_prestage;

CREATE TABLE  prestage.sbd_wmmt510_prestage (
vio_mk varchar(1) ,
data_ym varchar(5) ,
...
org_tax_data_tp decimal(2,0) ,
m_cnt decimal(7,0) ,
m_amt decimal(13,0) ,
acu_cnt decimal(9,0) ,
acu_amt decimal(13,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (vio_mk,this_prev_yr,tax_subtax_cd,gove_priv_tp,org_tax_data_tp)
...
ALTER TABLE  prestage.sbd_wmmt510_prestage OWNER TO ap_sbd;
