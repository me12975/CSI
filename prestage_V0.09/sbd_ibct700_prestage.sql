...
-- Purpose: Prestage資料表;
-- Table: sbd_ibct700_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn,pers_idn,batch_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_ibct700_prestage;

CREATE TABLE  prestage.sbd_ibct700_prestage (
...
TABLESPACE sbd 
DISTRIBUTED BY (rfn,pers_idn,batch_tp)
...
ALTER TABLE  prestage.sbd_ibct700_prestage OWNER TO ap_sbd;
