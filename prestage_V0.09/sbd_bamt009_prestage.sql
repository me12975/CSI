...
DROP TABLE IF EXISTS  prestage.sbd_bamt009_prestage;

CREATE TABLE  prestage.sbd_bamt009_prestage (
idn_ban varchar(10) ,
apl_ym varchar(5) ,
...
ALTER TABLE  prestage.sbd_bamt009_prestage OWNER TO ap_sbd;
