...
DROP TABLE IF EXISTS  prestage.sbd_bamt001_prestage;

CREATE TABLE  prestage.sbd_bamt001_prestage (
ban varchar(8) ,
bl_ym varchar(5) ,
upd_tms varchar(2) ,
hsn_cd varchar(1) ,
...
ALTER TABLE  prestage.sbd_bamt001_prestage OWNER TO ap_sbd;
