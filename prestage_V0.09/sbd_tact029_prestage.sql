...
DROP TABLE IF EXISTS  prestage.sbd_tact029_prestage;

CREATE TABLE  prestage.sbd_tact029_prestage (
tax_tp varchar(1) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
app_yy varchar(2) ,
...
ALTER TABLE  prestage.sbd_tact029_prestage OWNER TO ap_sbd;
