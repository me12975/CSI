...
-- Purpose: Prestage資料表;
-- Table: sbd_pact012_prestage;
-- Compressed: N ;
-- Distributed: Y (idn_ban,recev_no);
...
DROP TABLE IF EXISTS  prestage.sbd_pact012_prestage;

CREATE TABLE  prestage.sbd_pact012_prestage (
data_yr varchar(3) ,
idn_ban varchar(10) ,
recev_no varchar(8) ,
chk_tms varchar(2) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (idn_ban,recev_no)
...
ALTER TABLE  prestage.sbd_pact012_prestage OWNER TO ap_sbd;
