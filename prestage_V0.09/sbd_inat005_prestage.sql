...
-- Purpose: Prestage資料表;
-- Table: sbd_inat005_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_idn_ban);
...
DROP TABLE IF EXISTS  prestage.sbd_inat005_prestage;

CREATE TABLE  prestage.sbd_inat005_prestage (
incm_pfn_data_yr varchar(3) ,
incm_pfn_data_tp varchar(2) ,
incm_pfn_org_cd varchar(3) ,
incm_pfn_mdm_cd varchar(4) ,
incm_pfn_serial_no varchar(8) ,
incm_pfn_idn_ban varchar(10) ,
prof_idn varchar(10) ,
id_tp varchar(1) ,
commit_idn_ban varchar(10) ,
commit_nm varchar(20) ,
commit_id_mk varchar(1) ,
target_hsn_cd varchar(1) ,
case_no varchar(15) ,
...
tp_cd varchar(4) ,
nums decimal(9,2) ,
unit_prc decimal(14,0) ,
rvnu_amt decimal(14,0) ,
payment_t_amt decimal(14,0) ,
wh_tax decimal(14,0) ,
payment_n_amt decimal(14,0) ,
apl_nums decimal(7,2) ,
apl_amt decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_inat005_prestage OWNER TO ap_sbd;
