...
-- Purpose: Prestage資料表;
-- Table: sbd_ibrt447_prestage;
-- Compressed: N ;
-- Distributed: Y (hspl_ban);
...
DROP TABLE IF EXISTS  prestage.sbd_ibrt447_prestage;

CREATE TABLE  prestage.sbd_ibrt447_prestage (
data_yr varchar(3) ,
hspl_ban varchar(8) ,
hspl_nm varchar(52) ,
slf_pay_tot decimal(20) ,
reg_fee_tot decimal(20) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hspl_ban)
...
ALTER TABLE  prestage.sbd_ibrt447_prestage OWNER TO ap_sbd;
