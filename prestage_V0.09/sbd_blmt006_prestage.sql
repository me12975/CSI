...
DROP TABLE IF EXISTS  prestage.sbd_blmt006_prestage;

CREATE TABLE  prestage.sbd_blmt006_prestage (
data_ym varchar(5) ,
format_cd varchar(2) ,
...
ALTER TABLE  prestage.sbd_blmt006_prestage OWNER TO ap_sbd;
