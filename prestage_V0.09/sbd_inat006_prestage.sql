...
-- Purpose: Prestage資料表;
-- Table: sbd_inat006_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,partner_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_inat006_prestage;

CREATE TABLE  prestage.sbd_inat006_prestage (
incm_pfn_data_yr varchar(3) ,
incm_pfn_org_cd varchar(3) ,
incm_pfn_idn_ban varchar(10) ,
incm_pfn_seq_no varchar(1) ,
partner_idn varchar(10) ,
partner_nm varchar(20) ,
partner_haddr varchar(80) ,
partner_tel varchar(20) ,
prof_bl varchar(2) ,
prof_cd varchar(2) ,
partner_ratio decimal(5,2) ,
pf_dist_amt decimal(14,0) ,
wh_tax_dist_amt decimal(14,0) ,
apl_rvnu decimal(14,0) ,
apl_exp decimal(14,0) ,
apl_incm decimal(14,0) ,
ntf_unit varchar(3) ,
cnvt_ntf_unit varchar(3) ,
cnvt_ntf_date varchar(7) ,
create_date varchar(7) ,
pfls_dist_ratio varchar(5) ,
nm_get_houhld_mk varchar(1) ,
idn_nm_conf_mk varchar(1) ,
htcmp_mk varchar(1) ,
pf_dist_mode varchar(1) ,
upd_tp varchar(1) ,
user_id_cd varchar(8) ,
update_date_time varchar(13) ,
remark varchar(60) ,
ptnr_ctr_val_de varchar(7) ,
ptnr_ctr_end_de varchar(7) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,partner_idn)
...
ALTER TABLE  prestage.sbd_inat006_prestage OWNER TO ap_sbd;
