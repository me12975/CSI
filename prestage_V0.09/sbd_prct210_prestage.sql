...
DROP TABLE IF EXISTS  prestage.sbd_prct210_prestage;

CREATE TABLE  prestage.sbd_prct210_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
recev_no varchar(8) ,
hsn_cd varchar(1) ,
...
ban_nm varchar(72) ,
ban_eng_nm varchar(100) ,
busi_addr varchar(80) ,
resp_idn varchar(10) ,
resp_nm varchar(40) ,
...
vat_losn varchar(9) ,
bscd varchar(6) ,
ban_tel_no varchar(20) ,
ban_fax_no varchar(20) ,
email_addr varchar(50) ,
new_estab_mk varchar(1) ,
org_appr_date varchar(7) ,
org_appr_docu_no varchar(40) ,
agent_idn varchar(10) ,
agt_nm varchar(40) ,
agent_lic_yr varchar(3) ,
agent_lic_track varchar(2) ,
agent_lic_no varchar(5) ,
agt_ban varchar(8) ,
agt_tel_no varchar(20) ,
agt_fax_no varchar(20) ,
auth_tp varchar(1) ,
pia_flg_app_mk varchar(1) ,
pio_flg_app_mk varchar(1) ,
orgn varchar(1) ,
reg_date varchar(7) ,
reg_lic_no varchar(60) ,
appr_boss varchar(40) ,
update_cd varchar(1) ,
...
lqu_idn varchar(10) ,
lqu_addr varchar(80) ,
lqu_take_date varchar(7) ,
final_recev_no varchar(8) ,
pil_flg_app_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_prct210_prestage OWNER TO ap_sbd;
