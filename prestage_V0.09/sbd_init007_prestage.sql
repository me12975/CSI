...
DROP TABLE IF EXISTS  prestage.sbd_init007_prestage;

CREATE TABLE  prestage.sbd_init007_prestage (
...
ALTER TABLE  prestage.sbd_init007_prestage OWNER TO ap_sbd;
