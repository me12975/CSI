...
DROP TABLE IF EXISTS  prestage.sbd_ormh110_prestage;

CREATE TABLE  prestage.sbd_ormh110_prestage (
...
factory_addr_hsn varchar(8) ,
factory_addr_town varchar(8) ,
factory_addr_vill varchar(8) ,
factory_addr_lin varchar(6) ,
factory_addr varchar(50) ,
tel_area_no varchar(12) ,
resp_nm varchar(30) ,
resp_idn varchar(10) ,
idn_mk varchar(1) ,
resp_addr_hsn varchar(8) ,
resp_addr_town varchar(8) ,
resp_addr_vill varchar(8) ,
resp_addr_lin varchar(6) ,
resp_addr varchar(50) ,
born_date varchar(7) ,
orgn_tp varchar(1) ,
serv_area varchar(2) ,
un_flg_tp varchar(1) ,
...
ALTER TABLE  prestage.sbd_ormh110_prestage OWNER TO ap_sbd;
