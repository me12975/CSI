...
DROP TABLE IF EXISTS  prestage.sbd_bgmh002_prestage;

CREATE TABLE  prestage.sbd_bgmh002_prestage (
ban varchar(8) ,
hsn_cd varchar(1) ,
exp_grd varchar(1) ,
...
ALTER TABLE  prestage.sbd_bgmh002_prestage OWNER TO ap_sbd;
