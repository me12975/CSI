...
DROP TABLE IF EXISTS  prestage.sbd_prct003_prestage;

CREATE TABLE  prestage.sbd_prct003_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
recev_no varchar(8) ,
pd_b_invn decimal(14,0) ,
zsp_purchs decimal(14,0) ,
pd_e_invn decimal(14,0) ,
p_s_acost decimal(14,0) ,
p_s_scost decimal(14,0) ,
p_s_cost decimal(14,0) ,
pd_b_drmtrl decimal(14,0) ,
zsp_drmtrl decimal(14,0) ,
pd_e_drmtrl decimal(14,0) ,
dmtrl_acost decimal(14,0) ,
dmtrl_scost decimal(14,0) ,
drmtrl_cost decimal(14,0) ,
pd_b_imtrl decimal(14,0) ,
zsp_imtrl decimal(14,0) ,
pd_e_imtrl decimal(14,0) ,
imtrl_acost decimal(14,0) ,
imtrl_scost decimal(14,0) ,
imtrl_cost decimal(14,0) ,
dmnl_cost decimal(14,0) ,
mfg_exp decimal(14,0) ,
mfg_cost decimal(14,0) ,
pd_b_in_proc decimal(14,0) ,
pd_e_in_proc decimal(14,0) ,
in_proc_acost decimal(14,0) ,
in_proc_scost decimal(14,0) ,
gd_cost decimal(14,0) ,
pd_b_gd decimal(14,0) ,
pd_e_gd decimal(14,0) ,
gd_acost decimal(14,0) ,
gd_scost decimal(14,0) ,
export_ref decimal(14,0) ,
prod_s_sub decimal(14,0) ,
prod_s_cost decimal(14,0) ,
srv_cost decimal(14,0) ,
rpa_cost decimal(14,0) ,
proc_cost decimal(14,0) ,
oth_busi_cost decimal(14,0) ,
busi_cost decimal(14,0) ,
no_vouch_cost decimal(14,0) ,
force_mk varchar(1) ,
update_cd varchar(1) ,
keyin_id_cd varchar(8) ,
keyin_date varchar(7) ,
time_stamp timestamp ,
nrl_trade_adj_add decimal(14,0) ,
nrl_trade_adj_sub decimal(14,0) ,
acc_stl_pd_b_invn decimal(14,0) ,
acc_stl_zsp_purchs decimal(14,0) ,
acc_stl_pd_e_invn decimal(14,0) ,
acc_stl_p_s_acost decimal(14,0) ,
acc_stl_p_s_scost decimal(14,0) ,
acc_stl_p_s_cost decimal(14,0) ,
acc_pd_b_drmtrl decimal(14,0) ,
acc_stl_zsp_drmtrl decimal(14,0) ,
acc_pd_e_drmtrl decimal(14,0) ,
acc_dmtrl_acost decimal(14,0) ,
acc_dmtrl_scost decimal(14,0) ,
acc_drmtrl_cost decimal(14,0) ,
acc_stl_pd_b_imtrl decimal(14,0) ,
acc_stl_zsp_imtrl decimal(14,0) ,
acc_stl_pd_e_imtrl decimal(14,0) ,
acc_imtrl_acost decimal(14,0) ,
acc_imtrl_scost decimal(14,0) ,
acc_stl_imtrl_cost decimal(14,0) ,
acc_stl_dmnl_cost decimal(14,0) ,
acc_stl_mfg_exp decimal(14,0) ,
acc_stl_mfg_cost decimal(14,0) ,
acc_pd_b_in_proc decimal(14,0) ,
acc_pd_e_in_proc decimal(14,0) ,
acc_in_proc_acost decimal(14,0) ,
acc_in_proc_scost decimal(14,0) ,
acc_stl_gd_cost decimal(14,0) ,
acc_stl_pd_b_gd decimal(14,0) ,
acc_stl_pd_e_gd decimal(14,0) ,
acc_stl_gd_acost decimal(14,0) ,
acc_stl_gd_scost decimal(14,0) ,
acc_stl_export_ref decimal(14,0) ,
acc_stl_prod_s_sub decimal(14,0) ,
acc_prod_s_cost decimal(14,0) ,
acc_stl_srv_cost decimal(14,0) ,
acc_stl_rpa_cost decimal(14,0) ,
acc_stl_proc_cost decimal(14,0) ,
acc_oth_busi_cost decimal(14,0) ,
acc_stl_busi_cost decimal(14,0) ,
addsub_item_expl varchar(200) ,
p_s_acost_name varchar(40) ,
p_s_scost_name varchar(40) ,
dmtrl_acost_name varchar(40) ,
dmtrl_scost_name varchar(40) ,
imtrl_acost_name varchar(40) ,
imtrl_scost_name varchar(40) ,
in_proc_acost_name varchar(40) ,
in_proc_scost_name varchar(40) ,
gd_acos_name varchar(40) ,
gd_scost_name varchar(40) ,
affair_cost decimal(14) ,
acc_affair_cost decimal(14) ,
diff_reason varchar(200) ,
invn_pf decimal(14) ,
invn_loss decimal(14) ,
...
ALTER TABLE  prestage.sbd_prct003_prestage OWNER TO ap_sbd;
