...
-- Purpose: Prestage資料表;
-- Table: sbd_brct003_prestage;
-- Compressed: N ;
-- Distributed: Y (pfn_hsn_cd,pfn_dst_cd,pfn_serv_area,pfn_data_source_mk,pfn_book_page_no,pfn_item_no);
...
DROP TABLE IF EXISTS  prestage.sbd_brct003_prestage;

CREATE TABLE  prestage.sbd_brct003_prestage (
...
TABLESPACE sbd 
DISTRIBUTED BY (pfn_hsn_cd,pfn_dst_cd,pfn_serv_area,pfn_data_source_mk,pfn_book_page_no,pfn_item_no)
...
ALTER TABLE  prestage.sbd_brct003_prestage OWNER TO ap_sbd;
