...
-- Purpose: Prestage資料表;
-- Table: sbd_ibct110_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn,batch_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_ibct110_prestage;

CREATE TABLE  prestage.sbd_ibct110_prestage (
...
batch_tp varchar(1) ,
pr_mk_ins varchar(1) ,
pr_mk_scts varchar(1) ,
pr_mk_empl varchar(1) ,
low_file_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_ibct110_prestage OWNER TO ap_sbd;
