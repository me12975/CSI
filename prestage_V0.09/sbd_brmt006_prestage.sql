...
DROP TABLE IF EXISTS  prestage.sbd_brmt006_prestage;

CREATE TABLE  prestage.sbd_brmt006_prestage (
...
ALTER TABLE  prestage.sbd_brmt006_prestage OWNER TO ap_sbd;
