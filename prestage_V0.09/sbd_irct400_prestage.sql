...
-- Purpose: Prestage資料表;
-- Table: sbd_irct400_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn_data_yr,rfn_data_tp,rfn_org_cd,rfn_ctrl_area,rfn_box_no,rfn_book_no,rfn_page_no,seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_irct400_prestage;

CREATE TABLE  prestage.sbd_irct400_prestage (
...
TABLESPACE sbd 
DISTRIBUTED BY (rfn_data_yr,rfn_data_tp,rfn_org_cd,rfn_ctrl_area,rfn_box_no,rfn_book_no,rfn_page_no,seq_no)
...
ALTER TABLE  prestage.sbd_irct400_prestage OWNER TO ap_sbd;
