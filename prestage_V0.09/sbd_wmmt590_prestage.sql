...
-- Purpose: Prestage資料表;
-- Table: sbd_wmmt590_prestage;
-- Compressed: N ;
-- Distributed: Y (tax_subtax_cd,prod_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_wmmt590_prestage;

CREATE TABLE  prestage.sbd_wmmt590_prestage (
data_ym varchar(5) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
tax_subtax_cd varchar(3) ,
prod_tp varchar(2) ,
zsy_assess_cnt decimal(7,0) ,
zsy_assess_amt decimal(13,0) ,
zsy_assess_t_cnt decimal(9,0) ,
zsy_assess_t_amt decimal(13,0) ,
py_assess_cnt decimal(7,0) ,
py_assess_amt decimal(13,0) ,
py_assess_t_cnt decimal(9,0) ,
py_assess_t_amt decimal(13,0) ,
zsy_assess_upd_cnt decimal(7,0) ,
zsy_assess_upd_amt decimal(13,0) ,
zsy_assess_upd_t_cnt decimal(9,0) ,
zsy_assess_upd_t_amt decimal(13,0) ,
py_assess_upd_cnt decimal(7,0) ,
py_assess_upd_amt decimal(13,0) ,
py_assess_upd_t_cnt decimal(9,0) ,
py_assess_upd_t_amt decimal(13,0) ,
zsy_colld_num_cnt decimal(7,0) ,
zsy_colld_num_amt decimal(13,0) ,
zsy_colld_num_t_cnt decimal(9,0) ,
zsy_colld_num_t_amt decimal(13,0) ,
py_colld_num_cnt decimal(7,0) ,
py_colld_num_amt decimal(13,0) ,
py_colld_num_t_cnt decimal(9,0) ,
py_colld_num_t_amt decimal(13,0) ,
zsy_ref_cnt decimal(7,0) ,
zsy_ref_amt decimal(13,0) ,
zsy_ref_t_cnt decimal(9,0) ,
zsy_ref_t_amt decimal(13,0) ,
py_ref_cnt decimal(7,0) ,
py_ref_amt decimal(13,0) ,
py_ref_t_cnt decimal(9,0) ,
py_ref_t_amt decimal(13,0) ,
rtn_py_ref_cnt decimal(7,0) ,
rtn_py_ref_amt decimal(13,0) ,
rtn_py_ref_t_cnt decimal(9,0) ,
rtn_py_ref_t_amt decimal(13,0) ,
create_date varchar(7) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (tax_subtax_cd,prod_tp)
...
ALTER TABLE  prestage.sbd_wmmt590_prestage OWNER TO ap_sbd;
