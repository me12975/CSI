...
-- Purpose: Prestage資料表;
-- Table: sbd_tact028_prestage;
-- Compressed: N ;
-- Distributed: Y (tax_tp,ba_tax_fine_mk,serial_no,cstp_stus_tms,cstp_stus_tp,cstp_stus_rapl,cstp_stus_rchk,cstp_stus_aply_mk,item_no);
...
DROP TABLE IF EXISTS  prestage.sbd_tact028_prestage;

CREATE TABLE  prestage.sbd_tact028_prestage (
tax_tp varchar(1) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
app_yy varchar(2) ,
...
item_no varchar(3) ,
rvw_item_tax_tp varchar(1) ,
rvw_item_cd varchar(4) ,
update_mk varchar(1) ,
taxes_item_cd varchar(4) ,
taxes_item_seq_no varchar(4) ,
item_group varchar(2) ,
t_item_mk varchar(1) ,
bef_upd_data varchar(15) ,
aft_upd_data varchar(15) ,
flg_amt decimal(14,0) ,
o_apl_amt decimal(14,0) ,
pln_add_sub_amt decimal(14,0) ,
add_sub_amt decimal(14,0) ,
unit_cd varchar(3) ,
nrsp_cd varchar(2) ,
nrsp_amt decimal(14,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (tax_tp,ba_tax_fine_mk,serial_no,cstp_stus_tms,cstp_stus_tp,cstp_stus_rapl,cstp_stus_rchk,cstp_stus_aply_mk,item_no)
...
ALTER TABLE  prestage.sbd_tact028_prestage OWNER TO ap_sbd;
