...
DROP TABLE IF EXISTS  prestage.sbd_blit032_prestage;

CREATE TABLE  prestage.sbd_blit032_prestage (
data_ym varchar(5) ,
ban varchar(8) ,
format_cd varchar(2) ,
pfn varchar(23) ,
...
ALTER TABLE  prestage.sbd_blit032_prestage OWNER TO ap_sbd;
