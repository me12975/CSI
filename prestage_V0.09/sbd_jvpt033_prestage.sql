...
-- Purpose: Prestage資料表;
-- Table: sbd_jvpt033_prestage;
-- Compressed: N ;
-- Distributed: Y (ntf_busi_tp,ntf_no);
...
DROP TABLE IF EXISTS  prestage.sbd_jvpt033_prestage;

CREATE TABLE  prestage.sbd_jvpt033_prestage (
ntf_busi_tp varchar(3) ,
ntf_no varchar(27) ,
ntf_date varchar(7) ,
ntf_rec_seq_no varchar(2) ,
ntf_stus_tp varchar(4) ,
ntf_unit varchar(7) ,
proc_date varchar(7) ,
proc_time varchar(6) ,
ntfd_unit varchar(7) ,
...
finish_stus varchar(1) ,
finish_mk varchar(1) ,
exec_id_cd varchar(5) ,
ntf_user_nm varchar(20) ,
bl_org_cd varchar(3) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (ntf_busi_tp,ntf_no)
...
ALTER TABLE  prestage.sbd_jvpt033_prestage OWNER TO ap_sbd;
