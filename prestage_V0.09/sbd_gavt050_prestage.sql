...
-- Purpose: Prestage資料表;
-- Table: sbd_gavt050_prestage;
-- Compressed: N ;
-- Distributed: Y (stat_ym,town_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_gavt050_prestage;

CREATE TABLE  prestage.sbd_gavt050_prestage (
stat_ym varchar(5) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
...
ALTER TABLE  prestage.sbd_gavt050_prestage OWNER TO ap_sbd;
