...
DROP TABLE IF EXISTS  prestage.sbd_bcmt001_prestage;

CREATE TABLE  prestage.sbd_bcmt001_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
...
ALTER TABLE  prestage.sbd_bcmt001_prestage OWNER TO ap_sbd;
