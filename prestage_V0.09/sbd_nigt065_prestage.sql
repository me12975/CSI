...
DROP TABLE IF EXISTS  prestage.sbd_nigt065_prestage;

CREATE TABLE  prestage.sbd_nigt065_prestage (
dlv_unit varchar(3) ,
tax_cd varchar(2) ,
dlv_yr varchar(3) ,
flg_tp varchar(1) ,
...
ALTER TABLE  prestage.sbd_nigt065_prestage OWNER TO ap_sbd;
