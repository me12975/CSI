...
DROP TABLE IF EXISTS  prestage.sbd_blqt005_prestage;

CREATE TABLE  prestage.sbd_blqt005_prestage (
hsn_cd varchar(1) ,
ban varchar(8) ,
year varchar(3) ,
vat_losn varchar(9) ,
...
ALTER TABLE  prestage.sbd_blqt005_prestage OWNER TO ap_sbd;
