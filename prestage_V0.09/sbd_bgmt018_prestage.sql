...
-- Purpose: Prestage資料表;
-- Table: sbd_bgmt018_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,aphd_item);
...
DROP TABLE IF EXISTS  prestage.sbd_bgmt018_prestage;

CREATE TABLE  prestage.sbd_bgmt018_prestage (
ban varchar(8) ,
recev_date varchar(7) ,
aphd_item varchar(2) ,
rdc_docu_no varchar(40) ,
rmk varchar(152) ,
update_id varchar(8) ,
...
ALTER TABLE  prestage.sbd_bgmt018_prestage OWNER TO ap_sbd;
