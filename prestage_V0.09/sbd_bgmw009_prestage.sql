...
-- Purpose: Prestage資料表;
-- Table: sbd_bgmw009_prestage;
-- Compressed: N ;
-- Distributed: Y (cutoff_ym,bscd);
...
DROP TABLE IF EXISTS  prestage.sbd_bgmw009_prestage;

CREATE TABLE  prestage.sbd_bgmw009_prestage (
cutoff_ym varchar(5) ,
bscd varchar(6) ,
bscd_38_cd varchar(2) ,
busi_chi_nm varchar(30) ,
lrg_bscd varchar(1) ,
bank_rf_mk varchar(1) ,
update_id varchar(8) ,
...
ALTER TABLE  prestage.sbd_bgmw009_prestage OWNER TO ap_sbd;
