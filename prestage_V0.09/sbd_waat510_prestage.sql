...
-- Purpose: Prestage資料表;
-- Table: sbd_waat510_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,clat_g_ldgr_no,clat_s_ldgr_no,adj_prd_mk);
...
DROP TABLE IF EXISTS  prestage.sbd_waat510_prestage;

CREATE TABLE  prestage.sbd_waat510_prestage (
hsn_cd varchar(1) ,
data_yr varchar(3) ,
data_mo varchar(2) ,
clat_g_ldgr_no varchar(3) ,
clat_s_ldgr_no varchar(6) ,
item_cary_fw_yr varchar(3) ,
adj_prd_mk varchar(1) ,
clat_item456_no varchar(3) ,
m_dr_amt decimal(13,0) ,
m_cr_amt decimal(13,0) ,
y_dr_amt decimal(13,0) ,
y_cr_amt decimal(13,0) ,
m_cnt_dr_cr_tp varchar(1) ,
m_cnt decimal(8,0) ,
m_amt_dr_cr_tp varchar(1) ,
m_amt decimal(13,0) ,
acum_cnt_dr_cr_tp varchar(1) ,
acum_cnt decimal(8,0) ,
acum_amt_dr_cr_tp varchar(1) ,
acum_amt decimal(13,0) ,
data_bl_yr varchar(3) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,clat_g_ldgr_no,clat_s_ldgr_no,adj_prd_mk)
...
ALTER TABLE  prestage.sbd_waat510_prestage OWNER TO ap_sbd;
