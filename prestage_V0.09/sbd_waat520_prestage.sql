...
-- Purpose: Prestage資料表;
-- Table: sbd_waat520_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,tax_subtax_cd,this_prev_yr,trs_tp,adj_prd_mk);
...
DROP TABLE IF EXISTS  prestage.sbd_waat520_prestage;

CREATE TABLE  prestage.sbd_waat520_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
data_yr varchar(3) ,
data_mo varchar(2) ,
...
y_budget decimal(13,0) ,
m_budget decimal(13,0) ,
acum_budget decimal(13,0) ,
m_colld decimal(13,0) ,
acum_colld decimal(13,0) ,
m_pay_trs decimal(13,0) ,
acum_pay_trs decimal(13,0) ,
m_srcv_num decimal(13,0) ,
acum_srcv_num decimal(13,0) ,
m_srcv_pay_trs decimal(13,0) ,
acum_srcv_pay_trs decimal(13,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,tax_subtax_cd,this_prev_yr,trs_tp,adj_prd_mk)
...
ALTER TABLE  prestage.sbd_waat520_prestage OWNER TO ap_sbd;
