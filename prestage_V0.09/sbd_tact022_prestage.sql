...
-- Purpose: Prestage資料表;
-- Table: sbd_tact022_prestage;
-- Compressed: N ;
-- Distributed: Y (tax_tp,ba_tax_fine_mk,serial_no,cstp_stus_tms,cstp_stus_tp,cstp_stus_rapl,cstp_stus_rchk,cstp_stus_aply_mk);
...
DROP TABLE IF EXISTS  prestage.sbd_tact022_prestage;

CREATE TABLE  prestage.sbd_tact022_prestage (
tax_tp varchar(1) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
app_yy varchar(2) ,
...
serial_no varchar(5) ,
cstp_stus_tms varchar(1) ,
cstp_stus_tp varchar(1) ,
cstp_stus_rapl varchar(1) ,
cstp_stus_rchk varchar(1) ,
cstp_stus_aply_mk varchar(1) ,
asg_mk varchar(1) ,
asg_stus varchar(1) ,
asg_date varchar(7) ,
carry_date varchar(7) ,
carry_seq_no decimal(3,0) ,
tp_seq_no varchar(1) ,
mdasg_mode varchar(1) ,
mdasg_rvwr_date varchar(7) ,
o_rvwr_cd varchar(5) ,
o_rvwc_cd varchar(5) ,
extd_sh_fsh_date varchar(7) ,
extd_tms decimal(2,0) ,
extd_urge_tms decimal(2,0) ,
no_book_mk varchar(1) ,
lend_no varchar(17) ,
mtg_tp_cd varchar(10) ,
arrg_mtg_date varchar(7) ,
mtgdt varchar(7) ,
mtgno decimal(4,0) ,
mtg_case_no decimal(4,0) ,
dsdc_carry_date varchar(7) ,
dsdc_inform_date varchar(7) ,
dsdc_inform_no varchar(11) ,
dsdc_send_date varchar(7) ,
ft_mtgno decimal(4,0) ,
lt_mtgno decimal(4,0) ,
dlvk_mtgno decimal(4,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (tax_tp,ba_tax_fine_mk,serial_no,cstp_stus_tms,cstp_stus_tp,cstp_stus_rapl,cstp_stus_rchk,cstp_stus_aply_mk)
...
ALTER TABLE  prestage.sbd_tact022_prestage OWNER TO ap_sbd;
