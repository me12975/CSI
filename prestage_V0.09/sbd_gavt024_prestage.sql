...
DROP TABLE IF EXISTS  prestage.sbd_gavt024_prestage;

CREATE TABLE  prestage.sbd_gavt024_prestage (
...
npss_amt decimal(10,0) ,
tpss_shr_nmrt decimal(10,0) ,
tpss_shr_dnt decimal(10,0) ,
tpss_amt decimal(10,0) ,
ltax_amt decimal(10,0) ,
rlzt_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_gavt024_prestage OWNER TO ap_sbd;
