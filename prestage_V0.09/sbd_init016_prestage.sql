...
-- Purpose: Prestage資料表;
-- Table: sbd_init016_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,idn);
...
DROP TABLE IF EXISTS  prestage.sbd_init016_prestage;

CREATE TABLE  prestage.sbd_init016_prestage (
...
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,idn)
...
ALTER TABLE  prestage.sbd_init016_prestage OWNER TO ap_sbd;
