...
-- Purpose: Prestage資料表;
-- Table: sbd_ipat070_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_idn_ban,incm_pfn_seq_no,databag_case_no,sctn_cd,rvnu_item_seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ipat070_prestage;

CREATE TABLE  prestage.sbd_ipat070_prestage (
...
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_idn_ban,incm_pfn_seq_no,databag_case_no,sctn_cd,rvnu_item_seq_no)
...
ALTER TABLE  prestage.sbd_ipat070_prestage OWNER TO ap_sbd;
