...
DROP TABLE IF EXISTS  prestage.sbd_blit028_prestage;

CREATE TABLE  prestage.sbd_blit028_prestage (
format_cd varchar(2) ,
data_ym varchar(5) ,
...
ALTER TABLE  prestage.sbd_blit028_prestage OWNER TO ap_sbd;
