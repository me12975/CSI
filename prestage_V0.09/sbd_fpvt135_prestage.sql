...
-- Purpose: Prestage資料表;
-- Table: sbd_fpvt135_prestage;
-- Compressed: N ;
-- Distributed: Y (fbrk_cd,fbrk_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_fpvt135_prestage;

CREATE TABLE  prestage.sbd_fpvt135_prestage (
fbrk_cd varchar(7) ,
fbrk_tp varchar(1) ,
hsn_cd varchar(1) ,
co_ban varchar(8) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (fbrk_cd,fbrk_tp)
...
ALTER TABLE  prestage.sbd_fpvt135_prestage OWNER TO ap_sbd;
