...
-- Purpose: Prestage資料表;
-- Table: sbd_wsst130_prestage;
-- Compressed: N ;
-- Distributed: Y (trs_cd,serial_no,hsn_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_wsst130_prestage;

CREATE TABLE  prestage.sbd_wsst130_prestage (
rvnu_date varchar(7) ,
trs_cd varchar(7) ,
serial_no varchar(6) ,
hsn_cd varchar(1) ,
...
insim_int_b_date varchar(7) ,
tax_amt_tp varchar(1) ,
instm_pds varchar(2) ,
obj_rebate_cd varchar(1) ,
scts_tp varchar(1) ,
divide_no varchar(3) ,
...
tot decimal(12,0) ,
last_cmpt_date varchar(7) ,
dly_pay_amt decimal(11,0) ,
dly_pay_int decimal(11,0) ,
payment_date varchar(7) ,
payment_t_amt decimal(12,0) ,
incm_tp varchar(1) ,
cmpl_cncl_mk varchar(1) ,
cncl_abnor_mk varchar(1) ,
force_cncl_mk varchar(1) ,
cncl_date varchar(7) ,
cncl_time varchar(8) ,
cal_pay_mk varchar(1) ,
update_system_mk varchar(1) ,
update_user_cd varchar(8) ,
update_date varchar(7) ,
update_time varchar(6) ,
time_stamp timestamp ,
data_source varchar(1) ,
ctrl1_code varchar(2) ,
rfrs_mk varchar(1) ,
book_no varchar(6) ,
page_no varchar(6) ,
itcm_pfn varchar(17) ,
update_reas varchar(60) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (trs_cd,serial_no,hsn_cd)
...
ALTER TABLE  prestage.sbd_wsst130_prestage OWNER TO ap_sbd;
