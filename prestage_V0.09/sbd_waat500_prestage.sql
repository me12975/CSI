...
-- Purpose: Prestage資料表;
-- Table: sbd_waat500_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,clat_vouch_no,clat_vouch_tp,clat_g_ldgr_no,clat_s_ldgr_no,dr_cr_tp,aptrs_add_sub_mk,clat_data_dstg);
...
DROP TABLE IF EXISTS  prestage.sbd_waat500_prestage;

CREATE TABLE  prestage.sbd_waat500_prestage (
hsn_cd varchar(1) ,
data_yr varchar(3) ,
clat_vouch_no varchar(5) ,
clat_vouch_tp varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,clat_vouch_no,clat_vouch_tp,clat_g_ldgr_no,clat_s_ldgr_no,dr_cr_tp,aptrs_add_sub_mk,clat_data_dstg)
...
ALTER TABLE  prestage.sbd_waat500_prestage OWNER TO ap_sbd;
