...
DROP TABLE IF EXISTS  prestage.sbd_bgmw020_prestage;

CREATE TABLE  prestage.sbd_bgmw020_prestage (
subj varchar(8) ,
mental_stus varchar(10) ,
nm varchar(20) ,
born_stus varchar(1) ,
born_date varchar(7) ,
idn varchar(10) ,
...
ALTER TABLE  prestage.sbd_bgmw020_prestage OWNER TO ap_sbd;
