...
-- Purpose: Prestage資料表;
-- Table: sbd_irct320_prestage;
-- Compressed: N ;
-- Distributed: Y (recer_ban);
...
DROP TABLE IF EXISTS  prestage.sbd_irct320_prestage;

CREATE TABLE  prestage.sbd_irct320_prestage (
...
ALTER TABLE  prestage.sbd_irct320_prestage OWNER TO ap_sbd;
