...
DROP TABLE IF EXISTS  prestage.sbd_wmmt060_prestage;

CREATE TABLE  prestage.sbd_wmmt060_prestage (
coll_data_tp varchar(1) ,
coll_data_cd varchar(3) ,
coll_data_cd1 varchar(3) ,
coll_data_cd2 varchar(3) ,
coll_data_cd3 varchar(3) ,
coll_chi_nm varchar(25) ,
...
ALTER TABLE  prestage.sbd_wmmt060_prestage OWNER TO ap_sbd;
