...
DROP TABLE IF EXISTS  prestage.sbd_wxxt500_prestage;

CREATE TABLE  prestage.sbd_wxxt500_prestage (
data_ym varchar(5) ,
...
ALTER TABLE  prestage.sbd_wxxt500_prestage OWNER TO ap_sbd;
