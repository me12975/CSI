...
-- Purpose: Prestage資料表;
-- Table: sbd_wtgt090_prestage;
-- Compressed: N ;
-- Distributed: Y (idn_ban,tax_cd,subtax_cd,data_no);
...
DROP TABLE IF EXISTS  prestage.sbd_wtgt090_prestage;

CREATE TABLE  prestage.sbd_wtgt090_prestage (
...
stus_cd varchar(2) ,
depo_idn_ban varchar(10) ,
depo_nm varchar(52) ,
pay_date_b varchar(7) ,
pay_date_e varchar(7) ,
losn varchar(12) ,
online_mk varchar(1) ,
update_stus varchar(2) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (idn_ban,tax_cd,subtax_cd,data_no)
...
ALTER TABLE  prestage.sbd_wtgt090_prestage OWNER TO ap_sbd;
