...
-- Purpose: Prestage資料表;
-- Table: sbd_blot005_prestage;
-- Compressed: N ;
-- Distributed: Y (idn_ban,tax_form_no,bill_of_sight_no);
...
DROP TABLE IF EXISTS  prestage.sbd_blot005_prestage;

CREATE TABLE  prestage.sbd_blot005_prestage (
data_ym varchar(5) ,
idn_ban varchar(10) ,
...
ALTER TABLE  prestage.sbd_blot005_prestage OWNER TO ap_sbd;
