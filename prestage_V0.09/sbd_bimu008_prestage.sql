...
DROP TABLE IF EXISTS  prestage.sbd_bimu008_prestage;

CREATE TABLE  prestage.sbd_bimu008_prestage (
ban varchar(8) ,
...
ALTER TABLE  prestage.sbd_bimu008_prestage OWNER TO ap_sbd;
