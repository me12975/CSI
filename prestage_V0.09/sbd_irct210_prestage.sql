...
-- Purpose: Prestage資料表;
-- Table: sbd_irct210_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn_data_tp,rfn_org_cd,rfn_ctrl_area,rfn_box_no,rfn_book_no,rfn_page_no);
...
DROP TABLE IF EXISTS  prestage.sbd_irct210_prestage;

CREATE TABLE  prestage.sbd_irct210_prestage (
...
gene_ded_amt decimal(14) ,
slry_ded decimal(14) ,
prop_loss_ded decimal(14) ,
saving_ded decimal(14) ,
disab_ded decimal(14) ,
tuition_ded decimal(14) ,
flg_ded_tot decimal(14) ,
gov_dnt_ded decimal(14) ,
dfs_dnt_ded decimal(14) ,
dnt_ded decimal(14) ,
p_ins_ded decimal(14) ,
med_fee_ded decimal(14) ,
disa_loss_ded decimal(14) ,
hou_loan_ded decimal(14) ,
hou_rent decimal(14) ,
tppt_dnt decimal(14) ,
tpg_dnt decimal(14) ,
cnd_dnt decimal(14) ,
cnd_cmpgn_fee decimal(14) ,
pres_cnd_cmpgn_fee decimal(14) ,
prvt_s_dnt decimal(14) ,
...
dfs_dnt_obj_ded decimal(14) ,
dnt_obj_ded decimal(14) ,
hlth_ins_ded decimal(14) ,
ins_payment decimal(14) ,
scts_trade_incm decimal(14) ,
no_cash_ded decimal(14) ,
empl_dist_dif decimal(14) ,
base_incm_tot decimal(14) ,
base_tax decimal(14) ,
gene_incm_tax decimal(14) ,
base_gene_tax_dif decimal(14) ,
mlc_source_incm_tot decimal(14) ,
ovrse_incm decimal(14) ,
ovrse_crd decimal(14) ,
dif_crd_aft_blnc decimal(14) ,
child_edu_o_ded decimal(14) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (rfn_data_tp,rfn_org_cd,rfn_ctrl_area,rfn_box_no,rfn_book_no,rfn_page_no)
...
ALTER TABLE  prestage.sbd_irct210_prestage OWNER TO ap_sbd;
