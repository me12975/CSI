...
DROP TABLE IF EXISTS  prestage.sbd_ibkt001_prestage;

CREATE TABLE  prestage.sbd_ibkt001_prestage (
rfn varchar(17) ,
seq_no decimal(2,0) ,
tpr_idn varchar(10) ,
tpr_nm varchar(20) ,
...
lin_tp varchar(5) ,
road_no varchar(50) ,
houhld_pfn varchar(8) ,
pers_idn varchar(10) ,
pers_nm varchar(20) ,
houhld_spous_idn varchar(10) ,
houhld_spous_nm varchar(20) ,
o_rfn varchar(17) ,
...
ALTER TABLE  prestage.sbd_ibkt001_prestage OWNER TO ap_sbd;
