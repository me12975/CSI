...
-- Purpose: Prestage資料表;
-- Table: sbd_ormt130_prestage;
-- Compressed: N ;
-- Distributed: Y (class_key,prod_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_ormt130_prestage;

CREATE TABLE  prestage.sbd_ormt130_prestage (
class_key decimal(13,0) ,
prod_tp varchar(2) ,
tax_rate decimal(9,5) ,
taxable_unit_nm varchar(3) ,
prod_tp_nm varchar(30) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (class_key,prod_tp)
...
ALTER TABLE  prestage.sbd_ormt130_prestage OWNER TO ap_sbd;
