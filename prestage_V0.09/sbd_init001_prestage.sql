...
-- Purpose: Prestage資料表;
-- Table: sbd_init001_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_init001_prestage;

CREATE TABLE  prestage.sbd_init001_prestage (
...
prof_tp varchar(2) ,
apl_tp varchar(1) ,
apl_rvnu decimal(14,0) ,
apl_exp decimal(14,0) ,
apl_incm decimal(14,0) ,
mrg_rvnu decimal(14,0) ,
drct_apl_exp decimal(14,0) ,
...
ded_pay_yr1 varchar(3) ,
ded_pay_yr2 varchar(3) ,
ded_pay_yr3 varchar(3) ,
ded_amt1 decimal(14,0) ,
ded_amt2 decimal(14,0) ,
ded_amt3 decimal(14,0) ,
pay_amt1 decimal(14,0) ,
pay_amt2 decimal(14,0) ,
pay_amt3 decimal(14,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no)
...
ALTER TABLE  prestage.sbd_init001_prestage OWNER TO ap_sbd;
