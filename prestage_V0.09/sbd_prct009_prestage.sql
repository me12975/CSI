...
-- Purpose: Prestage資料表;
-- Table: sbd_prct009_prestage;
-- Compressed: N ;
-- Distributed: Y (data_yr,tax_rtn_kd,tax_rtn_item_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_prct009_prestage;

CREATE TABLE  prestage.sbd_prct009_prestage (
data_yr varchar(3) ,
tax_rtn_kd varchar(3) ,
tax_rtn_item_cd varchar(4) ,
tax_rtn_arrg_seq varchar(4) ,
tax_rtn_item_nm varchar(100) ,
tax_rtn_field_nm varchar(25) ,
abate_incm_field varchar(1) ,
ctx_field varchar(1) ,
abate_tax_field varchar(1) ,
are_acoll_field varchar(1) ,
update_cd varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (data_yr,tax_rtn_kd,tax_rtn_item_cd)
...
ALTER TABLE  prestage.sbd_prct009_prestage OWNER TO ap_sbd;
