...
DROP TABLE IF EXISTS  prestage.sbd_blot006_prestage;

CREATE TABLE  prestage.sbd_blot006_prestage (
data_ym varchar(5) ,
idn_ban varchar(10) ,
tax_form_no varchar(14) ,
bill_of_sight_no varchar(14) ,
ref_date varchar(7) ,
ref_tot decimal(14,0) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
...
ALTER TABLE  prestage.sbd_blot006_prestage OWNER TO ap_sbd;
