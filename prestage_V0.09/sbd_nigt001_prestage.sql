...
DROP TABLE IF EXISTS  prestage.sbd_nigt001_prestage;

CREATE TABLE  prestage.sbd_nigt001_prestage (
dlv_unit varchar(3) ,
tax_cd varchar(2) ,
dlv_yr varchar(3) ,
flg_tp varchar(1) ,
...
ALTER TABLE  prestage.sbd_nigt001_prestage OWNER TO ap_sbd;
