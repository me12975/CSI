...
-- Purpose: Prestage資料表;
-- Table: sbd_tact013_prestage;
-- Compressed: N ;
-- Distributed: Y (unit_cd,tax_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_tact013_prestage;

CREATE TABLE  prestage.sbd_tact013_prestage (
unit_cd varchar(3) ,
tax_cd varchar(2) ,
ctrl_unit_cd varchar(3) ,
...
ALTER TABLE  prestage.sbd_tact013_prestage OWNER TO ap_sbd;
