...
DROP TABLE IF EXISTS  prestage.sbd_brmt060_prestage;

CREATE TABLE  prestage.sbd_brmt060_prestage (
ban varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
serv_area varchar(2) ,
acu_dtn_cr_tax decimal(12,0) ,
...
no_inform_date varchar(7) ,
no_inform_docu_no varchar(30) ,
send_date varchar(7) ,
...
ALTER TABLE  prestage.sbd_brmt060_prestage OWNER TO ap_sbd;
