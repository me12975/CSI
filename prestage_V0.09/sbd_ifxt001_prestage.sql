...
-- Purpose: Prestage資料表;
-- Table: sbd_ifxt001_prestage;
-- Compressed: N ;
-- Distributed: Y (alien_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_ifxt001_prestage;

CREATE TABLE  prestage.sbd_ifxt001_prestage (
alien_idn varchar(10) ,
idn varchar(10) ,
alien_losn varchar(10) ,
eng_nm varchar(60) ,
chi_nm varchar(20) ,
sex_tp varchar(1) ,
...
born_date varchar(7) ,
ntnty_cd varchar(3) ,
serv_inst varchar(30) ,
pstn_ttl_cd varchar(2) ,
co_tel varchar(13) ,
resd_tel varchar(13) ,
roc_addr_hsn_cd varchar(1) ,
roc_addr_hsn_nm varchar(3) ,
roc_addr_town_cd varchar(2) ,
roc_addr_town_nm varchar(5) ,
roc_addr_vill_cd varchar(2) ,
roc_addr_vill_nm varchar(5) ,
roc_addr_lin varchar(5) ,
roc_addr_road_no varchar(70) ,
ovrse_addr varchar(60) ,
...
ALTER TABLE  prestage.sbd_ifxt001_prestage OWNER TO ap_sbd;
