...
DROP TABLE IF EXISTS  prestage.sbd_ptit007_prestage;

CREATE TABLE  prestage.sbd_ptit007_prestage (
payment_unit_ban varchar(8) ,
seq_no varchar(4) ,
...
ALTER TABLE  prestage.sbd_ptit007_prestage OWNER TO ap_sbd;
