...
DROP TABLE IF EXISTS  prestage.sbd_prct037_prestage;

CREATE TABLE  prestage.sbd_prct037_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
...
incnt_xmp_incm2 decimal(14,0) ,
incnt_xmp_incm3 decimal(14,0) ,
incnt_xmp_incm4 decimal(14,0) ,
incnt_xmp_incm5 decimal(14,0) ,
incnt_xmp_incm6 decimal(14,0) ,
incnt_xmp_incm7 decimal(14,0) ,
qlfy_xmp_incm1 decimal(14,0) ,
qlfy_xmp_incm2 decimal(14,0) ,
qlfy_xmp_incm3 decimal(14,0) ,
qlfy_xmp_incm4 decimal(14,0) ,
qlfy_xmp_incm5 decimal(14,0) ,
qlfy_xmp_incm6 decimal(14,0) ,
qlfy_xmp_incm7 decimal(14,0) ,
excl_incm_cond1 varchar(1) ,
excl_incm_cond2 varchar(1) ,
excl_incm_cond3 varchar(1) ,
excl_incm_cond4 varchar(1) ,
excl_incm_cond5 varchar(1) ,
excl_incm_cond6 varchar(1) ,
excl_incm_cond7 varchar(1) ,
ovrse_brch_xmp decimal(14,0) ,
base_incm decimal(14,0) ,
gene_incm decimal(14,0) ,
pybl_tax decimal(14,0) ,
oth_law_invt_ctx decimal(14,0) ,
...
base_dmst_xmp_incm decimal(14,0) ,
source_pay_incm_tax decimal(14,0) ,
crd_base_gene_dif decimal(14,0) ,
force_mk varchar(1) ,
update_cd varchar(1) ,
keyin_id_cd varchar(8) ,
keyin_date varchar(7) ,
time_stamp timestamp ,
zsy_ded_2 decimal(14,0) ,
zsy_ded_6 decimal(14,0) ,
base_incm_mk varchar(1) ,
scts_ftt_incm1 decimal(14,0) ,
ovrse_brch_xmp1 decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_prct037_prestage OWNER TO ap_sbd;
