...
-- Purpose: Prestage資料表;
-- Table: sbd_prct068_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,recev_no,trade_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_prct068_prestage;

CREATE TABLE  prestage.sbd_prct068_prestage (
data_yr varchar(3) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
ban varchar(8) ,
recev_no varchar(8) ,
trade_tp varchar(3) ,
act_rvnu_trade_amt decimal(14,0) ,
act_exp_trade_amt decimal(14,0) ,
flg_rvnu_trade_amt decimal(14,0) ,
flg_exp_trade_amt decimal(14,0) ,
trade_amt_method varchar(14) ,
trade_amt_oth_expl varchar(40) ,
update_cd varchar(1) ,
force_mk varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (ban,recev_no,trade_tp)
...
ALTER TABLE  prestage.sbd_prct068_prestage OWNER TO ap_sbd;
