...
-- Purpose: Prestage資料表;
-- Table: sbd_bcmt011_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,serv_area,scttm_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_bcmt011_prestage;

CREATE TABLE  prestage.sbd_bcmt011_prestage (
chk_ym varchar(5) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
serv_area varchar(2) ,
scttm_cd varchar(2) ,
pre_cal_busi_cnt decimal(6,0) ,
chk_rslt_busi_cnt1 decimal(6,0) ,
chk_rslt_busi_cnt2 decimal(6,0) ,
chk_rslt_busi_cnt3 decimal(6,0) ,
chk_rslt_busi_cnt4 decimal(6,0) ,
chk_rslt_busi_cnt5 decimal(6,0) ,
chk_rslt_busi_cnt6 decimal(6,0) ,
chk_rslt_busi_cnt7 decimal(6,0) ,
chk_rslt_busi_cnt8 decimal(6,0) ,
chk_rslt_busi_cnt9 decimal(6,0) ,
chk_rslt_busi_cnt10 decimal(6,0) ,
vio_busi_cnt decimal(6,0) ,
suple_amt decimal(14,0) ,
suple_tax decimal(12,0) ,
jdgf_amt decimal(12,0) ,
time_stamp timestamp ,
stop_pre_cal_busi_cnt decimal(6,0) ,
stop_chk_rslt_cnt1 decimal(6,0) ,
stop_chk_rslt_cnt2 decimal(6,0) ,
stop_chk_rslt_cnt3 decimal(6,0) ,
stop_chk_rslt_cnt4 decimal(6,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,serv_area,scttm_cd)
...
ALTER TABLE  prestage.sbd_bcmt011_prestage OWNER TO ap_sbd;
