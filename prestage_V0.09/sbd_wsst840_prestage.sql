...
DROP TABLE IF EXISTS  prestage.sbd_wsst840_prestage;

CREATE TABLE  prestage.sbd_wsst840_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
town_nm varchar(4) ,
...
ALTER TABLE  prestage.sbd_wsst840_prestage OWNER TO ap_sbd;
