...
DROP TABLE IF EXISTS  prestage.sbd_pgmt004_prestage;

CREATE TABLE  prestage.sbd_pgmt004_prestage (
data_yr varchar(3) ,
bscd varchar(6) ,
net_pf_rate_std decimal(2,0) ,
suit_form_adt_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_pgmt004_prestage OWNER TO ap_sbd;
