...
DROP TABLE IF EXISTS  prestage.sbd_crmt110_prestage;

CREATE TABLE  prestage.sbd_crmt110_prestage (
...
ALTER TABLE  prestage.sbd_crmt110_prestage OWNER TO ap_sbd;
