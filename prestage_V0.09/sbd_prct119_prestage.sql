...
DROP TABLE IF EXISTS  prestage.sbd_prct119_prestage;

CREATE TABLE  prestage.sbd_prct119_prestage (
ban varchar(8) ,
recev_no varchar(8) ,
data_yr varchar(3) ,
hsn_cd varchar(1) ,
...
invt_idn varchar(10) ,
cash decimal(14,0) ,
no_cash decimal(14,0) ,
tot decimal(14,0) ,
invt_amt decimal(14,0) ,
estab_wv_payment_tot decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_prct119_prestage OWNER TO ap_sbd;
