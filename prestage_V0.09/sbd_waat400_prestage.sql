...
-- Purpose: Prestage資料表;
-- Table: sbd_waat400_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,clat_vouch_no);
...
DROP TABLE IF EXISTS  prestage.sbd_waat400_prestage;

CREATE TABLE  prestage.sbd_waat400_prestage (
hsn_cd varchar(1) ,
fiscal_yr varchar(3) ,
...
data_nums decimal(5,0) ,
vou_cnt decimal(8,0) ,
vou_amt decimal(13,0) ,
vouch_make_date varchar(7) ,
print_date varchar(7) ,
acc_date varchar(7) ,
post_d_date varchar(7) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,clat_vouch_no)
...
ALTER TABLE  prestage.sbd_waat400_prestage OWNER TO ap_sbd;
