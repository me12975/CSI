...
-- Purpose: Prestage資料表;
-- Table: sbd_ormt112_prestage;
-- Compressed: N ;
-- Distributed: Y (data_key,prod_main_no,prod_main_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_ormt112_prestage;

CREATE TABLE  prestage.sbd_ormt112_prestage (
data_key decimal(13,0) ,
prod_main_no varchar(1) ,
prod_main_tp varchar(1) ,
prod_tp varchar(2) ,
factory_serial varchar(3) ,
ban varchar(8) ,
status varchar(2) ,
start_date date ,
end_date date ,
...
TABLESPACE sbd 
DISTRIBUTED BY (data_key,prod_main_no,prod_main_tp)
...
ALTER TABLE  prestage.sbd_ormt112_prestage OWNER TO ap_sbd;
