...
DROP TABLE IF EXISTS  prestage.sbd_blot025_prestage;

CREATE TABLE  prestage.sbd_blot025_prestage (
...
data_tp varchar(1) ,
dstg_data_tp_nm varchar(2) ,
cntr_ban varchar(8) ,
cntr_nm varchar(52) ,
vat_addr varchar(80) ,
app_date varchar(7) ,
water_ele_b_no varchar(13) ,
water_ele_e_no varchar(13) ,
water_b_no varchar(11) ,
water_e_no varchar(11) ,
build_lic_b_no varchar(30) ,
build_lic_e_no varchar(30) ,
build_use_lic_no varchar(30) ,
water_ele_app_nm varchar(52) ,
water_ele_addr varchar(80) ,
list_mk varchar(1) ,
pkg_mk varchar(1) ,
lamp_mk varchar(1) ,
ele_mk varchar(1) ,
asm_mk varchar(1) ,
n_estab_mk varchar(1) ,
add_estab_mk varchar(1) ,
temp_mk varchar(1) ,
cstmr_mk varchar(1) ,
chg_kd_mk varchar(1) ,
estab_chg_mk varchar(1) ,
istl_chg_mk varchar(1) ,
mrg_mk varchar(1) ,
rstr_water_ele_mk varchar(1) ,
ntc_ele_date varchar(7) ,
eng_tot decimal(14,0) ,
istl_place_area decimal(5,0) ,
...
ALTER TABLE  prestage.sbd_blot025_prestage OWNER TO ap_sbd;
