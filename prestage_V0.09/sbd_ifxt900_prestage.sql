...
-- Purpose: Prestage資料表;
-- Table: sbd_ifxt900_prestage;
-- Compressed: N ;
-- Distributed: Y (recev_no,alien_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_ifxt900_prestage;

CREATE TABLE  prestage.sbd_ifxt900_prestage (
recev_date varchar(7) ,
recev_no varchar(10) ,
rfn_data_yr varchar(3) ,
rfn_data_tp varchar(3) ,
rfn_hsn_cd varchar(1) ,
rfn_org varchar(2) ,
rfn_ctrl_area varchar(2) ,
rfn_serial varchar(6) ,
rsdt_type varchar(1) ,
data_sorce varchar(1) ,
keyin_date varchar(7) ,
alien_idn varchar(10) ,
spous_alien_idn varchar(10) ,
flg_incm_t decimal(14,0) ,
flg_tax decimal(14,0) ,
pay_ref_tp varchar(1) ,
flg_slf_pay_amt decimal(14,0) ,
flg_ref decimal(14,0) ,
tel_no varchar(26) ,
ext_no varchar(4) ,
tpr_nm varchar(20) ,
tpr_nm_eng varchar(60) ,
spous_nm varchar(20) ,
spous_nm_eng varchar(60) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (recev_no,alien_idn)
...
ALTER TABLE  prestage.sbd_ifxt900_prestage OWNER TO ap_sbd;
