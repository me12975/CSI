...
DROP TABLE IF EXISTS  prestage.sbd_jvpt001_prestage;

CREATE TABLE  prestage.sbd_jvpt001_prestage (
...
ALTER TABLE  prestage.sbd_jvpt001_prestage OWNER TO ap_sbd;
