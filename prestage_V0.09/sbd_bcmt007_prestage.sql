...
-- Purpose: Prestage資料表;
-- Table: sbd_bcmt007_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,docu_no);
...
DROP TABLE IF EXISTS  prestage.sbd_bcmt007_prestage;

CREATE TABLE  prestage.sbd_bcmt007_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
docu_no varchar(10) ,
sup_docu_mk varchar(1) ,
o_losn varchar(9) ,
o_resp_idn varchar(24) ,
o_resp_nm varchar(30) ,
o_ban_nm varchar(52) ,
o_ban_addr_hsn_nm varchar(6) ,
o_ban_addr_town_nm varchar(8) ,
o_ban_addr_vill_nm varchar(8) ,
o_ban_addr_lin varchar(8) ,
o_ban_addr_road_no varchar(50) ,
o_orgn_tp varchar(1) ,
o_busi_item1 varchar(6) ,
o_busi_item2 varchar(6) ,
o_busi_item3 varchar(6) ,
o_busi_item4 varchar(6) ,
o_capital decimal(14,0) ,
n_orgn_tp varchar(1) ,
n_busi_item1 varchar(6) ,
n_busi_item2 varchar(6) ,
n_busi_item3 varchar(6) ,
n_busi_item4 varchar(6) ,
n_capital decimal(14,0) ,
chg_date varchar(7) ,
chg_item varchar(20) ,
inves_mk1 varchar(1) ,
inves_rmk1 varchar(20) ,
app_mk1 varchar(1) ,
app_mk2 varchar(1) ,
app_mk3 varchar(1) ,
app_mk4 varchar(1) ,
inves_mk2 varchar(1) ,
inves_rmk2 varchar(20) ,
inves_mk3 varchar(1) ,
inves_rmk3 varchar(20) ,
inves_mk4 varchar(1) ,
inves_rmk4 varchar(20) ,
inves_mk5 varchar(1) ,
inves_rmk5 varchar(20) ,
inves_mk6 varchar(1) ,
inves_rmk6 varchar(20) ,
inves_mk7 varchar(1) ,
inves_rmk7 varchar(20) ,
resp_nm1 varchar(30) ,
ban1 varchar(8) ,
s_stop_date1 varchar(7) ,
org1 varchar(3) ,
abnor_reas1 varchar(2) ,
resp_nm2 varchar(30) ,
ban2 varchar(8) ,
s_stop_date2 varchar(7) ,
org2 varchar(3) ,
abnor_reas2 varchar(2) ,
resp_nm3 varchar(30) ,
ban3 varchar(8) ,
s_stop_date3 varchar(7) ,
org3 varchar(3) ,
abnor_reas3 varchar(2) ,
inves_mk8 varchar(1) ,
inves_rmk8 varchar(20) ,
inves_mk9 varchar(1) ,
inves_rmk9 varchar(20) ,
appr_rmk1 varchar(20) ,
appr_rmk2 varchar(20) ,
ntf_boss1 varchar(52) ,
ntf_boss2 varchar(52) ,
ntf_boss3 varchar(52) ,
ntf_boss4 varchar(52) ,
ntf_boss5 varchar(52) ,
ntf_boss6 varchar(52) ,
ntf_boss1_addr varchar(80) ,
ntf_boss2_addr varchar(80) ,
ntf_boss3_addr varchar(80) ,
ntf_boss4_addr varchar(80) ,
ntf_boss5_addr varchar(80) ,
ntf_boss6_addr varchar(80) ,
rmk varchar(80) ,
inves_sgst_mk varchar(1) ,
un_open_mk1 varchar(1) ,
un_open_mk2 varchar(1) ,
un_open_mk3 varchar(1) ,
un_open_mk4 varchar(1) ,
oth_inves_sgst varchar(40) ,
tax_cmpt varchar(1) ,
levy_mode varchar(1) ,
used_mk varchar(1) ,
time_stamp timestamp ,
unpaid_exp_mk varchar(1) ,
sumbit_dcd_mk varchar(1) ,
app_mk5 varchar(1) ,
app_mk6 varchar(1) ,
app_mk7 varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,docu_no)
...
ALTER TABLE  prestage.sbd_bcmt007_prestage OWNER TO ap_sbd;
