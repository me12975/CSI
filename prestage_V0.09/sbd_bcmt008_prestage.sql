...
DROP TABLE IF EXISTS  prestage.sbd_bcmt008_prestage;

CREATE TABLE  prestage.sbd_bcmt008_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
docu_no varchar(10) ,
...
ALTER TABLE  prestage.sbd_bcmt008_prestage OWNER TO ap_sbd;
