...
-- Purpose: Prestage資料表;
-- Table: sbd_biat004_prestage;
-- Compressed: N ;
-- Distributed: Y (case_source,case_tp,serial_no,batch_no_serial_no);
...
DROP TABLE IF EXISTS  prestage.sbd_biat004_prestage;

CREATE TABLE  prestage.sbd_biat004_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
chk_yy varchar(3) ,
chk_mm varchar(2) ,
...
evade_invo_tms varchar(1) ,
chk_rslt_mk varchar(1) ,
seize_date varchar(7) ,
evade_invo_amt decimal(14,0) ,
evade_s_amt decimal(14,0) ,
evade_tax decimal(12,0) ,
vio_amt decimal(14,0) ,
proc_stus varchar(80) ,
update_date varchar(7) ,
update_user_cd varchar(8) ,
time_stamp timestamp ,
chk_item varchar(40) ,
chk_qty decimal(12,0) ,
chk_unit decimal(14,2) ,
vio_amt_stus varchar(1) ,
chk_sign varchar(1) ,
chk_witness varchar(1) ,
chk_form_no varchar(23) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (case_source,case_tp,serial_no,batch_no_serial_no)
...
ALTER TABLE  prestage.sbd_biat004_prestage OWNER TO ap_sbd;
