...
-- Purpose: Prestage資料表;
-- Table: sbd_blmu011_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,keyin_id_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_blmu011_prestage;

CREATE TABLE  prestage.sbd_blmu011_prestage (
ban varchar(8) ,
agent_idn_ban varchar(10) ,
update_date_time varchar(15) ,
prs_add_mk varchar(1) ,
prs_revo_mk varchar(1) ,
prs_appr_no varchar(10) ,
prs_appr_date varchar(7) ,
prs_start_ym varchar(5) ,
prs_revo_ym varchar(5) ,
s_item_add_mk varchar(1) ,
s_item_revo_mk varchar(1) ,
s_item_appr_no varchar(10) ,
s_item_appr_date varchar(7) ,
s_item_start_ym varchar(5) ,
s_item_revo_ym varchar(5) ,
tax_rtn_add_mk varchar(1) ,
tax_rtn_revo_mk varchar(1) ,
tax_rtn_appr_no varchar(10) ,
tax_rtn_appr_date varchar(7) ,
tax_rtn_start_ym varchar(5) ,
tax_rtn_revo_ym varchar(5) ,
sumy_add_mk varchar(1) ,
sumy_revo_mk varchar(1) ,
sumy_appr_no varchar(10) ,
sumy_appr_date varchar(7) ,
sumy_start_ym varchar(7) ,
sumy_revo_ym varchar(7) ,
cntct_nm varchar(30) ,
cntct_tel_area_cd varchar(3) ,
cntct_tel varchar(12) ,
cntct_tel_ext_no varchar(6) ,
fax_no varchar(12) ,
email_addr varchar(30) ,
soft_factory varchar(52) ,
use_c3ev_mk varchar(1) ,
net_start_ym varchar(5) ,
app_date varchar(7) ,
trstr_cd varchar(8) ,
remark varchar(1000) ,
appr_sumy_cond varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (ban,keyin_id_cd)
...
ALTER TABLE  prestage.sbd_blmu011_prestage OWNER TO ap_sbd;
