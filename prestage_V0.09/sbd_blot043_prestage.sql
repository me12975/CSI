...
-- Purpose: Prestage資料表;
-- Table: sbd_blot043_prestage;
-- Compressed: N ;
-- Distributed: Y (tax_rgl_no);
...
DROP TABLE IF EXISTS  prestage.sbd_blot043_prestage;

CREATE TABLE  prestage.sbd_blot043_prestage (
tax_rgl_no varchar(11) ,
chi_gd_nm varchar(120) ,
eng_gd_nm varchar(50) ,
stat_qty_unit varchar(3) ,
stat_weight_unit varchar(3) ,
tax_rgl varchar(24) ,
input_rgl varchar(40) ,
output_rgl varchar(40) ,
first_tax_rate varchar(60) ,
time_stamp timestamp ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (tax_rgl_no)
...
ALTER TABLE  prestage.sbd_blot043_prestage OWNER TO ap_sbd;
