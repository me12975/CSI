...
-- Purpose: Prestage資料表;
-- Table: sbd_wxxt200_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,tax_cd,subtax_cd,data_no,divide_no,instm_pds);
...
DROP TABLE IF EXISTS  prestage.sbd_wxxt200_prestage;

CREATE TABLE  prestage.sbd_wxxt200_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
tax_cd varchar(2) ,
...
instm_s_date varchar(7) ,
instm_e_date varchar(7) ,
alcs_instm_mk varchar(1) ,
revo_instm_mk varchar(1) ,
instm_pay_off_mk varchar(1) ,
instm_ba_tax decimal(12,0) ,
paid_ba_tax decimal(12,0) ,
instm_misc1_cd varchar(1) ,
instm_misc1_amt decimal(11,0) ,
paid_misc1_amt decimal(11,0) ,
instm_misc2_cd varchar(1) ,
instm_misc2_amt decimal(11,0) ,
paid_misc2_amt decimal(11,0) ,
instm_misc3_cd varchar(1) ,
instm_misc3_amt decimal(11,0) ,
paid_misc3_amt decimal(11,0) ,
instm_misc4_cd varchar(1) ,
instm_misc4_amt decimal(11,0) ,
paid_misc4_amt decimal(11,0) ,
instm_misc5_cd varchar(1) ,
instm_misc5_amt decimal(11,0) ,
paid_misc5_amt decimal(11,0) ,
instm_misc6_cd varchar(1) ,
instm_misc6_amt decimal(11,0) ,
paid_misc6_amt decimal(11,0) ,
instm_misc7_cd varchar(1) ,
instm_misc7_amt decimal(11,0) ,
paid_misc7_amt decimal(11,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,tax_cd,subtax_cd,data_no,divide_no,instm_pds)
...
ALTER TABLE  prestage.sbd_wxxt200_prestage OWNER TO ap_sbd;
