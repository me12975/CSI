...
-- Purpose: Prestage資料表;
-- Table: sbd_ibrt421_prestage;
-- Compressed: N ;
-- Distributed: Y (head_bank,brch_bank,hou_borrower_idn,debt_account_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ibrt421_prestage;

CREATE TABLE  prestage.sbd_ibrt421_prestage (
data_yr varchar(3) ,
head_bank varchar(3) ,
brch_bank varchar(4) ,
hou_loc varchar(120) ,
hou_holder_nm varchar(40) ,
hou_holder_idn varchar(10) ,
hou_get_date varchar(7) ,
hou_borrower_nm varchar(20) ,
hou_borrower_idn varchar(10) ,
debt_account_no varchar(50) ,
ft_debt_amt decimal(14) ,
debt_b_date varchar(7) ,
debt_e_date varchar(7) ,
un_rpy_amt decimal(14) ,
pay_int_b_ym varchar(5) ,
pay_int_e_ym varchar(5) ,
hou_loan_int decimal(14) ,
data_source_mk varchar(1) ,
trsf_file_date varchar(7) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (head_bank,brch_bank,hou_borrower_idn,debt_account_no)
...
ALTER TABLE  prestage.sbd_ibrt421_prestage OWNER TO ap_sbd;
