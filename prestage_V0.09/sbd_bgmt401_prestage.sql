...
-- Purpose: Prestage資料表;
-- Table: sbd_bgmt401_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,ctrled_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_bgmt401_prestage;

CREATE TABLE  prestage.sbd_bgmt401_prestage (
ban varchar(8) ,
ctrled_idn varchar(10) ,
case_type varchar(1) ,
docu_no varchar(80) ,
prev_case_type varchar(1) ,
prev_docu_no varchar(80) ,
ctrl_tp varchar(1) ,
process_date varchar(7) ,
process_unit varchar(60) ,
process_type_cd varchar(2) ,
process_type varchar(20) ,
catch_during_s varchar(5) ,
catch_during_e varchar(5) ,
mk varchar(1) ,
update_id varchar(8) ,
...
ALTER TABLE  prestage.sbd_bgmt401_prestage OWNER TO ap_sbd;
