...
DROP TABLE IF EXISTS  prestage.sbd_bgmt017_prestage;

CREATE TABLE  prestage.sbd_bgmt017_prestage (
ban varchar(8) ,
busi_tel_no varchar(10) ,
busi_tel_ext_no varchar(4) ,
busi_fax_no varchar(10) ,
email_addr varchar(40) ,
agt_tel_no varchar(10) ,
agt_tel_ext_no varchar(4) ,
agt_fax_no varchar(10) ,
agt_email_addr varchar(200) ,
mail_addr varchar(80) ,
mail_mk varchar(1) ,
agent_prop_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_bgmt017_prestage OWNER TO ap_sbd;
