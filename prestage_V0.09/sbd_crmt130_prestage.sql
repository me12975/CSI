...
DROP TABLE IF EXISTS  prestage.sbd_crmt130_prestage;

CREATE TABLE  prestage.sbd_crmt130_prestage (
class_key decimal(13,0) ,
tob_lq_main_no varchar(1) ,
tob_lq_main_tp varchar(1) ,
tob_lq_tp varchar(2) ,
tob_lq_tp_nm varchar(14) ,
...
ALTER TABLE  prestage.sbd_crmt130_prestage OWNER TO ap_sbd;
