...
DROP TABLE IF EXISTS  prestage.sbd_blot027_prestage;

CREATE TABLE  prestage.sbd_blot027_prestage (
...
car_no varchar(8) ,
o_c_owner_ban varchar(10) ,
losn varchar(9) ,
o_c_owner_nm varchar(52) ,
o_c_owner_addr varchar(80) ,
car_kd_cd varchar(12) ,
brand varchar(52) ,
car_out_f_ym varchar(6) ,
t_exht varchar(10) ,
transfer_date varchar(7) ,
n_c_owner_idn_ban varchar(10) ,
n_c_owner_nm varchar(52) ,
n_c_owner_addr varchar(80) ,
schdl_tax decimal(14,0) ,
levy_mk varchar(1) ,
levy_tp varchar(1) ,
...
ALTER TABLE  prestage.sbd_blot027_prestage OWNER TO ap_sbd;
