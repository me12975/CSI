...
-- Purpose: Prestage資料表;
-- Table: sbd_bmst002_prestage;
-- Compressed: N ;
-- Distributed: Y (serv_area,item_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_bmst002_prestage;

CREATE TABLE  prestage.sbd_bmst002_prestage (
coll_ym varchar(5) ,
pr_cd varchar(1) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
serv_area varchar(2) ,
item_cd varchar(2) ,
busi_cnt_tot decimal(8,0) ,
busi_cnt_co decimal(6,0) ,
busi_cnt_partner decimal(6,0) ,
busi_cnt_ind_prp decimal(6,0) ,
busi_cnt_oth decimal(6,0) ,
invo_copy decimal(12,0) ,
sale_amt_tot decimal(18,0) ,
txl_s_amt decimal(16,0) ,
ztx_s_amt decimal(16,0) ,
xmp_s_amt decimal(16,0) ,
acu_sale_amt_tot decimal(18,0) ,
acu_txl_s_amt decimal(16,0) ,
acu_ztx_s_amt decimal(16,0) ,
acu_xmp_s_amt decimal(16,0) ,
assess_cnt decimal(6,0) ,
assess_tax decimal(14,0) ,
assess_brf decimal(14,0) ,
assess_oth decimal(14,0) ,
supfile_upd_cnt decimal(6,0) ,
supfile_upd_tax decimal(14,0) ,
supfile_upd_brf decimal(14,0) ,
supfile_upd_oth decimal(14,0) ,
acu_assess_cnt decimal(6,0) ,
acu_assess_tax decimal(15,0) ,
acu_assess_brf decimal(15,0) ,
acu_assess_oth decimal(15,0) ,
colld_cnt decimal(6,0) ,
colld_tax decimal(14,0) ,
colld_brf decimal(14,0) ,
colld_oth decimal(14,0) ,
zsy_colld_cnt decimal(6,0) ,
zsy_colld_tax decimal(14,0) ,
zsy_colld_brf decimal(14,0) ,
zsy_colld_oth decimal(14,0) ,
py_colld_cnt decimal(6,0) ,
py_colld_tax decimal(14,0) ,
py_colld_brf decimal(14,0) ,
py_colld_oth decimal(14,0) ,
acu_colld_cnt decimal(6,0) ,
acu_colld_tax decimal(15,0) ,
acu_colld_brf decimal(15,0) ,
acu_colld_oth decimal(15,0) ,
un_colld_cnt decimal(6,0) ,
un_colld_tax decimal(14,0) ,
un_colld_brf decimal(14,0) ,
un_colld_oth decimal(14,0) ,
zsy_ref_cnt decimal(6,0) ,
zsy_ref_tax decimal(14,0) ,
zsy_ref_brf decimal(14,0) ,
zsy_ref_oth decimal(14,0) ,
py_ref_cnt decimal(6,0) ,
py_ref_tax decimal(14,0) ,
py_ref_brf decimal(14,0) ,
py_ref_oth decimal(14,0) ,
colld_n_cnt decimal(6,0) ,
colld_n_tax decimal(14,0) ,
colld_n_brf decimal(14,0) ,
colld_n_oth decimal(14,0) ,
acu_colld_n_cnt decimal(6,0) ,
acu_colld_n_tax decimal(15,0) ,
acu_colld_n_brf decimal(15,0) ,
acu_colld_n_oth decimal(15,0) ,
m_budget decimal(14,0) ,
acu_budget decimal(15,0) ,
y_budget decimal(15,0) ,
ly_colld_n_tax decimal(14,0) ,
ly_colld_n_brf decimal(14,0) ,
ly_colld_n_oth decimal(14,0) ,
acu_ly_colld_n_tax decimal(15,0) ,
acu_ly_colld_n_brf decimal(15,0) ,
acu_ly_colld_n_oth decimal(15,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (serv_area,item_cd)
...
ALTER TABLE  prestage.sbd_bmst002_prestage OWNER TO ap_sbd;
