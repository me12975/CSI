...
DROP TABLE IF EXISTS  prestage.sbd_peat001_prestage;

CREATE TABLE  prestage.sbd_peat001_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
prov_recev_no varchar(8) ,
prov_recev_date varchar(7) ,
vat_losn varchar(9) ,
prov_tp varchar(1) ,
prov_ly_stl_tax decimal(14,0) ,
prov_tax decimal(14,0) ,
prov_credit_tax decimal(14,0) ,
prov_adm_rmd_ctx decimal(14,0) ,
prov_rebate_tax decimal(14,0) ,
prov_slf_pay_tax decimal(14,0) ,
prov_un_rtx decimal(14,0) ,
apl_prov decimal(14,0) ,
apl_pt_ctx decimal(14,0) ,
apl_sht_pay_tax decimal(14,0) ,
mm_rate decimal(6,4) ,
apl_prov_int decimal(14,0) ,
apl_pybl_prov_tot decimal(14,0) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
tax_cd varchar(2) ,
...
book_no varchar(2) ,
page_no varchar(2) ,
spc_acnt_md varchar(4) ,
gove_priv_tp varchar(1) ,
coll_mk varchar(1) ,
pfs_in_upd_cd varchar(1) ,
pfs_out_upd_cd varchar(1) ,
update_cd varchar(1) ,
apl_prov_pybl_tax decimal(14,0) ,
keyin_date varchar(7) ,
keyin_id_cd varchar(8) ,
in_upd_keyin_date varchar(7) ,
out_upd_keyin_date varchar(7) ,
time_stamp timestamp ,
adm_rmd_int decimal(14,0) ,
tb_flg_mk varchar(1) ,
busi_tel varchar(20) ,
agent_filer_tel varchar(20) ,
agent_filer_nm varchar(40) ,
agent_filer_idn varchar(10) ,
agent_filer_id_tp varchar(1) ,
agent_filer_lic_tp varchar(3) ,
agent_filer_lic_no varchar(7) ,
agent_filer_appr_no varchar(11) ,
agent_inform_track varchar(20) ,
agent_lic_no_mk varchar(2) ,
agent_acc_mk varchar(1) ,
agent_filer_addr varchar(50) ,
agent_filer_date varchar(7) ,
orgn_bkkpr_hsn_nm varchar(6) ,
orgn_bkkpr_no varchar(11) ,
instm_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_peat001_prestage OWNER TO ap_sbd;
