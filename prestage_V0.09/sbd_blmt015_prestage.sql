...
-- Purpose: Prestage資料表;
-- Table: sbd_blmt015_prestage;
-- Compressed: N ;
-- Distributed: Y (mdm_file_nm,f_trf_tms,f_trf_org_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_blmt015_prestage;

CREATE TABLE  prestage.sbd_blmt015_prestage (
data_ym varchar(5) ,
mdm_file_nm varchar(8) ,
flg_mk varchar(1) ,
f_trf_tms varchar(3) ,
data_nums decimal(9,0) ,
empty_file_mk varchar(1) ,
p_s_item_edit_mk varchar(1) ,
tax_rtn_edit_mk varchar(1) ,
f_cnvt_mk varchar(1) ,
flg_id_hsn_cd varchar(1) ,
flg_id_org_cd varchar(2) ,
flg_id_losn varchar(9) ,
f_trf_hsn_cd varchar(1) ,
f_trf_org_cd varchar(2) ,
f_trf_staff_cd varchar(8) ,
f_trf_date varchar(7) ,
f_cnvt_date varchar(7) ,
p_s_item_edit_time varchar(9) ,
tax_rtn_edit_time varchar(9) ,
file_path varchar(100) ,
agent_idn_ban varchar(10) ,
f_trf_date_time varchar(15) ,
cntct_email_addr varchar(30) ,
cntct_date varchar(7) ,
cntct_nm varchar(60) ,
recv_date varchar(7) ,
receiver varchar(60) ,
reply_date varchar(7) ,
guid_mk varchar(1) ,
pur_invo_mk varchar(1) ,
update_cd varchar(1) ,
update_staff_cd varchar(8) ,
update_date_time varchar(15) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (mdm_file_nm,f_trf_tms,f_trf_org_cd)
...
ALTER TABLE  prestage.sbd_blmt015_prestage OWNER TO ap_sbd;
