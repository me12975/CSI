...
DROP TABLE IF EXISTS  prestage.sbd_wiiw007_prestage;

CREATE TABLE  prestage.sbd_wiiw007_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
tax_cd varchar(2) ,
...
ALTER TABLE  prestage.sbd_wiiw007_prestage OWNER TO ap_sbd;
