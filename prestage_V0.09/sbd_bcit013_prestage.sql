...
DROP TABLE IF EXISTS  prestage.sbd_bcit013_prestage;

CREATE TABLE  prestage.sbd_bcit013_prestage (
sel_yr varchar(3) ,
ban varchar(8) ,
apl_date varchar(7) ,
sel_tp varchar(1) ,
...
ALTER TABLE  prestage.sbd_bcit013_prestage OWNER TO ap_sbd;
