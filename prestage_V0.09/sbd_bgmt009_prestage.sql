...
DROP TABLE IF EXISTS  prestage.sbd_bgmt009_prestage;

CREATE TABLE  prestage.sbd_bgmt009_prestage (
bscd_version varchar(5) ,
bscd varchar(6) ,
...
ALTER TABLE  prestage.sbd_bgmt009_prestage OWNER TO ap_sbd;
