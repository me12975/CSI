...
-- Purpose: Prestage資料表;
-- Table: sbd_inct010_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_data_tp,incm_pfn_org_cd,incm_pfn_serial_no,incm_pfn_idn_ban,incmer_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_inct010_prestage;

CREATE TABLE  prestage.sbd_inct010_prestage (
incm_pfn_data_yr varchar(3) ,
incm_pfn_data_tp varchar(2) ,
incm_pfn_org_cd varchar(3) ,
incm_pfn_serial_no varchar(12) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_data_tp,incm_pfn_org_cd,incm_pfn_serial_no,incm_pfn_idn_ban,incmer_idn)
...
ALTER TABLE  prestage.sbd_inct010_prestage OWNER TO ap_sbd;
