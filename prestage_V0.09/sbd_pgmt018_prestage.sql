...
DROP TABLE IF EXISTS  prestage.sbd_pgmt018_prestage;

CREATE TABLE  prestage.sbd_pgmt018_prestage (
data_yr varchar(3) ,
bscd varchar(6) ,
bscd_37_cd varchar(2) ,
bscd_chi_nm varchar(52) ,
lrg_bscd varchar(1) ,
un_anno_bscd_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_pgmt018_prestage OWNER TO ap_sbd;
