...
DROP TABLE IF EXISTS  prestage.sbd_blot007_prestage;

CREATE TABLE  prestage.sbd_blot007_prestage (
key varchar(75) ,
data_ym varchar(5) ,
seller_idn_ban varchar(10) ,
bol_main_no varchar(35) ,
bol_book_noc varchar(35) ,
bill_of_sight_no varchar(14) ,
bill_of_sight_tp varchar(2) ,
upd_tms varchar(2) ,
broker_box varchar(3) ,
broker_agent varchar(5) ,
input_prmt varchar(1) ,
input_prmt_no varchar(4) ,
sprvs_code varchar(8) ,
upd_mk varchar(1) ,
busi_tax_code varchar(1) ,
object_cntry varchar(5) ,
fob decimal(16,2) ,
frgt decimal(16,2) ,
ins decimal(16,2) ,
rcv_form_date varchar(7) ,
pass_date varchar(7) ,
traffic_tp varchar(4) ,
bill_of_sight_cnt decimal(8,0) ,
weight decimal(18,6) ,
red_edge_no varchar(1) ,
ssf varchar(1) ,
exam_code varchar(1) ,
exam_pct varchar(1) ,
sl_hld_cd varchar(1) ,
apl_isu_date varchar(7) ,
need_no_docu varchar(1) ,
proc_tp varchar(2) ,
edit_date varchar(7) ,
edit_mk varchar(1) ,
edit_staff varchar(7) ,
sh_add_exp decimal(16,2) ,
sh_sub_exp decimal(16,2) ,
buyer_idn_ban varchar(14) ,
dstg_mk varchar(1) ,
f_cnvt_mk varchar(1) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
...
gdsv_str_addr varchar(8) ,
pcts_mode varchar(8) ,
app_edit_mode varchar(1) ,
buy_cs_sprvs_no varchar(8) ,
commit_broker_mk varchar(1) ,
export_rmtrl_data varchar(1) ,
bill_of_sight_no_a varchar(14) ,
bill_of_sight_no_b varchar(14) ,
bill_of_sight_no_c varchar(14) ,
bill_of_sight_no_d varchar(14) ,
bill_of_sight_no_e varchar(14) ,
bill_of_sight_no_f varchar(14) ,
bill_of_sight_no_h varchar(14) ,
bill_of_sight_no_i varchar(14) ,
bill_of_sight_no_j varchar(14) ,
vrfctom_no_1 varchar(35) ,
vrfctom_no_2 varchar(35) ,
vrfctom_no_3 varchar(35) ,
oth_flg_item varchar(14) ,
export_business varchar(14) ,
mark varchar(240) ,
container_no varchar(11) ,
oth_flg_item_1 varchar(768) ,
oth_flg_item_2 varchar(768) ,
oth_flg_item_3 varchar(768) ,
goods_mm varchar(2) ,
buyer_eng_nm varchar(80) ,
...
ALTER TABLE  prestage.sbd_blot007_prestage OWNER TO ap_sbd;
