...
-- Purpose: Prestage資料表;
-- Table: sbd_ptit002_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ptit002_prestage;

CREATE TABLE  prestage.sbd_ptit002_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
seq_no varchar(4) ,
hsn_cd varchar(1) ,
...
relation_ban_mk varchar(1) ,
relation_nm varchar(60) ,
invt_percent decimal(5,2) ,
relation_hsn_cd varchar(1) ,
relation_bscd varchar(6) ,
relation_losn varchar(9) ,
relation_orgn_tp varchar(1) ,
relation_resp_idn varchar(10) ,
relation_act_capital decimal(14,0) ,
relation_prs_tot decimal(14,0) ,
relation_s_item_tot decimal(14,0) ,
flg_relation_tp varchar(42) ,
chk_relation_tp varchar(42) ,
force_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_ptit002_prestage OWNER TO ap_sbd;
