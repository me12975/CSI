...
DROP TABLE IF EXISTS  prestage.sbd_ptit008_prestage;

CREATE TABLE  prestage.sbd_ptit008_prestage (
...
ALTER TABLE  prestage.sbd_ptit008_prestage OWNER TO ap_sbd;
