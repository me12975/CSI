...
DROP TABLE IF EXISTS  prestage.sbd_bgmt002_prestage;

CREATE TABLE  prestage.sbd_bgmt002_prestage (
ban varchar(8) ,
hsn_cd varchar(1) ,
exp_grd varchar(1) ,
capitalist_pers decimal(2,0) ,
empl_pers decimal(2,0) ,
ping_num decimal(4,1) ,
hou_rent decimal(14,0) ,
exp_total_amt decimal(14,0) ,
exp_pct1 decimal(3,0) ,
exp_rate1 decimal(2,0) ,
tax_rate1 decimal(2,0) ,
sale_amt1 decimal(14,0) ,
exp_pct2 decimal(3,0) ,
exp_rate2 decimal(2,0) ,
tax_rate2 decimal(2,0) ,
sale_amt2 decimal(14,0) ,
exp_pct3 decimal(3,0) ,
exp_rate3 decimal(2,0) ,
tax_rate3 decimal(2,0) ,
sale_amt3 decimal(14,0) ,
exp_pct4 decimal(3,0) ,
exp_rate4 decimal(2,0) ,
tax_rate4 decimal(2,0) ,
sale_amt4 decimal(14,0) ,
job_tp_tax_rate1 decimal(2,0) ,
job_tp_sale_amt1 decimal(14,0) ,
s_amt_formula1 varchar(200) ,
job_tp_tax_rate2 decimal(2,0) ,
job_tp_sale_amt2 decimal(14,0) ,
s_amt_formula2 varchar(200) ,
job_tp_tax_rate3 decimal(2,0) ,
job_tp_sale_amt3 decimal(14,0) ,
s_amt_formula3 varchar(200) ,
levy_tax_rate1 decimal(2,0) ,
levy_sale_amt1 decimal(14,0) ,
levy_tax_rate2 decimal(2,0) ,
levy_sale_amt2 decimal(14,0) ,
levy_tax_rate3 decimal(2,0) ,
levy_sale_amt3 decimal(14,0) ,
peddler_tp varchar(1) ,
peddler_lic_mk varchar(1) ,
peddler_point decimal(3,0) ,
spc_bscd_mk varchar(1) ,
add_sub_pct decimal(3,0) ,
sale_agrl_percent decimal(3,0) ,
xmp_percent decimal(3,0) ,
collect_date varchar(7) ,
collect_mk varchar(1) ,
appral_s_amt_tot decimal(14,0) ,
apl_busi_tax decimal(14,0) ,
update_id varchar(8) ,
add_sub_pct_1 decimal(3,0) ,
recv_date varchar(7) ,
...
ALTER TABLE  prestage.sbd_bgmt002_prestage OWNER TO ap_sbd;
