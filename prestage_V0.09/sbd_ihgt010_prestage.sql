...
-- Purpose: Prestage資料表;
-- Table: sbd_ihgt010_prestage;
-- Compressed: N ;
-- Distributed: Y (holder_idn,hou_losn);
...
DROP TABLE IF EXISTS  prestage.sbd_ihgt010_prestage;

CREATE TABLE  prestage.sbd_ihgt010_prestage (
...
TABLESPACE sbd 
DISTRIBUTED BY (holder_idn,hou_losn)
...
ALTER TABLE  prestage.sbd_ihgt010_prestage OWNER TO ap_sbd;
