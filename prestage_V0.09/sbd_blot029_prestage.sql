...
DROP TABLE IF EXISTS  prestage.sbd_blot029_prestage;

CREATE TABLE  prestage.sbd_blot029_prestage (
...
seller_co_nm varchar(52) ,
seller_co_addr varchar(80) ,
resp_nm varchar(30) ,
buy_date varchar(7) ,
buy_gd_nm varchar(52) ,
qty decimal(10,0) ,
prc decimal(10,2) ,
t_s_amt decimal(14,0) ,
get_co_idn_ban varchar(10) ,
get_co_nm varchar(52) ,
pfs_recev_no varchar(8) ,
...
ALTER TABLE  prestage.sbd_blot029_prestage OWNER TO ap_sbd;
