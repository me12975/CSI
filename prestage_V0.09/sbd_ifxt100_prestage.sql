...
DROP TABLE IF EXISTS  prestage.sbd_ifxt100_prestage;

CREATE TABLE  prestage.sbd_ifxt100_prestage (
rfn varchar(17) ,
...
ALTER TABLE  prestage.sbd_ifxt100_prestage OWNER TO ap_sbd;
