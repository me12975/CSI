...
-- Purpose: Prestage資料表;
-- Table: sbd_bgmt014_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,orgn_tp,bscd);
...
DROP TABLE IF EXISTS  prestage.sbd_bgmt014_prestage;

CREATE TABLE  prestage.sbd_bgmt014_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
orgn_tp varchar(1) ,
bscd varchar(6) ,
lm_capital decimal(14,0) ,
lm_busi_cnt decimal(14,0) ,
m_open_cnt decimal(14,0) ,
m_open_capital decimal(14,0) ,
m_a_cptl_cnt decimal(14,0) ,
m_a_cptl_capital decimal(14,0) ,
adj_busi_cnt decimal(14,0) ,
adj_capital decimal(14,0) ,
m_s_cptl_cnt decimal(14,0) ,
m_s_cptl_capital decimal(14,0) ,
m_a_stop_cnt decimal(14,0) ,
m_a_stop_capital decimal(14,0) ,
m_s_stop_cnt decimal(14,0) ,
m_s_stop_capital decimal(14,0) ,
m_acu_busi_cnt decimal(14,0) ,
m_invnt_capital decimal(14,0) ,
data_ym varchar(5) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,orgn_tp,bscd)
...
ALTER TABLE  prestage.sbd_bgmt014_prestage OWNER TO ap_sbd;
