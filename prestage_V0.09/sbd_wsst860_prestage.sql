...
-- Purpose: Prestage資料表;
-- Table: sbd_wsst860_prestage;
-- Compressed: N ;
-- Distributed: Y (tax_cd,subtax_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_wsst860_prestage;

CREATE TABLE  prestage.sbd_wsst860_prestage (
tax_cd varchar(2) ,
subtax_cd varchar(1) ,
tax_nm varchar(20) ,
yn_cncl varchar(1) ,
amt_tp varchar(1) ,
colld_assess_tp varchar(1) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (tax_cd,subtax_cd)
...
ALTER TABLE  prestage.sbd_wsst860_prestage OWNER TO ap_sbd;
