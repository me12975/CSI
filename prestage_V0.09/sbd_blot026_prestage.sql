...
DROP TABLE IF EXISTS  prestage.sbd_blot026_prestage;

CREATE TABLE  prestage.sbd_blot026_prestage (
...
buyer_idn_ban varchar(10) ,
buyer_nm varchar(52) ,
buyer_addr varchar(80) ,
gov_org_nm varchar(52) ,
auction_date varchar(7) ,
gd_nm varchar(52) ,
prc decimal(10,2) ,
qty decimal(10,0) ,
...
ALTER TABLE  prestage.sbd_blot026_prestage OWNER TO ap_sbd;
