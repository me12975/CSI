...
DROP TABLE IF EXISTS  prestage.sbd_bcmt109_prestage;

CREATE TABLE  prestage.sbd_bcmt109_prestage (
hsn_cd varchar(1) ,
ban varchar(16) ,
data_tp varchar(1) ,
seq_no varchar(20) ,
...
ALTER TABLE  prestage.sbd_bcmt109_prestage OWNER TO ap_sbd;
