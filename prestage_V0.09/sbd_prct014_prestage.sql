...
DROP TABLE IF EXISTS  prestage.sbd_prct014_prestage;

CREATE TABLE  prestage.sbd_prct014_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
...
acc_rvnu_tot decimal(14,0) ,
acc_sale_incm decimal(14,0) ,
acc_no_sa_gd_in_rv decimal(14,0) ,
acc_prcd_orgn_incm decimal(14,0) ,
acc_exp_tot decimal(14,0) ,
acc_sale_loss decimal(14,0) ,
acc_create_exp decimal(14,0) ,
acc_prcd_orgn_loss decimal(14,0) ,
acc_zsp_net decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_prct014_prestage OWNER TO ap_sbd;
