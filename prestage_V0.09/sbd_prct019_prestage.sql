...
DROP TABLE IF EXISTS  prestage.sbd_prct019_prestage;

CREATE TABLE  prestage.sbd_prct019_prestage (
data_yr varchar(3) ,
flg_mk varchar(1) ,
ban varchar(8) ,
hsn_cd varchar(1) ,
...
recev_no varchar(8) ,
open_date varchar(7) ,
mrg_dism_date varchar(7) ,
resp_idn varchar(10) ,
resp_idn_mk varchar(1) ,
agent_tel_no varchar(20) ,
vat_losn varchar(9) ,
flg_date varchar(7) ,
item1_mk varchar(1) ,
levy_incm decimal(14,0) ,
zsy_abate_incm decimal(14,0) ,
zsy_excl_incm decimal(14,0) ,
ded_apl_loss decimal(14,0) ,
oth_a_item_incm decimal(14,0) ,
npt_adjs_loss decimal(14,0) ,
npt_list_exp_fine decimal(14,0) ,
std_incm_apac_dif decimal(14,0) ,
npfin_apac_dif decimal(14,0) ,
adj_acc_incm_dif decimal(14,0) ,
un_appr_loss decimal(14,0) ,
un_appr_vouch decimal(14,0) ,
zsy_pfs_tax decimal(14,0) ,
ast_cptl_surplus decimal(14,0) ,
loss_unded_amt decimal(14,0) ,
legal_pf_surplus decimal(14,0) ,
spc_pf_surplus decimal(14,0) ,
rpy_fund_resv decimal(14,0) ,
divd_n_amt decimal(14,0) ,
empl_divd decimal(14,0) ,
oth_appr_item decimal(14,0) ,
undist_pf decimal(14,0) ,
udpf_pybl_tax decimal(14,0) ,
upgrd_credit decimal(14,0) ,
dtn_cr_tax decimal(14,0) ,
rbt_stl_ref_amt decimal(14,0) ,
udpf_slfp_tax decimal(14,0) ,
l1y_py_acu_pfls decimal(14,0) ,
py_dist_divd decimal(14,0) ,
acu_pfls_cmpt_samt1 decimal(14,0) ,
py_offset_loss decimal(14,0) ,
acu_pfls_cmpt_aamt1 decimal(14,0) ,
py_acu_pfls decimal(14,0) ,
ly_pfls_num decimal(14,0) ,
ly_dist_divd decimal(14,0) ,
acu_pfls_cmpt_samt2 decimal(14,0) ,
pf_offset_loss_amt decimal(14,0) ,
acu_pfls_cmpt_aamt2 decimal(14,0) ,
ly_acu_pfls decimal(14,0) ,
zsy_acu_pfls decimal(14,0) ,
acu_pfls_pd_e_blnc decimal(14,0) ,
force_mk varchar(1) ,
update_cd varchar(1) ,
keyin_id_cd varchar(8) ,
keyin_date varchar(7) ,
time_stamp timestamp ,
tax_suc_net_pf decimal(14,0) ,
udpf_amt decimal(14,0) ,
blank_item_no3 decimal(14,0) ,
blank_item_no4 decimal(14,0) ,
blank_item_no5 decimal(14,0) ,
next_yr_loss decimal(14,0) ,
blank_item_no15 decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_prct019_prestage OWNER TO ap_sbd;
