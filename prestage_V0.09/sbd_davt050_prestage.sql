...
-- Purpose: Prestage資料表;
-- Table: sbd_davt050_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,town_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_davt050_prestage;

CREATE TABLE  prestage.sbd_davt050_prestage (
stat_ym varchar(5) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
death_pers_cnt decimal(6,0) ,
ntc_flg_cnt decimal(6,0) ,
no_flg_cnt decimal(6,0) ,
unrh_collect_cnt decimal(6,0) ,
flg_cnt decimal(6,0) ,
apl_pybl_cnt decimal(6,0) ,
apl_xmp_cnt decimal(6,0) ,
txl_cattel_tot decimal(12,0) ,
xmp_cattel_tot decimal(12,0) ,
txl_rel_est_tot decimal(12,0) ,
xmp_rel_est_tot decimal(12,0) ,
txl_ded_tot decimal(12,0) ,
xmp_ded_tot decimal(12,0) ,
txl_apl_inher_n_amt decimal(12,0) ,
xmp_apl_inher_n_amt decimal(12,0) ,
apl_tax decimal(12,0) ,
txl_excl_tot decimal(12,0) ,
xmp_excl_tot decimal(12,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,town_cd)
...
ALTER TABLE  prestage.sbd_davt050_prestage OWNER TO ap_sbd;
