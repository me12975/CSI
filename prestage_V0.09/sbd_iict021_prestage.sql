...
DROP TABLE IF EXISTS  prestage.sbd_iict021_prestage;

CREATE TABLE  prestage.sbd_iict021_prestage (
...
incm_tp varchar(2) ,
copies decimal(9) ,
payment_t_amt decimal(14) ,
wh_tax decimal(14) ,
divd_pf_rtx decimal(14) ,
batch_tp varchar(2) ,
err_mk_g varchar(1) ,
err_mk_h varchar(1) ,
err_mk_b varchar(1) ,
...
ALTER TABLE  prestage.sbd_iict021_prestage OWNER TO ap_sbd;
