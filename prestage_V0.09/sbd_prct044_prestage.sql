...
-- Purpose: Prestage資料表;
-- Table: sbd_prct044_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,seq_no,recev_no);
...
DROP TABLE IF EXISTS  prestage.sbd_prct044_prestage;

CREATE TABLE  prestage.sbd_prct044_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
seq_no decimal(14,0) ,
hsn_cd varchar(1) ,
...
flg_mk varchar(1) ,
cd_tp varchar(3) ,
divd_payment decimal(14,0) ,
lp_srcv_amt decimal(14,0) ,
lp_arcv_amt decimal(14,0) ,
zsp_srcv_amt decimal(14,0) ,
zsp_arcv_amt decimal(14,0) ,
oth decimal(14,0) ,
zsp_rvnu_amt decimal(14,0) ,
wh_tax decimal(14,0) ,
refded_tax decimal(14,0) ,
rmk varchar(100) ,
force_mk varchar(1) ,
update_cd varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (ban,seq_no,recev_no)
...
ALTER TABLE  prestage.sbd_prct044_prestage OWNER TO ap_sbd;
