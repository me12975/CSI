...
DROP TABLE IF EXISTS  prestage.sbd_init002_prestage;

CREATE TABLE  prestage.sbd_init002_prestage (
...
ALTER TABLE  prestage.sbd_init002_prestage OWNER TO ap_sbd;
