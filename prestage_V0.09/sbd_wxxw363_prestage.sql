...
-- Purpose: Prestage資料表;
-- Table: sbd_wxxw363_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,tax_cd,subtax_cd,data_no);
...
DROP TABLE IF EXISTS  prestage.sbd_wxxw363_prestage;

CREATE TABLE  prestage.sbd_wxxw363_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
tax_cd varchar(2) ,
...
agt_addr_hsn_nm varchar(3) ,
agt_addr_town_nm varchar(5) ,
agt_addr_vill_nm varchar(5) ,
agt_addr_lin varchar(5) ,
agt_addr_road_no varchar(50) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,tax_cd,subtax_cd,data_no)
...
ALTER TABLE  prestage.sbd_wxxw363_prestage OWNER TO ap_sbd;
