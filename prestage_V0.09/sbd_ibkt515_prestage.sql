...
-- Purpose: Prestage資料表;
-- Table: sbd_ibkt515_prestage;
-- Compressed: N ;
-- Distributed: Y (rfn,idn);
...
DROP TABLE IF EXISTS  prestage.sbd_ibkt515_prestage;

CREATE TABLE  prestage.sbd_ibkt515_prestage (
rfn varchar(17) ,
idn varchar(10) ,
nm varchar(20) ,
born_yy varchar(3) ,
...
ALTER TABLE  prestage.sbd_ibkt515_prestage OWNER TO ap_sbd;
