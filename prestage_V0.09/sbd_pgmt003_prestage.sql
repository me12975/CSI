...
DROP TABLE IF EXISTS  prestage.sbd_pgmt003_prestage;

CREATE TABLE  prestage.sbd_pgmt003_prestage (
data_yr varchar(3) ,
bscd varchar(6) ,
incm_std decimal(2,0) ,
pf_rate_std decimal(2,0) ,
exp_rate_std decimal(2,0) ,
n_rate_std decimal(2,0) ,
...
ALTER TABLE  prestage.sbd_pgmt003_prestage OWNER TO ap_sbd;
