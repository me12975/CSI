...
DROP TABLE IF EXISTS  prestage.sbd_bgmt402_prestage;

CREATE TABLE  prestage.sbd_bgmt402_prestage (
ban varchar(8) ,
ctrled_idn varchar(10) ,
exam_org varchar(30) ,
err_reas_type varchar(1) ,
err_reas_cd varchar(2) ,
err_reas_nm varchar(50) ,
exam_docu_no varchar(80) ,
seq_no varchar(2) ,
...
ALTER TABLE  prestage.sbd_bgmt402_prestage OWNER TO ap_sbd;
