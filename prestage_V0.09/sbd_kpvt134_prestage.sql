...
-- Purpose: Prestage資料表;
-- Table: sbd_kpvt134_prestage;
-- Compressed: N ;
-- Distributed: Y (brk_cd,brk_trade_tp,co_ban);
...
DROP TABLE IF EXISTS  prestage.sbd_kpvt134_prestage;

CREATE TABLE  prestage.sbd_kpvt134_prestage (
brk_cd varchar(4) ,
brk_trade_tp varchar(1) ,
co_ban varchar(8) ,
brk_nm varchar(30) ,
hsn_cd varchar(1) ,
...
source_update_cd varchar(1) ,
mvout_date varchar(7) ,
update_cd varchar(1) ,
tel_no varchar(12) ,
tel_ext_no varchar(6) ,
bonus_dist_ban varchar(8) ,
bonus_dist_mk varchar(1) ,
acct_no varchar(16) ,
bank_cd varchar(7) ,
dealer_mk varchar(1) ,
broker_mk varchar(1) ,
underwr_mk varchar(1) ,
act_capital decimal(14,0) ,
update_memo varchar(30) ,
addr_hsn_cd varchar(1) ,
addr_town_cd varchar(2) ,
addr_vill_cd varchar(2) ,
addr_hsn_nm varchar(3) ,
addr_town_nm varchar(5) ,
addr_vill_nm varchar(5) ,
addr_lin varchar(5) ,
addr_road_no varchar(80) ,
open_date varchar(7) ,
zip_cd varchar(5) ,
resp_idn varchar(10) ,
resp_nm varchar(30) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (brk_cd,brk_trade_tp,co_ban)
...
ALTER TABLE  prestage.sbd_kpvt134_prestage OWNER TO ap_sbd;
