...
-- Purpose: Prestage資料表;
-- Table: sbd_pact074_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,list_no,xmp_incm_item);
...
DROP TABLE IF EXISTS  prestage.sbd_pact074_prestage;

CREATE TABLE  prestage.sbd_pact074_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
recev_no varchar(8) ,
list_no varchar(2) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
xmp_incm_item varchar(2) ,
rvnu decimal(14,0) ,
cost_exp decimal(14,0) ,
incm decimal(14,0) ,
ovrse_busi_nm varchar(60) ,
ovrse_busi_cntry varchar(30) ,
rvnu_amt decimal(14,0) ,
ctrt_date varchar(7) ,
ctrt_prd_b_date varchar(7) ,
ctrt_prd_e_date varchar(7) ,
roy_serv_item_rd varchar(50) ,
ptnt_item varchar(50) ,
appr_cntry_law_rfrc varchar(50) ,
auth_use_area varchar(10) ,
auth_use_area_txl varchar(10) ,
auth_use_area_xmp varchar(10) ,
divd_dist_dscpl varchar(7) ,
dist_stk_volume decimal(14,0) ,
stk_dist_amt decimal(14,1) ,
tot_amt decimal(14,1) ,
update_cd varchar(1) ,
force_mk varchar(1) ,
apl_date varchar(7) ,
adt_id_cd varchar(5) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (ban,list_no,xmp_incm_item)
...
ALTER TABLE  prestage.sbd_pact074_prestage OWNER TO ap_sbd;
