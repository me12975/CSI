...
DROP TABLE IF EXISTS  prestage.sbd_init005_prestage;

CREATE TABLE  prestage.sbd_init005_prestage (
...
prof_bl varchar(2) ,
prof_tp varchar(2) ,
flg_rvnu decimal(14,0) ,
flg_exp decimal(14,0) ,
flg_incm decimal(14,0) ,
acc_cd varchar(1) ,
verify_cd varchar(1) ,
agree_mark varchar(1) ,
vicar_idn_ban varchar(10) ,
vicar_idn varchar(10) ,
vicar_nm varchar(20) ,
vicar_firm_nm varchar(52) ,
vicar_tel varchar(15) ,
commit_acc_date_b varchar(7) ,
commit_acc_date_e varchar(7) ,
em_rwrd_amt decimal(14,0) ,
rwrd_amt_tot decimal(14,0) ,
sel_case_mk varchar(1) ,
create_date varchar(7) ,
org_cd varchar(3) ,
user_id_cd varchar(8) ,
update_date_time varchar(13) ,
next_yr_sel_case_mk varchar(1) ,
lic_no varchar(80) ,
serial_no varchar(8) ,
incm_prd_b varchar(7) ,
incm_prd_e varchar(7) ,
flg_mode varchar(1) ,
...
ALTER TABLE  prestage.sbd_init005_prestage OWNER TO ap_sbd;
