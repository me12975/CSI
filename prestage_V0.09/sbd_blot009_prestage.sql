...
DROP TABLE IF EXISTS  prestage.sbd_blot009_prestage;

CREATE TABLE  prestage.sbd_blot009_prestage (
data_ym varchar(5) ,
ban varchar(8) ,
...
ALTER TABLE  prestage.sbd_blot009_prestage OWNER TO ap_sbd;
