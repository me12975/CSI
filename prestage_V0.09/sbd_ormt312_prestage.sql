...
-- Purpose: Prestage資料表;
-- Table: sbd_ormt312_prestage;
-- Compressed: N ;
-- Distributed: Y (data_key,factory_no,prod_key);
...
DROP TABLE IF EXISTS  prestage.sbd_ormt312_prestage;

CREATE TABLE  prestage.sbd_ormt312_prestage (
bl_yy varchar(3) ,
bl_mm varchar(2) ,
data_key decimal(13,0) ,
factory_no varchar(5) ,
prod_key decimal(19,0) ,
prod_no varchar(10) ,
dup_seq_no varchar(1) ,
book_no varchar(1) ,
page_no varchar(2) ,
item_no varchar(3) ,
out_f_txl_qty decimal(14,3) ,
unit_cstm_val decimal(14,3) ,
tax_rate decimal(9,5) ,
pybl_tax decimal(11,1) ,
rebate_tax decimal(10,0) ,
act_paid_tax decimal(10,0) ,
pay_date varchar(7) ,
update_cd varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (data_key,factory_no,prod_key)
...
ALTER TABLE  prestage.sbd_ormt312_prestage OWNER TO ap_sbd;
