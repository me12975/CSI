...
-- Purpose: Prestage資料表;
-- Table: sbd_fpvt101_prestage;
-- Compressed: N ;
-- Distributed: Y (tax_tp,stk_tp,expire_start_date,tax_rate);
...
DROP TABLE IF EXISTS  prestage.sbd_fpvt101_prestage;

CREATE TABLE  prestage.sbd_fpvt101_prestage (
tax_tp varchar(1) ,
stk_tp varchar(1) ,
expire_start_date varchar(7) ,
tax_rate decimal(13,7) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (tax_tp,stk_tp,expire_start_date,tax_rate)
...
ALTER TABLE  prestage.sbd_fpvt101_prestage OWNER TO ap_sbd;
