...
DROP TABLE IF EXISTS  prestage.sbd_bddt002_prestage;

CREATE TABLE  prestage.sbd_bddt002_prestage (
bl_yr varchar(3) ,
ban varchar(8) ,
hsn_cd varchar(1) ,
losn varchar(9) ,
bscd varchar(6) ,
txl_flg_s_amt1 decimal(14,0) ,
txl_mrg_s_amt1 decimal(14,0) ,
ztx_mrg_s_amt1 decimal(14,0) ,
xmp_flg_s_amt1 decimal(14,0) ,
xmp_mrg_s_amt1 decimal(14,0) ,
txl_flg_s_amt2 decimal(14,0) ,
txl_mrg_s_amt2 decimal(14,0) ,
ztx_flg_s_amt2 decimal(14,0) ,
ztx_mrg_s_amt2 decimal(14,0) ,
xmp_flg_s_amt2 decimal(14,0) ,
xmp_mrg_s_amt2 decimal(14,0) ,
ztx_flg_s_amt3 decimal(14,0) ,
txl_flg_s_amt4 decimal(14,0) ,
txl_mrg_s_amt4 decimal(14,0) ,
ztx_flg_s_amt4 decimal(14,0) ,
xmp_flg_s_amt4 decimal(14,0) ,
xmp_mrg_s_amt4 decimal(14,0) ,
txl_flg_s_amt5 decimal(14,0) ,
ztx_flg_s_amt5 decimal(14,0) ,
xmp_flg_s_amt5 decimal(14,0) ,
pe_amt1 decimal(14,0) ,
fa_amt1 decimal(14,0) ,
pe_amt2 decimal(14,0) ,
fa_amt2 decimal(14,0) ,
pe_amt3 decimal(14,0) ,
fa_amt3 decimal(14,0) ,
pe_amt4 decimal(14,0) ,
fa_amt4 decimal(14,0) ,
pe_fa_mrg_s_amt decimal(14,0) ,
sp_s_amt_tot decimal(14,0) ,
flg_s_amt1 decimal(14,0) ,
flg_s_amt2 decimal(14,0) ,
flg_s_amt3 decimal(14,0) ,
flg_s_amt4 decimal(14,0) ,
mrg_sale_amt decimal(14,0) ,
flg_s_amt5 decimal(14,0) ,
flg_s_amt6 decimal(14,0) ,
acu_lp_im_amt decimal(14,0) ,
acu_zsp_im_amt decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_bddt002_prestage OWNER TO ap_sbd;
