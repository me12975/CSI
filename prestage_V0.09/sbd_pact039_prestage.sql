...
-- Purpose: Prestage資料表;
-- Table: sbd_pact039_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,tax_rtn_kd,abate_clause,recev_no);
...
DROP TABLE IF EXISTS  prestage.sbd_pact039_prestage;

CREATE TABLE  prestage.sbd_pact039_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
...
abate_tax decimal(14,0) ,
are_acoll_tax decimal(14,0) ,
force_mk varchar(1) ,
apl_date varchar(7) ,
adt_id_cd varchar(5) ,
update_cd varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (ban,tax_rtn_kd,abate_clause,recev_no)
...
ALTER TABLE  prestage.sbd_pact039_prestage OWNER TO ap_sbd;
