...
-- Purpose: Prestage資料表;
-- Table: sbd_crmh110_prestage;
-- Compressed: N ;
-- Distributed: Y (data_key);
...
DROP TABLE IF EXISTS  prestage.sbd_crmh110_prestage;

CREATE TABLE  prestage.sbd_crmh110_prestage (
data_key decimal(13,0) ,
factory_no varchar(3) ,
update_date_time varchar(15) ,
tob_lq_tp varchar(2) ,
tax_rgst_hsn_cd varchar(1) ,
tax_rgst_org_cd varchar(3) ,
head_ban varchar(8) ,
ban varchar(8) ,
factory_nm varchar(52) ,
addr_hsn_nm varchar(6) ,
addr_town_nm varchar(8) ,
addr_vill_nm varchar(8) ,
addr_lin varchar(8) ,
addr_road_no varchar(50) ,
tel_area_no varchar(13) ,
resp_nm varchar(30) ,
resp_idn varchar(10) ,
idn_mk varchar(1) ,
resp_addr_hsn_nm varchar(6) ,
resp_addr_town_nm varchar(8) ,
resp_addr_vill_nm varchar(8) ,
resp_addr_lin varchar(8) ,
resp_addr_road_no varchar(50) ,
born_date varchar(7) ,
orgn_tp varchar(1) ,
capital decimal(10,0) ,
estab_f_date varchar(7) ,
prmt_no varchar(15) ,
estab_f_docu_no varchar(10) ,
delete_date varchar(7) ,
delete_docu_no varchar(10) ,
stop_b_date varchar(7) ,
stop_e_date varchar(7) ,
app_date varchar(7) ,
appr_estab_docu_no varchar(10) ,
...
hdrp_nm varchar(30) ,
hdrp_born_date varchar(7) ,
hdrp_idn varchar(10) ,
hdrp_idn_mk varchar(1) ,
hdrp_addr_hsn_nm varchar(6) ,
hdrp_addr_town_nm varchar(8) ,
hdrp_addr_vill_nm varchar(8) ,
hdrp_addr_lin varchar(8) ,
hdrp_addr_road_no varchar(50) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (data_key)
...
ALTER TABLE  prestage.sbd_crmh110_prestage OWNER TO ap_sbd;
