...
-- Purpose: Prestage資料表;
-- Table: sbd_bimt001_prestage;
-- Compressed: N ;
-- Distributed: Y (invo_tp,invo_track);
...
DROP TABLE IF EXISTS  prestage.sbd_bimt001_prestage;

CREATE TABLE  prestage.sbd_bimt001_prestage (
invo_ym varchar(5) ,
invo_tp varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (invo_tp,invo_track)
...
ALTER TABLE  prestage.sbd_bimt001_prestage OWNER TO ap_sbd;
