...
-- Purpose: Prestage資料表;
-- Table: sbd_tact052_prestage;
-- Compressed: N ;
-- Distributed: Y (report_cd,ba_tax_fine_tp,tax_seq_no,case_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_tact052_prestage;

CREATE TABLE  prestage.sbd_tact052_prestage (
report_cd varchar(8) ,
data_ym varchar(5) ,
ba_tax_fine_tp varchar(1) ,
tax_seq_no varchar(2) ,
case_tp varchar(1) ,
tax_cd varchar(2) ,
cnt1 decimal(6,0) ,
cnt2 decimal(6,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (report_cd,ba_tax_fine_tp,tax_seq_no,case_tp)
...
ALTER TABLE  prestage.sbd_tact052_prestage OWNER TO ap_sbd;
