...
-- Purpose: Prestage資料表;
-- Table: sbd_wsst850_prestage;
-- Compressed: N ;
-- Distributed: Y (tax_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_wsst850_prestage;

CREATE TABLE  prestage.sbd_wsst850_prestage (
tax_cd varchar(2) ,
tax_nm varchar(20) ,
tax_shnm varchar(3) ,
...
ALTER TABLE  prestage.sbd_wsst850_prestage OWNER TO ap_sbd;
