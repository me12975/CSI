...
DROP TABLE IF EXISTS  prestage.sbd_plmt218_prestage;

CREATE TABLE  prestage.sbd_plmt218_prestage (
head_ban varchar(8) ,
...
ALTER TABLE  prestage.sbd_plmt218_prestage OWNER TO ap_sbd;
