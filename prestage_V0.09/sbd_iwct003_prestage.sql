...
DROP TABLE IF EXISTS  prestage.sbd_iwct003_prestage;

CREATE TABLE  prestage.sbd_iwct003_prestage (
incm_pfn_data_yr varchar(3) ,
incm_pfn_data_tp varchar(2) ,
incm_pfn_org_cd varchar(3) ,
incm_pfn_serial_no varchar(8) ,
...
wh_tax decimal(14,0) ,
payment_n_amt decimal(14,0) ,
tp_cd varchar(2) ,
tax_wh_rate decimal(4,2) ,
hou_losn varchar(12) ,
dist_tms decimal(2,0) ,
sh_wh_tax decimal(14,0) ,
divd_pf_rtx decimal(14,0) ,
n_incm_pfn varchar(26) ,
iit_wh_nvp_mk varchar(1) ,
saving_ded_mk varchar(1) ,
err_mk_i varchar(1) ,
err_mk_b varchar(1) ,
re_chk_mk varchar(1) ,
reply_mk varchar(1) ,
nm_get_houhld_mk varchar(1) ,
idn_nm_conf_mk varchar(1) ,
htcmp_mk varchar(1) ,
page_tms varchar(6) ,
upd_mk varchar(1) ,
user_id_cd varchar(8) ,
update_date_time varchar(13) ,
mdm_flg_mk varchar(1) ,
rent_tax_agrmt varchar(2) ,
return_chk_tp varchar(1) ,
death_mk varchar(1) ,
death_date varchar(7) ,
death_nm varchar(20) ,
death_idn varchar(10) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
flg_yy varchar(3) ,
...
user_id_id varchar(8) ,
empl_divd_fv decimal(14,0) ,
empl_divd_stk_volume decimal(14,0) ,
empl_divd_exec_date varchar(7) ,
empl_divd_time_prc decimal(17,3) ,
empl_divd_base_tax decimal(14,0) ,
slfp_lbr_pnsn decimal(14,0) ,
cntry_code varchar(2) ,
isu_co_tot_amt decimal(14,0) ,
isu_co_wh_tax decimal(14,0) ,
isu_co_ban varchar(10) ,
dr_idn varchar(10) ,
dr_nm varchar(20) ,
incm_format_cd_sub varchar(2) ,
incm_mk_sub varchar(1) ,
alien_resd_days varchar(1) ,
cr_pt_credit_wh_tax decimal(14,0) ,
err_mk_h varchar(1) ,
no_rsdt_pay_date varchar(7) ,
err_mk_w varchar(1) ,
cash_divd decimal(14,0) ,
stk_divd decimal(14,0) ,
stk_divd_volume decimal(14,0) ,
err_mk_y varchar(1) ,
err_mk_z varchar(1) ,
...
ALTER TABLE  prestage.sbd_iwct003_prestage OWNER TO ap_sbd;
