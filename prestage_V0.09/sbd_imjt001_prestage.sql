...
-- Purpose: Prestage資料表;
-- Table: sbd_imjt001_prestage;
-- Compressed: N ;
-- Distributed: Y (rcpt_no,ban_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_imjt001_prestage;

CREATE TABLE  prestage.sbd_imjt001_prestage (
remit_tp varchar(1) ,
currency_tp varchar(3) ,
resp_bank_cd varchar(4) ,
trade_yy varchar(3) ,
trade_mm varchar(2) ,
trade_dd varchar(2) ,
rcpt_no varchar(12) ,
ban_idn varchar(10) ,
rcpt_tp varchar(1) ,
o_currency_amt decimal(17,3) ,
remit_clsf_no varchar(3) ,
remit_mode varchar(1) ,
ovrse_remit_cntry varchar(2) ,
dmst_remit_id varchar(1) ,
remit_rate decimal(9,8) ,
exch_usd_amt decimal(17,3) ,
ovrse_id_nm varchar(40) ,
ovrse_bank_nm varchar(105) ,
ovrse_account_no varchar(20) ,
org_cd varchar(3) ,
bureau_cd varchar(1) ,
update_date_time varchar(13) ,
remit_clsf_dtl varchar(1) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (rcpt_no,ban_idn)
...
ALTER TABLE  prestage.sbd_imjt001_prestage OWNER TO ap_sbd;
