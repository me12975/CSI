...
DROP TABLE IF EXISTS  prestage.sbd_jvpt002_prestage;

CREATE TABLE  prestage.sbd_jvpt002_prestage (
...
team_tp varchar(2) ,
empl_cd varchar(5) ,
asg_resp_unit varchar(1) ,
onto_data_cd1 varchar(3) ,
onto_data_cd2 varchar(3) ,
asg_case_wt decimal(2,1) ,
asg_turn_tms decimal(4,0) ,
asg_cmpt_wt decimal(2,1) ,
apl_tp varchar(1) ,
re_chk_tms decimal(2,0) ,
extend_tms decimal(2,0) ,
dcd_lvl varchar(2) ,
yn_violate varchar(1) ,
asg_date varchar(7) ,
extend_date varchar(7) ,
sh_fnsh_date varchar(7) ,
finish_date varchar(7) ,
apl_amt1 decimal(14,0) ,
apl_amt2 decimal(14,0) ,
apl_amt3 decimal(14,0) ,
apl_amt4 decimal(14,0) ,
apl_amt5 decimal(14,0) ,
apl_amt6 decimal(14,0) ,
apl_amt7 decimal(14,0) ,
apl_amt8 decimal(14,0) ,
apl_amt9 decimal(14,0) ,
apl_amt10 decimal(14,0) ,
apl_amt11 decimal(14,0) ,
apl_amt12 decimal(14,0) ,
apl_amt13 decimal(14,0) ,
apl_amt14 decimal(14,0) ,
apl_amt15 decimal(14,0) ,
adj_mk varchar(1) ,
time_stamp timestamp ,
update_id_cd varchar(5) ,
update_date varchar(7) ,
o_asg_date varchar(7) ,
o_sh_fnsh_date varchar(7) ,
ntf_pnk_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_jvpt002_prestage OWNER TO ap_sbd;
