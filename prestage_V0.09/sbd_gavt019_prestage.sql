...
DROP TABLE IF EXISTS  prestage.sbd_gavt019_prestage;

CREATE TABLE  prestage.sbd_gavt019_prestage (
suit_start_date varchar(7) ,
suit_cutoff_date varchar(7) ,
grd_tp varchar(2) ,
n_amt_b_range decimal(10,0) ,
n_amt_e_range decimal(11,0) ,
...
ALTER TABLE  prestage.sbd_gavt019_prestage OWNER TO ap_sbd;
