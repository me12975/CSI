...
DROP TABLE IF EXISTS  prestage.sbd_prct077_prestage;

CREATE TABLE  prestage.sbd_prct077_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
recev_no varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
acc_sps_exp decimal(14,0) ,
sps_exp decimal(14,0) ,
acc_slry_exp decimal(14,0) ,
slry_exp decimal(14,0) ,
acc_rent_exp decimal(14,0) ,
rent_exp decimal(14,0) ,
acc_stnry_fee decimal(14,0) ,
stnry_fee decimal(14,0) ,
acc_trvl_fee decimal(14,0) ,
trvl_fee decimal(14,0) ,
acc_frgt decimal(14,0) ,
frgt decimal(14,0) ,
acc_post_tel_fee decimal(14,0) ,
post_tel_fee decimal(14,0) ,
acc_rpa_exp decimal(14,0) ,
rpa_exp decimal(14,0) ,
acc_water_ele_fee decimal(14,0) ,
water_ele_fee decimal(14,0) ,
acc_ins decimal(14,0) ,
ins decimal(14,0) ,
acc_social_fee decimal(14,0) ,
social_fee decimal(14,0) ,
acc_tax_amt decimal(14,0) ,
tax_amt decimal(14,0) ,
acc_depr_amt decimal(14,0) ,
depr_amt decimal(14,0) ,
acc_depl_apn decimal(14,0) ,
depl_apn decimal(14,0) ,
acc_meals_fee decimal(14,0) ,
meals_fee decimal(14,0) ,
acc_empl_ben decimal(14,0) ,
empl_ben decimal(14,0) ,
acc_roy decimal(14,0) ,
roy decimal(14,0) ,
acc_srv_fee decimal(14,0) ,
srv_fee decimal(14,0) ,
acc_trng_fee decimal(14,0) ,
trng_fee decimal(14,0) ,
acc_oth_resh_fee decimal(14,0) ,
oth_resh_fee decimal(14,0) ,
acc_voucr_elmt decimal(14,0) ,
voucr_elmt decimal(14,0) ,
acc_rd_exp_tot decimal(14,0) ,
rd_exp_tot decimal(14,0) ,
force_mk varchar(1) ,
update_cd varchar(1) ,
...
ALTER TABLE  prestage.sbd_prct077_prestage OWNER TO ap_sbd;
