...
-- Purpose: Prestage資料表;
-- Table: sbd_crmt312_prestage;
-- Compressed: N ;
-- Distributed: Y (data_key,factory_no,tob_lq_prod_key,tob_lq_prod_no);
...
DROP TABLE IF EXISTS  prestage.sbd_crmt312_prestage;

CREATE TABLE  prestage.sbd_crmt312_prestage (
bl_yy varchar(3) ,
bl_mm varchar(2) ,
data_key decimal(13,0) ,
factory_no varchar(3) ,
tob_lq_prod_key decimal(19,0) ,
tob_lq_prod_no varchar(12) ,
tax_rgst_hsn_cd varchar(1) ,
tax_rgst_org_cd varchar(3) ,
book_no varchar(1) ,
page_no varchar(2) ,
item_no varchar(3) ,
out_f_txl_qty decimal(14,3) ,
appr_tax decimal(7,2) ,
pybl_tax decimal(15,1) ,
pybl_dnte decimal(15,1) ,
rebate_tax decimal(11,1) ,
rbt_dnte decimal(11,1) ,
act_paid_tax decimal(14,0) ,
act_pay_dnte decimal(14,0) ,
pay_date varchar(7) ,
update_cd varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (data_key,factory_no,tob_lq_prod_key,tob_lq_prod_no)
...
ALTER TABLE  prestage.sbd_crmt312_prestage OWNER TO ap_sbd;
