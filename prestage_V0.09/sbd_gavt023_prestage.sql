...
DROP TABLE IF EXISTS  prestage.sbd_gavt023_prestage;

CREATE TABLE  prestage.sbd_gavt023_prestage (
...
gft_case_no varchar(14) ,
giver_idn varchar(10) ,
flg_date varchar(7) ,
pybl_ba_tax decimal(10,0) ,
...
asg_key varchar(25) ,
ntrs_amt decimal(10,0) ,
htrs_amt decimal(10,0) ,
...
ALTER TABLE  prestage.sbd_gavt023_prestage OWNER TO ap_sbd;
