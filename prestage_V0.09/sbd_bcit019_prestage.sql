...
-- Purpose: Prestage資料表;
-- Table: sbd_bcit019_prestage;
-- Compressed: N ;
-- Distributed: Y (data_ym);
...
DROP TABLE IF EXISTS  prestage.sbd_bcit019_prestage;

CREATE TABLE  prestage.sbd_bcit019_prestage (
data_ym varchar(5) ,
sh_chk_cnt decimal(6,0) ,
sh_chk_suple_tax decimal(12,0) ,
chk_cnt decimal(6,0) ,
chk_suple_tax decimal(12,0) ,
chk_rslt_cnt0 decimal(6,0) ,
chk_rslt_cnt1 decimal(6,0) ,
chk_rslt_tax1 decimal(12,0) ,
chk_rslt_cnt2 decimal(6,0) ,
chk_rslt_tax2 decimal(12,0) ,
chk_rslt_cnt3 decimal(6,0) ,
chk_rslt_tax3 decimal(12,0) ,
chk_rslt_cnt4 decimal(6,0) ,
chk_rslt_tax4 decimal(12,0) ,
chk_rslt_cnt5 decimal(6,0) ,
chk_rslt_tax5 decimal(12,0) ,
chk_rslt_cnt6 decimal(6,0) ,
chk_rslt_tax6 decimal(12,0) ,
chk_rslt_cnt7 decimal(6,0) ,
time_stamp timestamp ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
chk_rslt_cnt8 decimal(6,0) ,
ntf_cs_suple_tax decimal(12,0) ,
chk_rslt_tax8 decimal(12,0) ,
no_vat_sh_chk_cnt decimal(6,0) ,
chk_rslt_cnt12 decimal(6,0) ,
...
ALTER TABLE  prestage.sbd_bcit019_prestage OWNER TO ap_sbd;
