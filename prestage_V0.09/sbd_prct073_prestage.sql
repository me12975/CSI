...
DROP TABLE IF EXISTS  prestage.sbd_prct073_prestage;

CREATE TABLE  prestage.sbd_prct073_prestage (
cntry_code varchar(2) ,
cntry_eng_nm varchar(100) ,
cntry_chi_nm varchar(50) ,
...
ALTER TABLE  prestage.sbd_prct073_prestage OWNER TO ap_sbd;
