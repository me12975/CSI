...
DROP TABLE IF EXISTS  prestage.sbd_prct103_prestage;

CREATE TABLE  prestage.sbd_prct103_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
recev_no varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
gov_mk varchar(2) ,
wlfr_orgn_mk varchar(1) ,
no_oth_dist_mk varchar(1) ,
excss_bl_mk varchar(1) ,
no_lmt_mk varchar(1) ,
no_lmt_item varchar(1) ,
mof_appr_date varchar(7) ,
mof_fileno varchar(40) ,
no_busi_mk varchar(1) ,
ben_vouch_mk varchar(1) ,
main_num_mk varchar(1) ,
busi_relation_mk varchar(1) ,
relate_exp_mk varchar(1) ,
gene_act_exp decimal(14) ,
gene_orgn_loss decimal(14) ,
gene_relate_rvnu decimal(14) ,
geme_extra_incm decimal(14) ,
gene_orgn_incm decimal(14) ,
gene_org_ratio decimal(5,2) ,
prvt_s_exp decimal(14) ,
prvt_orgn_loss decimal(14) ,
prvt_s_rvnu decimal(14) ,
prvt_orgn_incm decimal(14) ,
prvt_exp_ratio decimal(5,2) ,
nq_rgl_mk varchar(1) ,
nq_appr_date varchar(7) ,
nq_fileno varchar(60) ,
vrfctom_num decimal(2) ,
hold_vouch_mk varchar(1) ,
commit_agent_mk varchar(1) ,
reg_prop_tot decimal(14) ,
flg_rvnu_tot decimal(14) ,
sale_goods_amt decimal(14) ,
sale_goods_ext_amt decimal(14) ,
sale_gdsv_mk varchar(1) ,
exist_orgn_mk varchar(1) ,
prcss_flg_mk varchar(1) ,
prvt_plan_mk varchar(1) ,
prvt_appr_date varchar(7) ,
prvt_fileno varchar(60) ,
sub_plan_mk varchar(1) ,
force_mk varchar(1) ,
update_cd varchar(1) ,
keyin_id_cd varchar(8) ,
keyin_date varchar(7) ,
time_stamp timestamp ,
rgl_no_prgh varchar(1) ,
...
ALTER TABLE  prestage.sbd_prct103_prestage OWNER TO ap_sbd;
