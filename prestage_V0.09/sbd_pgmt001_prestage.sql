...
DROP TABLE IF EXISTS  prestage.sbd_pgmt001_prestage;

CREATE TABLE  prestage.sbd_pgmt001_prestage (
ban varchar(8) ,
docu_no varchar(10) ,
app_no varchar(15) ,
appr_date varchar(7) ,
...
delete_docu_no varchar(15) ,
o_spc_acnt_md varchar(4) ,
...
ALTER TABLE  prestage.sbd_pgmt001_prestage OWNER TO ap_sbd;
