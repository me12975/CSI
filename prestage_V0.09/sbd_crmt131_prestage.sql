...
-- Purpose: Prestage資料表;
-- Table: sbd_crmt131_prestage;
-- Compressed: N ;
-- Distributed: Y (class_key);
...
DROP TABLE IF EXISTS  prestage.sbd_crmt131_prestage;

CREATE TABLE  prestage.sbd_crmt131_prestage (
class_key decimal(13,0) ,
tob_lq_main_tp varchar(1) ,
tob_lq_tp varchar(2) ,
taxable_unit_nm varchar(3) ,
unit_tax decimal(6,1) ,
expire_start_date varchar(7) ,
expire_cutoff_date varchar(7) ,
tob_hlth_ben_dnte decimal(5,0) ,
alch_b_cncn decimal(5,2) ,
alch_e_cncn decimal(5,2) ,
cncn_cal_tax_tp varchar(1) ,
...
ALTER TABLE  prestage.sbd_crmt131_prestage OWNER TO ap_sbd;
