...
-- Purpose: Prestage資料表;
-- Table: sbd_ipat030_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,databag_case_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ipat030_prestage;

CREATE TABLE  prestage.sbd_ipat030_prestage (
incm_pfn_data_yr varchar(3) ,
incm_pfn_org_cd varchar(3) ,
incm_pfn_idn_ban varchar(10) ,
incm_pfn_seq_no varchar(1) ,
databag_case_no varchar(12) ,
chk_tms varchar(2) ,
prof_bl varchar(2) ,
prof_tp varchar(2) ,
apl_tp varchar(1) ,
apl_rvnu decimal(14) ,
apl_exp_mk varchar(1) ,
apl_exp decimal(14) ,
apl_incm decimal(14) ,
wh_tax decimal(14) ,
mrg_rvnu decimal(14) ,
drct_apl_exp decimal(14) ,
audit_reas_cd varchar(1) ,
cnvt_chk_date varchar(7) ,
cnvt_ntf_date varchar(7) ,
f_asg_date varchar(7) ,
dlv_outj_unit varchar(3) ,
dlv_outj_date varchar(7) ,
ntf_mk varchar(1) ,
sel_case_mk varchar(1) ,
drct_apl_mk varchar(1) ,
rvnu_mrg_data_mk varchar(1) ,
verify_data_mk varchar(1) ,
visit_data_mk varchar(1) ,
pfls_data_mk varchar(1) ,
incm_apl_cd varchar(1) ,
data_ntf_mk1 varchar(1) ,
data_ntf_copy1 decimal(2) ,
data_ntf_mk2 varchar(1) ,
data_ntf_copy2 decimal(2) ,
data_ntf_mk3 varchar(1) ,
data_ntf_copy3 decimal(2) ,
data_ntf_mk4 varchar(1) ,
data_ntf_copy4 decimal(2) ,
create_acnt1 decimal(2) ,
create_acnt2 decimal(2) ,
create_acnt3 decimal(2) ,
acnt_kd4 varchar(20) ,
create_acnt4 decimal(2) ,
acnt_kd5 varchar(20) ,
create_acnt5 decimal(2) ,
...
apl_rvnu_mk varchar(1) ,
mnl_drct_apl_mk varchar(1) ,
rvnu_flg_amt decimal(14) ,
exp_flg_amt decimal(14) ,
asg_spc_stat_tp varchar(2) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,databag_case_no)
...
ALTER TABLE  prestage.sbd_ipat030_prestage OWNER TO ap_sbd;
