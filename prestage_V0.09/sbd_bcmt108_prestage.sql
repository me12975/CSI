...
-- Purpose: Prestage資料表;
-- Table: sbd_bcmt108_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,data_tp,seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_bcmt108_prestage;

CREATE TABLE  prestage.sbd_bcmt108_prestage (
hsn_cd varchar(1) ,
ban varchar(19) ,
data_tp varchar(4) ,
seq_no varchar(20) ,
pstn_ttl_cd varchar(25) ,
chi_nm varchar(100) ,
idn varchar(36) ,
amt_hold_stk decimal(15,0) ,
stkh_duty_kd varchar(2) ,
zip_cd varchar(120) ,
addr varchar(240) ,
resp_mk varchar(2) ,
director_no_b varchar(20) ,
director_no_e varchar(20) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (ban,data_tp,seq_no)
...
ALTER TABLE  prestage.sbd_bcmt108_prestage OWNER TO ap_sbd;
