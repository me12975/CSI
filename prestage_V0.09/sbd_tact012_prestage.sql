...
-- Purpose: Prestage資料表;
-- Table: sbd_tact012_prestage;
-- Compressed: N ;
-- Distributed: Y (rvw_item_tax_tp,rvw_item_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_tact012_prestage;

CREATE TABLE  prestage.sbd_tact012_prestage (
rvw_item_tax_tp varchar(1) ,
rvw_item_cd varchar(4) ,
rvw_item_nm varchar(52) ,
item_tp varchar(1) ,
data_tp varchar(1) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (rvw_item_tax_tp,rvw_item_cd)
...
ALTER TABLE  prestage.sbd_tact012_prestage OWNER TO ap_sbd;
