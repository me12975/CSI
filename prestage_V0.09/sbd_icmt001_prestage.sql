...
-- Purpose: Prestage資料表;
-- Table: sbd_icmt001_prestage;
-- Compressed: N ;
-- Distributed: Y (data_yr);
...
DROP TABLE IF EXISTS  prestage.sbd_icmt001_prestage;

CREATE TABLE  prestage.sbd_icmt001_prestage (
data_yr varchar(3) ,
sngl_std_ded decimal(14,0) ,
cpl_std_ded decimal(14,0) ,
xmp_a_70_amt decimal(14,0) ,
xmp_b_70_amt decimal(14,0) ,
incm_ded_max decimal(14,0) ,
saving_ded_max decimal(14,0) ,
disab_ded_max decimal(14,0) ,
tuition_ded_max decimal(14,0) ,
nover_dnt_ded decimal(3,0) ,
ins_fee_max decimal(14,0) ,
hou_rent_max decimal(14,0) ,
hou_loan_ded_max decimal(14,0) ,
cnd_dnt_flg_max decimal(14,0) ,
ppt_dnt_lmt_pct decimal(3,0) ,
dnt_ppt_tot decimal(14,0) ,
prvt_s_dnt_lmt_pct decimal(3,0) ,
invt_ctx_lmt_pct decimal(3,0) ,
rent_esstl_exp_pct decimal(3,0) ,
written_ded decimal(14,0) ,
evade_incm_amt decimal(14,0) ,
evade_incm_tax decimal(14,0) ,
mlm_coll_amt decimal(14,0) ,
incm_base_ded decimal(14,0) ,
incm_base_tax_rate decimal(2,0) ,
child_edu_o_ded_max decimal(14,0) ,
base_death_ins_xmp decimal(14,0) ,
base_live_exp decimal(14,0) ,
lse_esstl_exp_pct decimal(3,0) ,
divd_crd_pct decimal(3,1) ,
divd_crd_max decimal(14,0) ,
divd_pybl_pct decimal(3,0) ,
ltc_ded_max decimal(14,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (data_yr)
...
ALTER TABLE  prestage.sbd_icmt001_prestage OWNER TO ap_sbd;
