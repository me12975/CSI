...
-- Purpose: Prestage資料表;
-- Table: sbd_crmt710_prestage;
-- Compressed: N ;
-- Distributed: Y (manage_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_crmt710_prestage;

CREATE TABLE  prestage.sbd_crmt710_prestage (
...
o_apl_tax decimal(14,0) ,
o_apl_dnte decimal(14,0) ,
o_dlfg_amt decimal(10,0) ,
o_ncfg_amt decimal(10,0) ,
o_add_cal_int decimal(10,0) ,
paid_amt decimal(14,0) ,
paid_dnte decimal(14,0) ,
update_cd varchar(1) ,
...
ALTER TABLE  prestage.sbd_crmt710_prestage OWNER TO ap_sbd;
