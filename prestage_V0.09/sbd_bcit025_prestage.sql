...
DROP TABLE IF EXISTS  prestage.sbd_bcit025_prestage;

CREATE TABLE  prestage.sbd_bcit025_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
...
sup_pay_s_tax decimal(12,0) ,
ztx_s_amt1 decimal(14,0) ,
sup_pay_tax1 decimal(12,0) ,
apl_suple_tax2 decimal(12,0) ,
evd2 decimal(12,0) ,
bhv2 decimal(12,0) ,
ztx_s_amt2 decimal(14,0) ,
ztx_s_tax decimal(12,0) ,
apl_suple_tax3 decimal(12,0) ,
evd3 decimal(12,0) ,
bhv3 decimal(12,0) ,
chk_rslt_mk4 varchar(1) ,
export_goods_nm varchar(20) ,
artc1 varchar(80) ,
artc2 varchar(80) ,
artc3 varchar(80) ,
app varchar(80) ,
...
ALTER TABLE  prestage.sbd_bcit025_prestage OWNER TO ap_sbd;
