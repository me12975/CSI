...
-- Purpose: Prestage資料表;
-- Table: sbd_waat410_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,clat_vouch_no,data_seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_waat410_prestage;

CREATE TABLE  prestage.sbd_waat410_prestage (
hsn_cd varchar(1) ,
fiscal_yr varchar(3) ,
clat_vouch_no varchar(5) ,
data_seq_no decimal(10,0) ,
dr_g_ldgr_no varchar(3) ,
cr_g_ldgr_no varchar(3) ,
data_b_date varchar(7) ,
data_e_date varchar(7) ,
vou_cnt decimal(8,0) ,
vou_amt decimal(13,0) ,
tax_amt_dstg varchar(2) ,
data_tp varchar(2) ,
vou_format_cd varchar(1) ,
trs_cd varchar(7) ,
tax_amt_acct_no varchar(6) ,
out_hsn_org_cd varchar(3) ,
tax_subtax_cd varchar(3) ,
gove_priv_tp varchar(1) ,
prod_tp varchar(2) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
this_prev_yr varchar(1) ,
trs_tp varchar(1) ,
clat_s_ldgr_no varchar(6) ,
aptrs_add_sub_mk varchar(1) ,
data_bl_yr varchar(3) ,
clat_data_dstg varchar(3) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,clat_vouch_no,data_seq_no)
...
ALTER TABLE  prestage.sbd_waat410_prestage OWNER TO ap_sbd;
