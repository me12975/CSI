...
DROP TABLE IF EXISTS  prestage.sbd_prct016_prestage;

CREATE TABLE  prestage.sbd_prct016_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
sale_goods_rvnu decimal(14,0) ,
sale_srv_rvnu decimal(14,0) ,
lse_rvnu decimal(14,0) ,
comsn_rvnu decimal(14,0) ,
sale_ast_amt decimal(14,0) ,
sale_scts_rvnu decimal(14,0) ,
sale_lnd_rvnu decimal(14,0) ,
invn_pf decimal(14,0) ,
exch_pf decimal(14,0) ,
oth_rvnu decimal(14,0) ,
sale_gdsv_rvnt decimal(14,0) ,
force_mk varchar(1) ,
update_cd varchar(1) ,
keyin_id_cd varchar(8) ,
keyin_date varchar(7) ,
time_stamp timestamp ,
acc_sale_good_rvnu decimal(14,0) ,
acc_sale_srv_rvnu decimal(14,0) ,
acc_stl_lse_rvnu decimal(14,0) ,
acc_stl_comsn_rvnu decimal(14,0) ,
acc_sale_ast_amt decimal(14,0) ,
acc_sale_scts_rvnu decimal(14,0) ,
acc_sale_lnd_rvnu decimal(14,0) ,
acc_stl_invn_pf decimal(14,0) ,
acc_stl_exch_pf decimal(14,0) ,
acc_stl_oth_rvnu decimal(14,0) ,
acc_sale_gdsv_rvnt decimal(14,0) ,
recev_no varchar(8) ,
diff_reason varchar(200) ,
mod_sale_gdsv_rvnu decimal(14,0) ,
mod_vat_sale_amt decimal(14,0) ,
mod_diff decimal(14,0) ,
mod_cary_fw_arcv decimal(14,0) ,
mod_srcv_un_invo decimal(14,0) ,
mod_rvnu_add_oth decimal(14,0) ,
mod_rvnu_add_oth_expl varchar(30) ,
...
mod_trst_estab_invo_amt decimal(14,0) ,
mod_rvnu_sub_oth decimal(14,0) ,
mod_rvnu_sub_oth_expl varchar(30) ,
...
ALTER TABLE  prestage.sbd_prct016_prestage OWNER TO ap_sbd;
