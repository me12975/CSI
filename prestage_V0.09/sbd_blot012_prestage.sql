...
-- Purpose: Prestage資料表;
-- Table: sbd_blot012_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,recev_bill_inst_cd,mrcht_cd,tms);
...
DROP TABLE IF EXISTS  prestage.sbd_blot012_prestage;

CREATE TABLE  prestage.sbd_blot012_prestage (
data_yr varchar(3) ,
ban varchar(10) ,
recev_bill_inst_cd varchar(3) ,
mrcht_cd varchar(15) ,
tms varchar(1) ,
fhy_dtl_cnt decimal(8,0) ,
shy_dtl_cnt decimal(8,0) ,
jan_amt decimal(14,0) ,
feb_amt decimal(14,0) ,
mar_amt decimal(14,0) ,
apr_amt decimal(14,0) ,
may_amt decimal(14,0) ,
jun_amt decimal(14,0) ,
jul_amt decimal(14,0) ,
aug_amt decimal(14,0) ,
sep_amt decimal(14,0) ,
oct_amt decimal(14,0) ,
nov_amt decimal(14,0) ,
dec_amt decimal(14,0) ,
amt_tot decimal(14,0) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (ban,recev_bill_inst_cd,mrcht_cd,tms)
...
ALTER TABLE  prestage.sbd_blot012_prestage OWNER TO ap_sbd;
