...
-- Purpose: Prestage資料表;
-- Table: sbd_bcmt002_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd,case_source,data_kd,serial_no);
...
DROP TABLE IF EXISTS  prestage.sbd_bcmt002_prestage;

CREATE TABLE  prestage.sbd_bcmt002_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
out_form_ym varchar(5) ,
...
use_invo_yr varchar(3) ,
use_invo_mth varchar(2) ,
sign_date varchar(7) ,
correct_data varchar(7) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd,case_source,data_kd,serial_no)
...
ALTER TABLE  prestage.sbd_bcmt002_prestage OWNER TO ap_sbd;
