...
-- Purpose: Prestage資料表;
-- Table: sbd_bcit006_prestage;
-- Compressed: N ;
-- Distributed: Y (sel_case_yr);
...
DROP TABLE IF EXISTS  prestage.sbd_bcit006_prestage;

CREATE TABLE  prestage.sbd_bcit006_prestage (
sel_case_yr varchar(3) ,
busi_cnt_scr decimal(2,0) ,
cnt_scr1 decimal(2,0) ,
tax_scr1 decimal(2,0) ,
cnt_scr2 decimal(2,0) ,
tax_scr2 decimal(2,0) ,
cnt_scr3 decimal(2,0) ,
tax_scr3 decimal(2,0) ,
cnt_scr4 decimal(2,0) ,
tax_scr4 decimal(2,0) ,
cnt_scr5 decimal(2,0) ,
tax_scr5 decimal(2,0) ,
cnt_scr6 decimal(2,0) ,
tax_scr6 decimal(2,0) ,
cnt_scr7 decimal(2,0) ,
tax_scr7 decimal(2,0) ,
cnt_scr8 decimal(2,0) ,
tax_scr8 decimal(2,0) ,
chk_pct1 decimal(3,0) ,
chk_pct2 decimal(3,0) ,
chk_pct3 decimal(3,0) ,
chk_pct4 decimal(3,0) ,
chk_pct5 decimal(3,0) ,
chk_pct6 decimal(3,0) ,
chk_pct7 decimal(3,0) ,
chk_pct8 decimal(3,0) ,
chk_pct9 decimal(3,0) ,
chk_pct10 decimal(3,0) ,
chk_pct11 decimal(3,0) ,
chk_pct12 decimal(3,0) ,
time_stamp timestamp ,
ec_scr8 decimal(3,2) ,
chk_b_date varchar(7) ,
chk_e_date varchar(7) ,
suple_tax_scr decimal(2,0) ,
cnt_scr9 decimal(2,1) ,
tax_scr9 decimal(2,1) ,
tax_scr10 decimal(2,1) ,
cnt_scr12 decimal(2,1) ,
tax_scr12 decimal(2,1) ,
ec_scr12 decimal(3,2) ,
upd_stus char(1) ,
...
ALTER TABLE  prestage.sbd_bcit006_prestage OWNER TO ap_sbd;
