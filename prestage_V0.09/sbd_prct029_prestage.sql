...
DROP TABLE IF EXISTS  prestage.sbd_prct029_prestage;

CREATE TABLE  prestage.sbd_prct029_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
...
ALTER TABLE  prestage.sbd_prct029_prestage OWNER TO ap_sbd;
