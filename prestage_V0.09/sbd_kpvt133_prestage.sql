...
DROP TABLE IF EXISTS  prestage.sbd_kpvt133_prestage;

CREATE TABLE  prestage.sbd_kpvt133_prestage (
pfn varchar(13) ,
source_tp varchar(1) ,
adt_fsh_mk varchar(1) ,
asg_upd_tms varchar(2) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
manage_cd varchar(24) ,
case_tp varchar(3) ,
apl_tax decimal(12,0) ,
dly_pay_amt decimal(12,0) ,
evade_stt_tax decimal(12,0) ,
...
apl_date varchar(7) ,
apl_user_id_cd varchar(8) ,
f_cnvt_mk1 varchar(1) ,
f_cnvt_mk2 varchar(1) ,
f_cnvt_mk3 varchar(1) ,
f_cnvt_mk4 varchar(1) ,
adt_cd varchar(5) ,
upd_tp varchar(1) ,
update_date varchar(7) ,
update_cd varchar(1) ,
update_user_cd varchar(8) ,
sup_pay_date varchar(7) ,
sup_pay_tax decimal(12,0) ,
sup_dly_pay_amt decimal(12,0) ,
time_stamp timestamp ,
r_apl_memo varchar(80) ,
...
ALTER TABLE  prestage.sbd_kpvt133_prestage OWNER TO ap_sbd;
