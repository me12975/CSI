...
-- Purpose: Prestage資料表;
-- Table: sbd_wxmt500_prestage;
-- Compressed: N ;
-- Distributed: Y (stat_data_tp,org_cd,tax_cd,unpaid_stat_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_wxmt500_prestage;

CREATE TABLE  prestage.sbd_wxmt500_prestage (
data_ym varchar(5) ,
stat_data_tp varchar(1) ,
org_cd varchar(3) ,
tax_cd varchar(2) ,
unpaid_stat_tp varchar(2) ,
py_m_cnt decimal(8,0) ,
py_m_amt decimal(12,0) ,
py_m_fine decimal(12,0) ,
py_acu_cnt decimal(8,0) ,
py_acu_amt decimal(12,0) ,
py_acu_fine decimal(12,0) ,
zsy_m_cnt decimal(8,0) ,
zsy_m_amt decimal(12,0) ,
zsy_m_fine decimal(12,0) ,
zsy_acu_cnt decimal(8,0) ,
zsy_acu_amt decimal(12,0) ,
zsy_acu_fine decimal(12,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (stat_data_tp,org_cd,tax_cd,unpaid_stat_tp)
...
ALTER TABLE  prestage.sbd_wxmt500_prestage OWNER TO ap_sbd;
