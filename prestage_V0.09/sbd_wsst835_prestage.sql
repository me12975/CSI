...
-- Purpose: Prestage資料表;
-- Table: sbd_wsst835_prestage;
-- Compressed: N ;
-- Distributed: Y (hsn_cd,dst_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_wsst835_prestage;

CREATE TABLE  prestage.sbd_wsst835_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
dst_nm varchar(8) ,
yn_ntax_brch varchar(1) ,
dlv_org_cd varchar(6) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hsn_cd,dst_cd)
...
ALTER TABLE  prestage.sbd_wsst835_prestage OWNER TO ap_sbd;
