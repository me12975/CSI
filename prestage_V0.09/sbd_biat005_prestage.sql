...
DROP TABLE IF EXISTS  prestage.sbd_biat005_prestage;

CREATE TABLE  prestage.sbd_biat005_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
chk_yy varchar(3) ,
chk_mm varchar(2) ,
...
ALTER TABLE  prestage.sbd_biat005_prestage OWNER TO ap_sbd;
