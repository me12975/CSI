...
-- Purpose: Prestage資料表;
-- Table: sbd_jvpt088_prestage;
-- Compressed: N ;
-- Distributed: Y (asg_org_cd,sctn_cd,scttm_cd,asg_busi_tp,d_goal_item_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_jvpt088_prestage;

CREATE TABLE  prestage.sbd_jvpt088_prestage (
d_goal_yr varchar(3) ,
...
goal_cnt decimal(5,0) ,
goal_amt decimal(14,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (asg_org_cd,sctn_cd,scttm_cd,asg_busi_tp,d_goal_item_cd)
...
ALTER TABLE  prestage.sbd_jvpt088_prestage OWNER TO ap_sbd;
