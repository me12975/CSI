...
-- Purpose: Prestage資料表;
-- Table: sbd_icmt002_prestage;
-- Compressed: N ;
-- Distributed: Y (data_yr,incm_n_b_range,incm_n_e_range);
...
DROP TABLE IF EXISTS  prestage.sbd_icmt002_prestage;

CREATE TABLE  prestage.sbd_icmt002_prestage (
data_yr varchar(3) ,
incm_n_b_range decimal(14,0) ,
incm_n_e_range decimal(14,0) ,
incm_net_range_tp varchar(1) ,
tax_rate decimal(3,0) ,
prg_dif decimal(14,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (data_yr,incm_n_b_range,incm_n_e_range)
...
ALTER TABLE  prestage.sbd_icmt002_prestage OWNER TO ap_sbd;
