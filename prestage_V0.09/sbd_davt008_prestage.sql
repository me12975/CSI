...
-- Purpose: Prestage資料表;
-- Table: sbd_davt008_prestage;
-- Compressed: N ;
-- Distributed: Y (aphd_mk,serial_no,prop_serial_no);
...
DROP TABLE IF EXISTS  prestage.sbd_davt008_prestage;

CREATE TABLE  prestage.sbd_davt008_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
flg_yy varchar(3) ,
...
prop_flg_stus_cd varchar(1) ,
prop_mk varchar(1) ,
prop_cd varchar(2) ,
oth_prop_nm varchar(60) ,
qty decimal(12,0) ,
oth_tot_amt decimal(12,0) ,
lnd_hsn_cd varchar(1) ,
lnd_mark varchar(15) ,
land_nm varchar(1) ,
lump_lnd_area decimal(11,2) ,
anno_pr_val decimal(9,0) ,
shr_nmrt decimal(10,0) ,
shr_dnt decimal(10,0) ,
lnd_tot_amt decimal(12,0) ,
farm_mk varchar(1) ,
ded_mk varchar(1) ,
lnd_sec_nm varchar(60) ,
lnd_losn varchar(12) ,
unpaid_mk varchar(1) ,
inq_un_cutoff_date varchar(7) ,
time_stamp timestamp ,
cvll10301_mk varchar(1) ,
get_date varchar(7) ,
get_reas varchar(1) ,
paid_mk varchar(1) ,
lt_inher_date varchar(7) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (aphd_mk,serial_no,prop_serial_no)
...
ALTER TABLE  prestage.sbd_davt008_prestage OWNER TO ap_sbd;
