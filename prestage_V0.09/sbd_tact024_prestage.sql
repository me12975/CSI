...
-- Purpose: Prestage資料表;
-- Table: sbd_tact024_prestage;
-- Compressed: N ;
-- Distributed: Y (tax_tp,ba_tax_fine_mk,serial_no,cstp_stus_tms,cstp_stus_tp,cstp_stus_rapl,cstp_stus_rchk,cstp_stus_aply_mk,prcd_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_tact024_prestage;

CREATE TABLE  prestage.sbd_tact024_prestage (
tax_tp varchar(1) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
app_yy varchar(2) ,
...
docu_no varchar(55) ,
o_prcd_cntnt varchar(50) ,
rec_cntnt varchar(200) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (tax_tp,ba_tax_fine_mk,serial_no,cstp_stus_tms,cstp_stus_tp,cstp_stus_rapl,cstp_stus_rchk,cstp_stus_aply_mk,prcd_cd)
...
ALTER TABLE  prestage.sbd_tact024_prestage OWNER TO ap_sbd;
