...
-- Purpose: Prestage資料表;
-- Table: sbd_jvpt006_prestage;
-- Compressed: N ;
-- Distributed: Y (ntf_no,bl_org_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_jvpt006_prestage;

CREATE TABLE  prestage.sbd_jvpt006_prestage (
ntf_no varchar(27) ,
rfn varchar(17) ,
incm_data_str_addr varchar(26) ,
case_qlty varchar(1) ,
idn_ban varchar(10) ,
idn varchar(10) ,
tpr_nm varchar(26) ,
...
data_tp varchar(2) ,
incm_kd varchar(2) ,
incm_source varchar(24) ,
proc_unit varchar(7) ,
reply_source_unit varchar(7) ,
out_source_unit varchar(7) ,
creat_mark varchar(1) ,
o_ntf_no varchar(27) ,
...
ALTER TABLE  prestage.sbd_jvpt006_prestage OWNER TO ap_sbd;
