...
-- Purpose: Prestage資料表;
-- Table: sbd_init004_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,inves_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_init004_prestage;

CREATE TABLE  prestage.sbd_init004_prestage (
...
inves_tp varchar(2) ,
asg_date varchar(7) ,
asg_reas_cd varchar(1) ,
inves_date varchar(7) ,
inves_empl_cd1 varchar(8) ,
inves_empl_cd2 varchar(8) ,
inves_mode varchar(1) ,
zst_inves_rvnu decimal(14,0) ,
reg_fee_unit_prc decimal(14,0) ,
acc_stus varchar(1) ,
...
relation_class varchar(50) ,
remark varchar(30) ,
no_rcv_reg_fee_amt decimal(14,0) ,
urgt_reg_fee_unit_prc decimal(14,0) ,
inq_b_ym varchar(5) ,
inq_e_ym varchar(5) ,
ntf_amt decimal(14,0) ,
prof_tp1 varchar(2) ,
prof_tp2 varchar(2) ,
zst_flg_rvnu decimal(14,0) ,
zst_flg_rvnu1 decimal(14,0) ,
zst_flg_rvnu2 decimal(14,0) ,
serial_no varchar(8) ,
cllt_adja_rvnu decimal(14,0) ,
cllt_adja_rvnu1 decimal(14,0) ,
cllt_adja_rvnu2 decimal(14,0) ,
zst_inves_rvnu1 decimal(14,0) ,
zst_inves_rvnu2 decimal(14,0) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_org_cd,incm_pfn_idn_ban,incm_pfn_seq_no,inves_tp)
...
ALTER TABLE  prestage.sbd_init004_prestage OWNER TO ap_sbd;
