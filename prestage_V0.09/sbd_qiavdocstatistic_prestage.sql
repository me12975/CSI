...
-- Purpose: Prestage資料表;
-- Table: sbd_qiavdocstatistic_prestage;
-- Compressed: N ;
-- Distributed: Y (ds_orgeid,ds_chargedp,ds_attrcode);
...
DROP TABLE IF EXISTS  prestage.sbd_qiavdocstatistic_prestage;

CREATE TABLE  prestage.sbd_qiavdocstatistic_prestage (
ds_orgeid varchar(17) ,
ds_year varchar(3) ,
ds_month varchar(2) ,
ds_chargedp varchar(14) ,
ds_attrcode varchar(1) ,
ds_newdoc decimal(6,0) ,
ds_unclose decimal(6,0) ,
ds_credoc decimal(6,0) ,
ds_senddoc decimal(6,0) ,
ds_inthree decimal(6,0) ,
ds_insix decimal(6,0) ,
ds_in1to6 decimal(6,0) ,
ds_infifth decimal(6,0) ,
ds_inmon decimal(6,0) ,
ds_sixmon decimal(6,0) ,
ds_inover decimal(6,0) ,
ds_sendday decimal(8,2) ,
ds_average_day decimal(8,2) ,
ds_save decimal(6,0) ,
ds_ready decimal(6,0) ,
ds_spinct decimal(6,0) ,
ds_spotct decimal(6,0) ,
ds_cancel decimal(6,0) ,
ds_lssenddy decimal(8,2) ,
ds_lssenddoc decimal(6,0) ,
ds_inready decimal(6,0) ,
ds_overready decimal(6,0) ,
ds_oinfive decimal(6,0) ,
ds_ointen decimal(6,0) ,
ds_oinfif decimal(6,0) ,
ds_ooverfif decimal(6,0) ,
ds_in3mon decimal(6,0) ,
ds_in5mon decimal(6,0) ,
ds_over3mon decimal(6,0) ,
ds_over5mon decimal(6,0) ,
ds_mergdoc decimal(6,0) ,
ds_upd_deptid varchar(7) ,
ds_upd_deptnm varchar(200) ,
ds_upd_userid varchar(20) ,
ds_upd_usernm varchar(200) ,
ds_upd_date varchar(7) ,
ds_upd_time varchar(8) ,
ds_upd_status varchar(1) ,
ds_chargepe varchar(40) ,
ds_apply_ce varchar(1) ,
ds_apply_yn varchar(1) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (ds_orgeid,ds_chargedp,ds_attrcode)
...
ALTER TABLE  prestage.sbd_qiavdocstatistic_prestage OWNER TO ap_sbd;
