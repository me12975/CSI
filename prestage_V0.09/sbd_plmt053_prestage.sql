...
-- Purpose: Prestage資料表;
-- Table: sbd_plmt053_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,chg_tms);
...
DROP TABLE IF EXISTS  prestage.sbd_plmt053_prestage;

CREATE TABLE  prestage.sbd_plmt053_prestage (
hppn_yr varchar(3) ,
ban varchar(8) ,
chg_tms decimal(2) ,
use_yr varchar(3) ,
last_yr varchar(3) ,
acu_trace_yr varchar(3) ,
org_nm varchar(52) ,
on_t_flg_mk varchar(1) ,
chg_use_plan_mk varchar(1) ,
appr_date varchar(7) ,
appr_no varchar(30) ,
rdc_docu_no varchar(30) ,
ntf_date varchar(7) ,
ntf_docu_no varchar(24) ,
ntfd_unit_cd varchar(3) ,
ntfd_unit_nm varchar(20) ,
tran_flg_mk varchar(1) ,
offset_py_loss_mk varchar(1) ,
resv_aft_yr_use_mk varchar(1) ,
buy_depr_ast_mk varchar(1) ,
zst_tran_tot_amt decimal(14) ,
chg_reg_date varchar(7) ,
aft_tran_tot_amt decimal(14) ,
offset_py_loss_amt decimal(14) ,
resv_afty_amt decimal(14) ,
resv_afty_empl_amt decimal(14) ,
rvrs_ctrl varchar(1) ,
plan_use_mk1 varchar(1) ,
suple_tax decimal(14) ,
remark varchar(100) ,
update_cd varchar(1) ,
...
ALTER TABLE  prestage.sbd_plmt053_prestage OWNER TO ap_sbd;
