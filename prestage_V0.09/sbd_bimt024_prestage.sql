...
-- Purpose: Prestage資料表;
-- Table: sbd_bimt024_prestage;
-- Compressed: N ;
-- Distributed: Y (void_invo_pfn);
...
DROP TABLE IF EXISTS  prestage.sbd_bimt024_prestage;

CREATE TABLE  prestage.sbd_bimt024_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
void_invo_pfn varchar(10) ,
data_bl_ym varchar(5) ,
invo_ym varchar(5) ,
invo_tp varchar(1) ,
void_cd varchar(1) ,
sale_unit_hsn_cd varchar(1) ,
...
ALTER TABLE  prestage.sbd_bimt024_prestage OWNER TO ap_sbd;
