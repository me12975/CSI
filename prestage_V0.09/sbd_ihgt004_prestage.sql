...
-- Purpose: Prestage資料表;
-- Table: sbd_ihgt004_prestage;
-- Compressed: N ;
-- Distributed: Y (cpfn_org_cd,cpfn_serial_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ihgt004_prestage;

CREATE TABLE  prestage.sbd_ihgt004_prestage (
cpfn_org_cd varchar(3) ,
cpfn_data_yr varchar(3) ,
cpfn_serial_no varchar(7) ,
holder_idn varchar(10) ,
hou_losn varchar(12) ,
holder_nm varchar(20) ,
holder_addr varchar(80) ,
shr_nmrt decimal(10,0) ,
shr_dnt decimal(10,0) ,
hou_loc varchar(80) ,
renter_idn varchar(10) ,
renter_nm varchar(20) ,
rent decimal(14,0) ,
morg_amt decimal(14,0) ,
rent_payment_mode varchar(1) ,
pds decimal(3,0) ,
rent_b_date varchar(7) ,
rent_e_date varchar(7) ,
del_morg_date varchar(7) ,
cmpt_mk varchar(1) ,
force_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_ihgt004_prestage OWNER TO ap_sbd;
