...
DROP TABLE IF EXISTS  prestage.sbd_gavt006_prestage;

CREATE TABLE  prestage.sbd_gavt006_prestage (
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
flg_yy varchar(3) ,
...
ALTER TABLE  prestage.sbd_gavt006_prestage OWNER TO ap_sbd;
