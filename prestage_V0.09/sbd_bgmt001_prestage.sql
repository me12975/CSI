...
DROP TABLE IF EXISTS  prestage.sbd_bgmt001_prestage;

CREATE TABLE  prestage.sbd_bgmt001_prestage (
ban varchar(8) ,
vat_losn varchar(9) ,
ban_nm varchar(52) ,
resp_idn varchar(10) ,
...
ALTER TABLE  prestage.sbd_bgmt001_prestage OWNER TO ap_sbd;
