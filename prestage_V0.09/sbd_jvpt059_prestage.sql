...
-- Purpose: Prestage資料表;
-- Table: sbd_jvpt059_prestage;
-- Compressed: N ;
-- Distributed: Y (asg_busi_tp,report_cd,asg_org_cd,sctn_cd,scttm_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_jvpt059_prestage;

CREATE TABLE  prestage.sbd_jvpt059_prestage (
...
field8 decimal(14,0) ,
field9 decimal(14,0) ,
field10 decimal(14,0) ,
field11 decimal(14,0) ,
field12 decimal(14,0) ,
field13 decimal(14,0) ,
field14 decimal(14,0) ,
field15 decimal(14,0) ,
field16 decimal(14,0) ,
field17 decimal(14,0) ,
field18 decimal(14,0) ,
field19 decimal(14,0) ,
field20 decimal(14,0) ,
field21 decimal(14,0) ,
field22 decimal(14,0) ,
field23 decimal(14,0) ,
field24 decimal(14,0) ,
field25 decimal(14,0) ,
field26 decimal(14,0) ,
field27 decimal(14,0) ,
field28 decimal(14,0) ,
field29 decimal(14,0) ,
field30 decimal(14,0) ,
field31 decimal(14,0) ,
field32 decimal(14,0) ,
field33 decimal(14,0) ,
field34 decimal(14,0) ,
field35 decimal(14,0) ,
field36 decimal(14,0) ,
field37 decimal(14,0) ,
field38 decimal(14,0) ,
field39 decimal(14,0) ,
field40 decimal(14,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (asg_busi_tp,report_cd,asg_org_cd,sctn_cd,scttm_cd)
...
ALTER TABLE  prestage.sbd_jvpt059_prestage OWNER TO ap_sbd;
