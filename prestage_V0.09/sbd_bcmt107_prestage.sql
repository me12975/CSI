...
DROP TABLE IF EXISTS  prestage.sbd_bcmt107_prestage;

CREATE TABLE  prestage.sbd_bcmt107_prestage (
hsn_cd varchar(1) ,
ban varchar(32) ,
seq_no varchar(20) ,
busi_item_no varchar(10) ,
busi_item_nm varchar(500) ,
...
ALTER TABLE  prestage.sbd_bcmt107_prestage OWNER TO ap_sbd;
