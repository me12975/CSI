...
DROP TABLE IF EXISTS  prestage.sbd_bcit035_prestage;

CREATE TABLE  prestage.sbd_bcit035_prestage (
data_ym varchar(5) ,
...
apl_busi_tax decimal(12,0) ,
adj_assess_s_amt decimal(14,0) ,
sh_guid_busi_cnt decimal(6,0) ,
...
ALTER TABLE  prestage.sbd_bcit035_prestage OWNER TO ap_sbd;
