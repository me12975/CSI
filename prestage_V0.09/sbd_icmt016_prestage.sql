...
-- Purpose: Prestage資料表;
-- Table: sbd_icmt016_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_data_tp,incm_format_cd,incm_tp,incm_mk,trst_mk);
...
DROP TABLE IF EXISTS  prestage.sbd_icmt016_prestage;

CREATE TABLE  prestage.sbd_icmt016_prestage (
data_yr varchar(3) ,
incm_data_tp varchar(2) ,
incm_format_cd varchar(2) ,
incm_tp varchar(1) ,
incm_mk varchar(1) ,
trst_mk varchar(1) ,
incm_tp_expl varchar(200) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (incm_data_tp,incm_format_cd,incm_tp,incm_mk,trst_mk)
...
ALTER TABLE  prestage.sbd_icmt016_prestage OWNER TO ap_sbd;
