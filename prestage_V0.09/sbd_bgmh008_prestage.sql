...
DROP TABLE IF EXISTS  prestage.sbd_bgmh008_prestage;

CREATE TABLE  prestage.sbd_bgmh008_prestage (
ban varchar(8) ,
...
ALTER TABLE  prestage.sbd_bgmh008_prestage OWNER TO ap_sbd;
