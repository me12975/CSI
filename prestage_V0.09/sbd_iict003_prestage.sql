...
-- Purpose: Prestage資料表;
-- Table: sbd_iict003_prestage;
-- Compressed: N ;
-- Distributed: Y (incm_pfn_data_tp,incm_pfn_org,incm_pfn_serial_no,idn_ban_tp,dist_tms);
...
DROP TABLE IF EXISTS  prestage.sbd_iict003_prestage;

CREATE TABLE  prestage.sbd_iict003_prestage (
incm_pfn_data_yr varchar(3) ,
incm_pfn_data_tp varchar(1) ,
incm_pfn_hsn_cd varchar(1) ,
incm_pfn_org varchar(2) ,
incm_pfn_serial_no varchar(6) ,
idn_ban_tp varchar(1) ,
...
incm_mk varchar(1) ,
copies decimal(9) ,
divd_n_amt decimal(14) ,
tax_credit_ded_rate decimal(4,2) ,
pt_crd decimal(14) ,
batch_tp varchar(2) ,
err_mk_b varchar(1) ,
err_mk_n varchar(1) ,
...
flag_mk varchar(1) ,
scts_tran_mk varchar(1) ,
supfile_date varchar(7) ,
no_pt_crd_cash_divd decimal(14) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (incm_pfn_data_tp,incm_pfn_org,incm_pfn_serial_no,idn_ban_tp,dist_tms)
...
ALTER TABLE  prestage.sbd_iict003_prestage OWNER TO ap_sbd;
