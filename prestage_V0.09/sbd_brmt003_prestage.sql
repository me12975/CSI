...
DROP TABLE IF EXISTS  prestage.sbd_brmt003_prestage;

CREATE TABLE  prestage.sbd_brmt003_prestage (
bl_yr varchar(3) ,
bl_mm varchar(2) ,
ban varchar(8) ,
unfile_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_brmt003_prestage OWNER TO ap_sbd;
