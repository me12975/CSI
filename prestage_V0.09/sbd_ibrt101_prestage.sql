...
DROP TABLE IF EXISTS  prestage.sbd_ibrt101_prestage;

CREATE TABLE  prestage.sbd_ibrt101_prestage (
idn varchar(10) ,
nm varchar(20) ,
born_date varchar(7) ,
hsn_cd varchar(1) ,
...
ALTER TABLE  prestage.sbd_ibrt101_prestage OWNER TO ap_sbd;
