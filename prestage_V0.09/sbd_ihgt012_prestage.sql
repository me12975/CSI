...
-- Purpose: Prestage資料表;
-- Table: sbd_ihgt012_prestage;
-- Compressed: N ;
-- Distributed: Y (hou_losn,floor);
...
DROP TABLE IF EXISTS  prestage.sbd_ihgt012_prestage;

CREATE TABLE  prestage.sbd_ihgt012_prestage (
hou_losn varchar(12) ,
floor varchar(3) ,
tot_floor varchar(3) ,
busi_area decimal(6,1) ,
resd_area decimal(6,1) ,
nrb_area decimal(6,1) ,
struc_cd varchar(1) ,
hou_use_tp varchar(1) ,
hou_use_dtl_tp varchar(2) ,
hou_slvy_ym varchar(5) ,
hou_depr_year varchar(2) ,
hou_build_tp varchar(1) ,
floor_std_rent decimal(14) ,
update_date_time varchar(13) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (hou_losn,floor)
...
ALTER TABLE  prestage.sbd_ihgt012_prestage OWNER TO ap_sbd;
