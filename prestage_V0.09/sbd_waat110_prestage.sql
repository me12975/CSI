...
-- Purpose: Prestage資料表;
-- Table: sbd_waat110_prestage;
-- Compressed: N ;
-- Distributed: Y (para_group_tp,para_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_waat110_prestage;

CREATE TABLE  prestage.sbd_waat110_prestage (
para_group_tp varchar(3) ,
para_cd varchar(3) ,
lvl decimal(1,0) ,
field_seq_no decimal(3,0) ,
fr_para varchar(3) ,
dtl_mk varchar(1) ,
un_stat_mk varchar(1) ,
visible_mk varchar(1) ,
stat_para_item varchar(800) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (para_group_tp,para_cd)
...
ALTER TABLE  prestage.sbd_waat110_prestage OWNER TO ap_sbd;
