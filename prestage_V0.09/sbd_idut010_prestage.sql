...
DROP TABLE IF EXISTS  prestage.sbd_idut010_prestage;

CREATE TABLE  prestage.sbd_idut010_prestage (
recev_no varchar(9) ,
tpr_idn varchar(10) ,
rfn varchar(17) ,
...
ALTER TABLE  prestage.sbd_idut010_prestage OWNER TO ap_sbd;
