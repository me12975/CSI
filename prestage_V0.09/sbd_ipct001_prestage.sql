...
-- Purpose: Prestage資料表;
-- Table: sbd_ipct001_prestage;
-- Compressed: N ;
-- Distributed: Y (commit_ctrl_area,commit_serial_no);
...
DROP TABLE IF EXISTS  prestage.sbd_ipct001_prestage;

CREATE TABLE  prestage.sbd_ipct001_prestage (
data_yr varchar(3) ,
commit_hsn_cd varchar(1) ,
commit_org varchar(2) ,
commit_ctrl_area varchar(2) ,
commit_serial_no varchar(6) ,
town_cd varchar(2) ,
tpr_idn varchar(10) ,
tpr_nm varchar(20) ,
depo_idn varchar(10) ,
depo_nm varchar(20) ,
tel_no_day varchar(20) ,
tel_no_night varchar(20) ,
flg_tp varchar(1) ,
flg_tax decimal(14,0) ,
post_office_cd varchar(7) ,
head_bank_cd varchar(3) ,
brch_bank_cd varchar(4) ,
bank_dstg_cd varchar(1) ,
acct_no varchar(14) ,
upd_tp_cd varchar(2) ,
redeem_stus_tp varchar(2) ,
div_file_mk varchar(1) ,
batch_no varchar(1) ,
ctrl_mk varchar(1) ,
withdraw_date varchar(7) ,
flg_e_dd_blnc decimal(14,0) ,
abnormal_mk varchar(1) ,
online_mk varchar(1) ,
manage_serial_no1 varchar(2) ,
manage_ck1_no varchar(1) ,
manage_ck2_no varchar(1) ,
outj_trf_in_mk varchar(1) ,
create_date varchar(7) ,
redeem_tms varchar(1) ,
add_mk_date varchar(7) ,
...
comu_hsn_cd varchar(1) ,
comu_org_cd varchar(2) ,
comu_town_cd varchar(2) ,
inft_withdraw_amt decimal(14,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (commit_ctrl_area,commit_serial_no)
...
ALTER TABLE  prestage.sbd_ipct001_prestage OWNER TO ap_sbd;
