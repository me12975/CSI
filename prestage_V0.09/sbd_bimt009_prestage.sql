...
DROP TABLE IF EXISTS  prestage.sbd_bimt009_prestage;

CREATE TABLE  prestage.sbd_bimt009_prestage (
agt_cd varchar(10) ,
resp_nm varchar(30) ,
agt_nm varchar(52) ,
...
ALTER TABLE  prestage.sbd_bimt009_prestage OWNER TO ap_sbd;
