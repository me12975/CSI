...
DROP TABLE IF EXISTS  prestage.sbd_wxxw300_prestage;

CREATE TABLE  prestage.sbd_wxxw300_prestage (
unpaid_case_tp varchar(1) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
town_cd varchar(2) ,
tax_cd varchar(2) ,
...
ALTER TABLE  prestage.sbd_wxxw300_prestage OWNER TO ap_sbd;
