...
-- Purpose: Prestage資料表;
-- Table: sbd_davt019_prestage;
-- Compressed: N ;
-- Distributed: Y (suit_start_date,suit_cutoff_date,grd_tp);
...
DROP TABLE IF EXISTS  prestage.sbd_davt019_prestage;

CREATE TABLE  prestage.sbd_davt019_prestage (
suit_start_date varchar(7) ,
suit_cutoff_date varchar(7) ,
grd_tp varchar(2) ,
n_amt_b_range decimal(12,0) ,
n_amt_e_range decimal(12,0) ,
tax_rate decimal(2,0) ,
prg_dif decimal(8,0) ,
xmp_amt decimal(8,0) ,
spous_ded decimal(10,0) ,
parent_ded decimal(10,0) ,
depnt_ded decimal(10,0) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (suit_start_date,suit_cutoff_date,grd_tp)
...
ALTER TABLE  prestage.sbd_davt019_prestage OWNER TO ap_sbd;
