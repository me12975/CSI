...
-- Purpose: Prestage資料表;
-- Table: sbd_ptit011_prestage;
-- Compressed: N ;
-- Distributed: Y (cntry_code);
...
DROP TABLE IF EXISTS  prestage.sbd_ptit011_prestage;

CREATE TABLE  prestage.sbd_ptit011_prestage (
data_yr varchar(3) ,
cntry_code varchar(2) ,
cntry_eng_nm varchar(60) ,
cntry_chi_nm varchar(52) ,
tax_prtt_src_mk varchar(1) ,
area_tp varchar(50) ,
invt_deal_mk varchar(1) ,
conf_prtt_area varchar(1) ,
...
ALTER TABLE  prestage.sbd_ptit011_prestage OWNER TO ap_sbd;
