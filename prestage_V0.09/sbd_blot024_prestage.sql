...
-- Purpose: Prestage資料表;
-- Table: sbd_blot024_prestage;
-- Compressed: N ;
-- Distributed: Y (levy_pfn_org_cd,levy_pfn_data_cd,levy_pfn_book_no,levy_pfn_page_no,levy_pfn_seq_no,levy_pfn_mdm_cd);
...
DROP TABLE IF EXISTS  prestage.sbd_blot024_prestage;

CREATE TABLE  prestage.sbd_blot024_prestage (
levy_pfn_org_cd varchar(3) ,
levy_pfn_create_yy varchar(3) ,
levy_pfn_data_cd varchar(2) ,
levy_pfn_book_no varchar(3) ,
levy_pfn_page_no varchar(2) ,
levy_pfn_seq_no varchar(2) ,
levy_pfn_mdm_cd varchar(1) ,
cnstrt_lic_no varchar(40) ,
gov_org_nm varchar(52) ,
data_tp varchar(1) ,
data_tp_nm varchar(14) ,
cnstrt_ban varchar(10) ,
cnstrt_nm varchar(52) ,
start_pty_no varchar(10) ,
start_pty_nm varchar(52) ,
chg_aft_cntr_ban varchar(10) ,
chg_aft_cntr_nm varchar(52) ,
chg_date varchar(7) ,
cnstrt_place varchar(80) ,
cnstrt_area decimal(10,2) ,
eng_bldg_cost decimal(14,0) ,
build_chg_aft_prc decimal(14,0) ,
yn_chg_bldg_cost varchar(1) ,
floor decimal(4,0) ,
hou_build_num decimal(4,0) ,
hou_fam_num decimal(4,0) ,
struc_tp varchar(2) ,
struc_tp_nm varchar(24) ,
cmpl_pct decimal(3,0) ,
engn_b_date varchar(7) ,
cmpl_date varchar(7) ,
jurisl_org_cd varchar(3) ,
no_o_tax_rgst varchar(1) ,
chk_mk varchar(7) ,
data_date varchar(7) ,
update_cd varchar(1) ,
use_lic_no varchar(30) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (levy_pfn_org_cd,levy_pfn_data_cd,levy_pfn_book_no,levy_pfn_page_no,levy_pfn_seq_no,levy_pfn_mdm_cd)
...
ALTER TABLE  prestage.sbd_blot024_prestage OWNER TO ap_sbd;
