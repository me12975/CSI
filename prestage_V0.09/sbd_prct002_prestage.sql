...
DROP TABLE IF EXISTS  prestage.sbd_prct002_prestage;

CREATE TABLE  prestage.sbd_prct002_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
recev_no varchar(8) ,
ca_amt decimal(14,0) ,
cash_amt decimal(14,0) ,
depo_amt decimal(14,0) ,
scts_amt decimal(14,0) ,
scts_loss_resv decimal(14,0) ,
sht_term_invt decimal(14,0) ,
srcv_note decimal(14,0) ,
note_bad_debt decimal(14,0) ,
srcv_acnt decimal(14,0) ,
acnt_bad_debt decimal(14,0) ,
oth_srcv decimal(14,0) ,
invn_amt decimal(14,0) ,
merch_amt decimal(14,0) ,
gd_amt decimal(14,0) ,
in_proc_amt decimal(14,0) ,
rmtrl_amt decimal(14,0) ,
mtrl_amt decimal(14,0) ,
cnsgnmt_amt decimal(14,0) ,
oth_invn decimal(14,0) ,
invn_loss_resv decimal(14,0) ,
apay_amt decimal(14,0) ,
apay_exp decimal(14,0) ,
merch_invn decimal(14,0) ,
apay_gd_amt decimal(14,0) ,
oth_apay_amt decimal(14,0) ,
oth_ca decimal(14,0) ,
tpay_amt decimal(14,0) ,
ica_ca decimal(14,0) ,
same_trade_ca decimal(14,0) ,
p_item_tax decimal(14,0) ,
dtn_cr_tax decimal(14,0) ,
oth_ca_oth decimal(14,0) ,
fund decimal(14,0) ,
long_term_invt decimal(14,0) ,
lti_un_rlz_loss decimal(14,0) ,
fa_amt_tot decimal(14,0) ,
lnd_amt decimal(14,0) ,
mind_amt decimal(14,0) ,
mind_acu_depl decimal(14,0) ,
hou_bldng decimal(14,0) ,
hou_bldng_acu_depr decimal(14,0) ,
mchn_amt decimal(14,0) ,
mchn_acu_depr decimal(14,0) ,
traffic_amt decimal(14,0) ,
traffic_acu_depr decimal(14,0) ,
mny_tool_amt decimal(14,0) ,
mny_tool_acu_depr decimal(14,0) ,
un_cmpl_engineer decimal(14,0) ,
apay_equip_amt decimal(14,0) ,
oth_fa decimal(14,0) ,
oth_fa_acu_depr decimal(14,0) ,
ia_amt decimal(14,0) ,
ia_acu_depr decimal(14,0) ,
oth_ast decimal(14,0) ,
savein_bail decimal(14,0) ,
orgn_fee decimal(14,0) ,
unapn_exp decimal(14,0) ,
oth_ast_oth decimal(14,0) ,
ast_t decimal(14,0) ,
cl_amt decimal(14,0) ,
sht_term_loan decimal(14,0) ,
bank_insuf_fund decimal(14,0) ,
bank_loan decimal(14,0) ,
spay_comrcl_note decimal(14,0) ,
oth_sht_loan decimal(14,0) ,
spay_amt decimal(14,0) ,
spay_note decimal(14,0) ,
spay_account_amt decimal(14,0) ,
spay_exp decimal(14,0) ,
spay_tax decimal(14,0) ,
spay_divd decimal(14,0) ,
oth_spay_amt decimal(14,0) ,
arcv_amt decimal(14,0) ,
arcv_gd_amt decimal(14,0) ,
oth_arcv_amt decimal(14,0) ,
oth_cl decimal(14,0) ,
trcv_amt decimal(14,0) ,
stkh_deal_cl decimal(14,0) ,
same_trade_cl decimal(14,0) ,
s_item_tax decimal(14,0) ,
agent_recev_amt decimal(14,0) ,
oth_cl_oth decimal(14,0) ,
long_term_liab decimal(14,0) ,
spay_bond decimal(14,0) ,
long_term_loan decimal(14,0) ,
oth_long_term_liab decimal(14,0) ,
oth_liab decimal(14,0) ,
saveout_bail decimal(14,0) ,
lvit_resv decimal(14,0) ,
pnsn_resv decimal(14,0) ,
fgn_loss_resv decimal(14,0) ,
agent_sale decimal(14,0) ,
oth_liab_oth decimal(14,0) ,
liab_t decimal(14,0) ,
act_recev_cptl decimal(14,0) ,
reg_stk_cptl decimal(14,0) ,
un_isu_stk_cptl decimal(14,0) ,
resvstk_fvm decimal(14,0) ,
surplus_pf decimal(14,0) ,
legal_surplus decimal(14,0) ,
legal_surplus1 decimal(14,0) ,
legal_surplus2 decimal(14,0) ,
cptl_surplus decimal(14,0) ,
spc_surplus decimal(14,0) ,
spc_surplus1 decimal(14,0) ,
spc_surplus2 decimal(14,0) ,
un_rlz_lti_loss decimal(14,0) ,
oth_surplus decimal(14,0) ,
acu_pfls decimal(14,0) ,
acu_pfls1 decimal(14,0) ,
acu_pfls2 decimal(14,0) ,
zsp_pfls decimal(14,0) ,
resvstk_costm decimal(14,0) ,
networth_t decimal(14,0) ,
liab_networth_t decimal(14,0) ,
force_mk varchar(1) ,
update_cd varchar(1) ,
keyin_id_cd varchar(8) ,
keyin_date varchar(7) ,
time_stamp timestamp ,
lti_acu_sub_loss decimal(14,0) ,
oth_fa_acu_sub_loss decimal(14,0) ,
ia_acu_sub_loss decimal(14,0) ,
scty_bank_ast decimal(14,0) ,
court_ctrl_pfls decimal(14,0) ,
resv_sale_bank_ast decimal(14,0) ,
hold_arrvl_ast decimal(14,0) ,
scty_have_ast decimal(14,0) ,
cost_bank_ast decimal(14,0) ,
unable_city_bond decimal(14,0) ,
oth_bank_ast decimal(14,0) ,
crnt_acu_loss decimal(14,0) ,
fund_invt decimal(14,0) ,
court_ctrl_no_crnt decimal(14,0) ,
resv_sale_no_crnt decimal(14,0) ,
hold_arrvl_no_crnt decimal(14,0) ,
scty_have_no_crnt decimal(14,0) ,
cost_bank_no_crnt decimal(14,0) ,
unable_city_no decimal(14,0) ,
oth_bank_ast_no decimal(14,0) ,
rgt_lti_stk_invt decimal(14,0) ,
no_crnt_acu_loss decimal(14,0) ,
court_ctrl_cl decimal(14,0) ,
scty_bank_cl decimal(14,0) ,
cost_bank_cl decimal(14,0) ,
spc_cl decimal(14,0) ,
oth_bank_cl decimal(14,0) ,
court_ctrl_liab_no decimal(14,0) ,
scty_bank_liab_no decimal(14,0) ,
cost_bank_liab_no decimal(14,0) ,
spc_liab_no decimal(14,0) ,
oth_bank_liab_no decimal(14,0) ,
rspf decimal(14,0) ,
oth decimal(14,0) ,
acu_pfls3 decimal(14,0) ,
legal_surplus3 decimal(14,0) ,
spc_surplus3 decimal(14,0) ,
invt_rel decimal(14,0) ,
cash_eqv decimal(14,0) ,
oth_court_ctrl_crnt decimal(14,0) ,
cost_fina_ast_crnt decimal(14,0) ,
ctrt_ast_crnt decimal(14,0) ,
no_crnt_ast decimal(14,0) ,
oth_court_ctrl_no_crnt decimal(14,0) ,
cost_fina_ast_no_crnt decimal(14,0) ,
ctrt_ast_no_crnt decimal(14,0) ,
blg_ast decimal(14,0) ,
ctrt_cl_crnt decimal(14,0) ,
oth_spay_amt_oth decimal(14,0) ,
long_spay_note decimal(14,0) ,
ctrt_cl_no_crnt decimal(14,0) ,
arcv_stk_cptl decimal(14,0) ,
acu_pfls_adj decimal(14,0) ,
acu_pfls_aft decimal(14,0) ,
zsp_loss_amt decimal(14,0) ,
hdg_tool_pfls decimal(14,0) ,
exch_dif decimal(14,0) ,
un_rlz_rvl decimal(14,0) ,
dbp_rmt decimal(14,0) ,
oth_un_rlz_pfls decimal(14,0) ,
oth_rgt decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_prct002_prestage OWNER TO ap_sbd;
