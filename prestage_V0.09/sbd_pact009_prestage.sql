...
DROP TABLE IF EXISTS  prestage.sbd_pact009_prestage;

CREATE TABLE  prestage.sbd_pact009_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
recev_no varchar(8) ,
chk_tms varchar(2) ,
...
orgn_tp varchar(1) ,
bscd varchar(6) ,
lqdt_b_date varchar(7) ,
lqdt_e_date varchar(7) ,
stop_date varchar(7) ,
open_date varchar(7) ,
invn_cshd_pfls decimal(14,0) ,
invn_cshd_rvnu decimal(14,0) ,
invn_cshd_cost decimal(14,0) ,
lqdt_rvnu decimal(14,0) ,
n_invn_cshd_rvnu decimal(14,0) ,
rpy_liab_rvnu decimal(14,0) ,
ast_aprsl_rvnu decimal(14,0) ,
lqdt_oth_rvnu decimal(14,0) ,
lqdt_loss decimal(14,0) ,
n_invn_cshd_loss decimal(14,0) ,
recev_pod_loss decimal(14,0) ,
ast_aprsl_loss decimal(14,0) ,
lqdt_exp decimal(14,0) ,
lqdt_oth_loss decimal(14,0) ,
lqdt_incm_loss decimal(14,0) ,
ded_apl_loss decimal(14,0) ,
excl_change decimal(14,0) ,
incnt_xmp_incm decimal(14,0) ,
lqdt_levy_incm decimal(14,0) ,
...
upgrd_lan_rgl_ctx decimal(14,0) ,
adm_rmd_dnt_cr decimal(14,0) ,
aptm_shsr_tax decimal(14,0) ,
re_apl_mk varchar(1) ,
lqdt_id_idn varchar(10) ,
mlc_credit_rtx decimal(14,0) ,
no_invn_n_rvnu decimal(14,0) ,
no_invn_n_cost decimal(14,0) ,
no_invn_n_rvnu_1 decimal(14,0) ,
no_invn_n_cost_1 decimal(14,0) ,
...
ALTER TABLE  prestage.sbd_pact009_prestage OWNER TO ap_sbd;
