...
DROP TABLE IF EXISTS  prestage.sbd_blmt011_prestage;

CREATE TABLE  prestage.sbd_blmt011_prestage (
ban varchar(8) ,
...
ALTER TABLE  prestage.sbd_blmt011_prestage OWNER TO ap_sbd;
