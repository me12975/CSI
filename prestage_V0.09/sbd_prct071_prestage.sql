...
DROP TABLE IF EXISTS  prestage.sbd_prct071_prestage;

CREATE TABLE  prestage.sbd_prct071_prestage (
data_yr varchar(3) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
ban varchar(8) ,
...
suit_artc varchar(4) ,
cntry_tp varchar(2) ,
ovrse_incmer_nm varchar(75) ,
flg_cost_exp_amt decimal(14,0) ,
payment_amt decimal(14,0) ,
appr_docu_no varchar(60) ,
update_cd varchar(1) ,
force_mk varchar(1) ,
...
ALTER TABLE  prestage.sbd_prct071_prestage OWNER TO ap_sbd;
