...
-- Purpose: Prestage資料表;
-- Table: sbd_crmt120_prestage;
-- Compressed: N ;
-- Distributed: Y (tob_lq_prod_key,tob_lq_prod_no);
...
DROP TABLE IF EXISTS  prestage.sbd_crmt120_prestage;

CREATE TABLE  prestage.sbd_crmt120_prestage (
...
ban varchar(8) ,
prod_nm varchar(80) ,
alch_cncn decimal(5,2) ,
mfg_prcs varchar(1) ,
min_pkg_cap decimal(10,3) ,
min_pkg_unit varchar(3) ,
taxable_unit_nm varchar(6) ,
tpr_mk varchar(1) ,
tpr_factory_no varchar(3) ,
export_only_mk varchar(1) ,
reg_date varchar(7) ,
reg_docu_no varchar(10) ,
...
TABLESPACE sbd 
DISTRIBUTED BY (tob_lq_prod_key,tob_lq_prod_no)
...
ALTER TABLE  prestage.sbd_crmt120_prestage OWNER TO ap_sbd;
