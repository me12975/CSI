...
-- Purpose: Prestage資料表;
-- Table: sbd_wmmt070_prestage;
-- Compressed: N ;
-- Distributed: Y (coll_report_cd,coll_report_format,field_seq_no);
...
DROP TABLE IF EXISTS  prestage.sbd_wmmt070_prestage;

CREATE TABLE  prestage.sbd_wmmt070_prestage (
coll_report_cd varchar(10) ,
coll_report_format varchar(1) ,
field_seq_no decimal(2,0) ,
coll_field_cd varchar(3) ,
tax_clsf_cd decimal(1,0) ,
lvl decimal(1,0) ,
coll_chi_nm varchar(20) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (coll_report_cd,coll_report_format,field_seq_no)
...
ALTER TABLE  prestage.sbd_wmmt070_prestage OWNER TO ap_sbd;
