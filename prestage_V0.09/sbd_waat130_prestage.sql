...
-- Purpose: Prestage資料表;
-- Table: sbd_waat130_prestage;
-- Compressed: N ;
-- Distributed: Y (clat_g_ldgr_no);
...
DROP TABLE IF EXISTS  prestage.sbd_waat130_prestage;

CREATE TABLE  prestage.sbd_waat130_prestage (
clat_g_ldgr_no varchar(3) ,
clat_g_ldgr_nm varchar(40) ,
this_prev_yr varchar(1) ,
clat_item1_no varchar(1) ,
dr_cr_tp varchar(1) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (clat_g_ldgr_no)
...
ALTER TABLE  prestage.sbd_waat130_prestage OWNER TO ap_sbd;
