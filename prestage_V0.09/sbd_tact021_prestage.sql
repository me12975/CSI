...
DROP TABLE IF EXISTS  prestage.sbd_tact021_prestage;

CREATE TABLE  prestage.sbd_tact021_prestage (
tax_tp varchar(1) ,
hsn_cd varchar(1) ,
dst_cd varchar(2) ,
app_yy varchar(2) ,
...
prst_prcd_cd varchar(2) ,
prst_prcd_date varchar(7) ,
prst_sh_fsh_date varchar(7) ,
prst_fsh_date varchar(7) ,
prst_rvwr_cd varchar(5) ,
prst_rvwc_cd varchar(5) ,
nd2_rvwc_cd varchar(5) ,
case_tp varchar(1) ,
asg_tp_code varchar(4) ,
mtg_tp_code varchar(4) ,
docu_no varchar(11) ,
cncs varchar(2) ,
cmpt_date varchar(7) ,
cmpt_stus varchar(9) ,
cmpx_date varchar(7) ,
coll_mk varchar(1) ,
dlv_coll_date varchar(7) ,
sur_date varchar(7) ,
fnsh_mk varchar(1) ,
pr_mk varchar(1) ,
next_cstp_stus varchar(1) ,
l_cstp_stus varchar(5) ,
...
ALTER TABLE  prestage.sbd_tact021_prestage OWNER TO ap_sbd;
