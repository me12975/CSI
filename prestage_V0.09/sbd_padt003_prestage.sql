...
-- Purpose: Prestage資料表;
-- Table: sbd_padt003_prestage;
-- Compressed: N ;
-- Distributed: Y (ban,resp_idn);
...
DROP TABLE IF EXISTS  prestage.sbd_padt003_prestage;

CREATE TABLE  prestage.sbd_padt003_prestage (
data_yr varchar(3) ,
ban varchar(8) ,
resp_idn varchar(10) ,
...
percent decimal(5,2) ,
orgn_tp varchar(1) ,
update_reas varchar(2) ,
xmp_mk varchar(1) ,
sale_amt_jan decimal(14,0) ,
sale_amt_feb decimal(14,0) ,
sale_amt_mar decimal(14,0) ,
sale_amt_apr decimal(14,0) ,
sale_amt_may decimal(14,0) ,
sale_amt_jun decimal(14,0) ,
sale_amt_jul decimal(14,0) ,
sale_amt_aug decimal(14,0) ,
sale_amt_sep decimal(14,0) ,
sale_amt_oct decimal(14,0) ,
sale_amt_nov decimal(14,0) ,
sale_amt_dec decimal(14,0) ,
y_sale_amt decimal(14,0) ,
net_pf_rate decimal(5,2) ,
sc_y_incm decimal(14,0) ,
tob_lq_dist_amt decimal(14,0) ,
tob_lq_sale_amt decimal(14,0) ,
tob_lq_bscd varchar(6) ,
tob_lq_net_pf_rate decimal(5,2) ,
tob_lq_incm decimal(14,0) ,
agrl_underwr_tot decimal(14,0) ,
agrl_assess_retail_amt decimal(14,0) ,
agrl_underwr_n_amt decimal(14,0) ,
agrl_underwr_bscd varchar(6) ,
underwr_net_pf_rate decimal(5,2) ,
agrl_underwr_incm decimal(14,0) ,
agrl_retail_incm decimal(14,0) ,
agrl_underwr_cmrv decimal(14,0) ,
agrl_buy_bscd varchar(6) ,
comsn_net_pf_rate decimal(5,2) ,
agrl_underwr_cmin decimal(14,0) ,
max_conf_mk varchar(1) ,
spss_busi_amt decimal(14,0) ,
spss_bscd varchar(6) ,
spss_net_pf_rate decimal(5,2) ,
spss_incm decimal(14,0) ,
trd_busi_amt decimal(14,0) ,
trd_bscd varchar(6) ,
trd_net_pf_rate decimal(5,2) ,
trd_incm decimal(14,0) ,
proc_for_busi_amt decimal(14,0) ,
proc_for_bscd varchar(6) ,
proc_for_net_pf_rate decimal(5,2) ,
proc_for_incm decimal(14,0) ,
sc_sale_amt_tot decimal(14,0) ,
sc_incm_tot decimal(14,0) ,
disa_loss decimal(14,0) ,
sc_levy_incm decimal(14,0) ,
tax_rate decimal(5,2) ,
prg_dif decimal(14,0) ,
apl_tax decimal(14,0) ,
apl_prov decimal(14,0) ,
apl_sup_ref_tax decimal(14,0) ,
busi_mm_num decimal(2,0) ,
chg_resp_mk varchar(1) ,
apl_date varchar(7) ,
resp_nm varchar(20) ,
ban_nm varchar(52) ,
busi_addr_hsn_nm varchar(6) ,
busi_addr_town_nm varchar(8) ,
busi_addr_vill_nm varchar(8) ,
busi_addr_lin varchar(8) ,
busi_addr_road_no varchar(50) ,
pfs_out_upd_mk varchar(1) ,
in_out_upd_date varchar(7) ,
update_cd varchar(1) ,
keyin_date varchar(7) ,
keyin_id_cd varchar(8) ,
time_stamp timestamp ,
levy_mode varchar(1) ,
seize_incm_nm varchar(10) ,
seize_amt decimal(14,0) ,
seize_amt_net_pf_rate decimal(5,2) ,
seize_incm_amt decimal(14,0) ,
seize_source varchar(20) ,
stage_upd_stus char(1) NOT NULL,
data_update_time timestamp NOT NULL,
data_exch_date date NOT NULL)
TABLESPACE sbd 
DISTRIBUTED BY (ban,resp_idn)
...
ALTER TABLE  prestage.sbd_padt003_prestage OWNER TO ap_sbd;
